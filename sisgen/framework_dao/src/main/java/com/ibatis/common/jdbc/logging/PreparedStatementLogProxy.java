 ...
 */
public class PreparedStatementLogProxy extends BaseLogProxy implements
		InvocationHandler {
	...
	public Object invoke(Object proxy, Method method, Object[] params)
		...
		try {
			if (EXECUTE_METHODS.contains(method.getName())) {
				...
				/*jcairampoma 20110525 COMENTADO PARA EVITAR MOSTRAR SCRIPTS RELACIONADOS A MENU*/  
				boolean b = true;
				if (sql.contains("COD_MENU")) b=false; 
