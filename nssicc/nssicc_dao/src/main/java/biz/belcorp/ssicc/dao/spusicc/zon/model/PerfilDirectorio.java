 ...
 *
 */
public class PerfilDirectorio extends AuditableBaseObject implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PerfilDirectorio other = (PerfilDirectorio) obj;
		if (codigo == null) {
	...
	public String toString() {
		return "PerfilDirectorio [codigo=" + codigo + ", descripcion="
				+ descripcion + ", estado=" + estado + ", indicadorActivo="
				+ indicadorActivo + "]";
	}
}
