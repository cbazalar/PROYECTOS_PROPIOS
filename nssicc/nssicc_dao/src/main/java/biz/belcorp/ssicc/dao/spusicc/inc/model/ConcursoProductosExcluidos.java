 ...
 *
 */
public class ConcursoProductosExcluidos extends AuditableBaseObject implements Serializable {
	...
	public ConcursoProductosExcluidos() {
	}
	...
	public String toString() {
		return "ConcursoProductosExcluidos [oid=" + oid + ", oidCicloVida="
				+ oidCicloVida + ", oidPeriodoHasta=" + oidPeriodoHasta
				+ ", oidTipoOferta=" + oidTipoOferta + ", oidPeriodoDesde="
				+ oidPeriodoDesde + ", oidSuperGenerico=" + oidSuperGenerico
				+ ", oidProductos=" + oidProductos + ", oidGenerico="
				+ oidGenerico + ", oidNegocio=" + oidNegocio
