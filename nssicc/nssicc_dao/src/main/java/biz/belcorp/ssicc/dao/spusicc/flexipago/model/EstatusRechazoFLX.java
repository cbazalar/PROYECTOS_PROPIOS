 ...
 *
 */
public class EstatusRechazoFLX extends AuditableBaseObject{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EstatusRechazoFLX other = (EstatusRechazoFLX) obj;
		if (codigo == null) {
	...
	public String toString() {
		return "EstatusRechazoFLX [codigo=" + codigo + ", codigoEstatus="
