...
/**
 * <p>
 * <a href="MantenimientoLECProgramaCorporativoDAO.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="yrivas@sigcomt.com">Yahir Rivas L.</a>
 *         
 */
public interface MantenimientoLECProgramaCorporativoDAO extends DAO {
	...
	/**
	 * Ejecuta el NUEVO Proceso de Clasificacion Lideres
	 * @param params
	 */
	public void executeProcesoLECProcesarClasificacionLideres(Map params);

	/**
	 * Obtienen la lista de tipos de oferta disponibles
	 * @return
	 */
	public List getTipoOfertaList();
	/**
	 * Mtodo inserta Canasta
     * @param Canasta
	 * @return
	 */	
	...
	/**
	 * Verifica si una consultora es posible Lider LEC
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Obtiene la lista de grupos de pago
	 * @param map
	 * @return
	 */
