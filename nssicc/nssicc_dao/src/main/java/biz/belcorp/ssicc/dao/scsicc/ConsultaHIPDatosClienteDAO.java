 ...
 * 
 * <p>
 * <a href="ConsultaHIPDatosClienteDAO.java.html"> <i>View Source</i> </a>
 * </p>
 * 
...
public interface ConsultaHIPDatosClienteDAO extends DAO {
	...
	/**
	 * Calcula el Periodo Promedio de Ventas
	 * 
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Inserta una solicitud Dupla Cyzone (STO)
	 * 
	 * @param criteria
	 */
	...
	/**
	 * Inserta una solicitud de Actualizacion de Datos de Consultora (STO)
	 * 
	 * @param criteria
	 */
	...
	/**
	 * Retorna la lista de tipo de premios
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Se recupera el Estado de la Solicitud de Poliza
	 * 
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Se recupera las fechas de cobertura de la Poliza
	 * 
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Borramos el registro de la tabla de Trasnferencia de Solicitudes de Credito
	 * 
	 * @param codigoCliente
	 */
	...
	/**
	 * Se recupera la lista de codigo de Venta relacionado a un codigo de Venta Principal
	 * 
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Se recupera la lista de venta exclusiva relacionado a un codigo de Venta Principal
	 * 
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Obtiene los datos adicionales de la cabecera del reclamo
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Obtiene un listado de clientes de los paises FOX
	 * @param criteria
	 * @return
	 */
	...
	/**
	 * Obtiene los pedidos base y linea de credito de 3 campaas, activa-1, activa, cativa+1
	 * @param params
	 * @return
	 */
	...
	/**
	 * Obtine el codigo del programa LET correspondiente a la campaa de proceso
	...
	/**
	 * Obtiene la situacion del cliente en flexipago
	 * @param codigoPais
	 * @param codigoCliente
	 * @return
	 */
