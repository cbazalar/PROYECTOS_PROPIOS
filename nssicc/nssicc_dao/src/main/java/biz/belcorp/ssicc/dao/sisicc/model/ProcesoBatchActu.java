 ...
 * 
 */
public class ProcesoBatchActu extends AuditableBaseObject implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7133992406098547664L;
	...
	private String descIndicadorEjecucion;
	...
	/**
	 * @return Returns the indicadorEjecucion.
	 */
	...
	/**
	 * @return Returns the descIndicadorEjecucion.
	 */
	public String getDescIndicadorEjecucion() {
		return descIndicadorEjecucion;
	}


	/**
	 * @param descIndicadorEjecucion The descIndicadorEjecucion to set.
	 */
	public void setDescIndicadorEjecucion(String descIndicadorEjecucion) {
		this.descIndicadorEjecucion = descIndicadorEjecucion;
	}
