 ...
 *
 */
public class ConcursoProductosValidos extends AuditableBaseObject implements Serializable {
	...
	public ConcursoProductosValidos() {
	}
	...
	public String toString() {
		return "ConcursoProductosValidos [oid=" + oid + ", oidTipoOferta="
				+ oidTipoOferta + ", oidProductos=" + oidProductos
				+ ", oidUnidadNegocio=" + oidUnidadNegocio
				+ ", oidSuperGenerico=" + oidSuperGenerico + ", oidCicloVida="
				+ oidCicloVida + ", oidNegocio=" + oidNegocio
				+ ", oidGenerico=" + oidGenerico + ", oidProducto="
				...
				+ descripcionMarcaProducto + ", codigoSuperGenerico="
