 ...
 * 
 * <p>
 * <a href="ClienteUAHistorico.java.html"> <i>View Source </i> </a>
 * </p>
 * 
...
public class ClienteUAHistorico extends AuditableBaseObject implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5018617251844320442L;
	...
	/**
	 * @param codigoUbigeoNivel1 The codigoUbigeoNivel1 to set.
	 */
	...
	/**
	 * @param codigoUbigeoNivel2 The codigoUbigeoNivel2 to set.
	 */
	...
	/**
	 * @param codigoUbigeoNivel3 The codigoUbigeoNivel3 to set.
	 */
	...
	/**
	 * @param codigoUbigeoNivel4 The codigoUbigeoNivel4 to set.
	 */
	...
	/**
	 * @param estadoValidacion The estadoValidacion to set.
	 */
	...
	/**
	 * @param valorCoordenadaX The valorCoordenadaX to set.
	 */
	...
	/**
	 * @param valorCoordenadaY The valorCoordenadaY to set.
	 */
	...
	/**
	 * @param valorCoordenadaZ The valorCoordenadaZ to set.
	 */
	...
	/**
	 * @param valorInterior The valorInterior to set.
	 */
	...
	/**
	 * @param valorKilometro The valorKilometro to set.
	 */
	...
	/**
	 * @param valorManzana The valorManzana to set.
	 */
    ...
    public boolean equals(Object object) {
        if (!(object instanceof ClienteUAHistorico)) {
            return false;
        }
        ClienteUAHistorico rhs = (ClienteUAHistorico) object;
        return new EqualsBuilder().append(this.codigoUbigeoNivel1,
                ...
                .append(this.tipoVia, rhs.tipoVia).append(this.auditInfo,
                        ...
                        rhs.valorCoordenadaX).append(this.numeroLote,
                        rhs.numeroLote).append(this.valorInterior,
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(1047856421, -1461161025).append(
                ...
                this.numeroLote).append(this.valorInterior).append(this.estado)
                .append(this.codigoUbigeoNivel4).append(this.nombreVia).append(
    ...
    public String toString() {
        return new ToStringBuilder(this)
                .append("valorLote", this.valorLote).append("codigoCliente",
                        this.codigoCliente).append("nombreVia", this.nombreVia)
                .append("valorCoordenadaY", this.valorCoordenadaY).append(
                        "auditInfo", this.auditInfo).append("estado",
                        this.estado).append("estadoValidacion",
                        this.estadoValidacion).append("tipoDireccion",
                        this.tipoDireccion).append("tipoVia", this.tipoVia)
                .append("valorManzana", this.valorManzana).append(
                        "valorCoordenadaZ", this.valorCoordenadaZ).append(
                        "codigoZona", this.codigoZona).append("valorInterior",
                        this.valorInterior).append("codigoPais",
                        this.codigoPais).append("codigoUbigeoNivel1",
                        this.codigoUbigeoNivel1).append("valorNumero",
                        this.valorNumero).append("codigoTerritorio",
                        this.codigoTerritorio).append("valorCoordenadaX",
                        this.valorCoordenadaX).append("codigoUbigeoNivel4",
                        this.codigoUbigeoNivel4).append("nivelSocioeconomico",
                        this.nivelSocioeconomico).append("numeroLote",
                        this.numeroLote).append("codigoUbigeoNivel3",
                        this.codigoUbigeoNivel3).append("codigoUbigeoNivel2",
                        this.codigoUbigeoNivel2).append("valorKilometro",
                        this.valorKilometro).toString();
    }
