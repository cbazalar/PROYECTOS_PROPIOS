 ...
 *
 */
public interface ProcesoMAVAsignacionReemplazoGerenteDAO extends DAO {
	
	/**
	 * Recupera la lista de gerente de regiones
	 * 
	 * @param params
	 * @return
	 */
	...
	/**
	 * Recupera datos necesarios para la consulta de remisiones de Material Promocional por fecha
	 * 
	 * @param params
	 * @return
	 */
	Map getDatosRemisionesMaterialPromocional(Map params);
	...
	/**
	 * Recupera datos necesarios para la consulta de historico de Material Promocional
	 * 
	 * @param params
	 * @return
	 */
	Map getDatosHistoricoMaterialPromocional(Map params);
