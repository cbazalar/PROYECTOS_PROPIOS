...
public class SubgerenciaPK implements Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 6799875374801225860L;
	/**
     ...
     * @param codigoRol
     */
    public SubgerenciaPK(String codigoMenu, String codigoRol) {
        this.codigoMenu = codigoMenu;
        this.codigoRol = codigoRol;
    }
    ...
    public boolean equals(Object object) {
        if (!(object instanceof SubgerenciaPK)) {
            return false;
        }
        SubgerenciaPK rhs = (SubgerenciaPK) object;
