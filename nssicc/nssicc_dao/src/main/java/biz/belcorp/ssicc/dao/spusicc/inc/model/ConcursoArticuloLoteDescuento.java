...
public class ConcursoArticuloLoteDescuento extends AuditableBaseObject implements Serializable {
	...
	public ConcursoArticuloLoteDescuento() {
	...
	public String toString() {
		return "ConcursoArticuloLote [oid=" + oid + ", indicadorDespacho="
				...
				+ ", eliminado=" + eliminado +", montoDescuento=" + montoDescuento+"]";
	}
