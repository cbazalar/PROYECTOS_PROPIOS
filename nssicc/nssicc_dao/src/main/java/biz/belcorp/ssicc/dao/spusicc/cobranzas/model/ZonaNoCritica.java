 ...
 *
 */
public class ZonaNoCritica extends AuditableBaseObject implements Serializable {
	...
	public String toString() {
		return "ZonaNoCritica [id=" + id + ", codigoPais=" + codigoPais
				+ ", codigoEtapaDeuda=" + codigoEtapaDeuda + ", codigoRegion="
				+ codigoRegion + ", codigoZona=" + codigoZona
				+ ", indicadorActivo=" + indicadorActivo + ", observaciones="
				+ observaciones + "]";
	}
