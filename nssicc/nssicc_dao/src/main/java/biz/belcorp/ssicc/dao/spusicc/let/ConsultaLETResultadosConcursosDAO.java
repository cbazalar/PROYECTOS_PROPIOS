 ...
 *
 */
public interface ConsultaLETResultadosConcursosDAO extends DAO{
	...
	/**
	 * Obtiene el total de ingresos efectivosd de una lider dentro de un rango de campaas de un concurso
	 * @param criteria
	 * @return
	 */
