 ...
 * 
 * <p>
 * <a href="SistemaPK.java.html"> <i>View Source</i> </a>
 * </p>
 * 
...
public class SistemaPK extends BaseObject implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -9178404391986106036L;
	 ...
	 * @param codigo
	 */
	public SistemaPK(String codigoPais, String codigo){
		super();
		this.codigoPais = codigoPais;
		this.codigo = codigo;
	}
	...
	public boolean equals(Object object) {
		if(!(object instanceof SistemaPK)){
			return false;
		}
		SistemaPK rhs = (SistemaPK)object;
