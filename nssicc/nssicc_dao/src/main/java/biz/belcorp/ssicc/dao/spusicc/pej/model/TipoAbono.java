 ...
 *
 */
public class TipoAbono extends AuditableBaseObject implements Serializable {
	...
	public String toString() {
		return "TipoAbono [codigo=" + codigo + ", codigoPais=" + codigoPais
