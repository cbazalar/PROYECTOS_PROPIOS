...
public class ConsultaOCRRecepcionPedidosAction extends
	...
	@ManagedProperty(value="#{consultaOCRDetallePedidoAction}")
	private ConsultaOCRDetallePedidoAction popupConsultaOCRDetallePedido;
	...
	public void abrirPopup(ActionEvent actionEvent) {
		try {
			popupConsultaOCRDetallePedido.setOcrRecepcionPedidosList(this.ocrRecepcionPedidosList);
			popupConsultaOCRDetallePedido.inicializarValores();
	...
	/**
	 * @return the popupConsultaOCRDetallePedido
	 */
	public ConsultaOCRDetallePedidoAction getPopupConsultaOCRDetallePedido() {
		return popupConsultaOCRDetallePedido;
	}

	/**
	 * @param popupConsultaOCRDetallePedido the popupConsultaOCRDetallePedido to set
	 */
	public void setPopupConsultaOCRDetallePedido(
			ConsultaOCRDetallePedidoAction popupConsultaOCRDetallePedido) {
		this.popupConsultaOCRDetallePedido = popupConsultaOCRDetallePedido;
	}
