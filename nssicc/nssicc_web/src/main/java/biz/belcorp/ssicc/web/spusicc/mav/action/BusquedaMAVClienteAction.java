...
@ManagedBean  
@SessionScoped
public class BusquedaMAVClienteAction extends BaseMantenimientoSearchAbstractAction {
	...
	@ManagedProperty(value="#{mantenimientoMAVConfiguracionSearchAction}")
	private MantenimientoMAVConfiguracionSearchAction mantenimientoMAVConfiguracionSearchAction;
	...
	protected void setViewAtributes() throws Exception {
		...
		this.listaResultado =  new ArrayList<ConsultaHIPDatosCliente>();
	...
	public void aceptar(ActionEvent e){
		...
		try {
			if(this.elemento != null) {
				BeanUtils.copyProperties(this.getSelected(), this.elemento);
							
				String nombreCompleto = this.getSelected().getApellido1() + " ";
				if(this.getSelected().getApellido2()!=null)
					nombreCompleto = nombreCompleto + this.getSelected().getApellido2();
				nombreCompleto = nombreCompleto + " " + this.getSelected().getNombre1()+ " ";
				if(this.getSelected().getNombre2()!=null)
					nombreCompleto = nombreCompleto + this.getSelected().getNombre2();
				
				((MantenimientoMAVConfiguracionForm)mantenimientoMAVConfiguracionSearchAction.getFormMantenimiento()).setNombreCliente(nombreCompleto);
			
				((MantenimientoMAVConfiguracionForm)mantenimientoMAVConfiguracionSearchAction.getFormMantenimiento()).setCodigoCliente(this.getSelected().getCodigoCliente());
	...
	/**
	 * @return the mantenimientoMAVConfiguracionSearchAction
	 */
	public MantenimientoMAVConfiguracionSearchAction getMantenimientoMAVConfiguracionSearchAction() {
		return mantenimientoMAVConfiguracionSearchAction;
	}

	/**
	 * @param mantenimientoMAVConfiguracionSearchAction the mantenimientoMAVConfiguracionSearchAction to set
	 */
	public void setMantenimientoMAVConfiguracionSearchAction(
			MantenimientoMAVConfiguracionSearchAction mantenimientoMAVConfiguracionSearchAction) {
		this.mantenimientoMAVConfiguracionSearchAction = mantenimientoMAVConfiguracionSearchAction;
	}
