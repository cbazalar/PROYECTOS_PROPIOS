...
import biz.belcorp.ssicc.web.scsicc.form.ReporteVENDetalleNCMarcaUNForm;

@ManagedBean
@SessionScoped
@SuppressWarnings({ "rawtypes", "unchecked" })
public class ReporteVENDetalleNCMarcaUNAction extends BaseReporteAbstractAction {
	...
	public String setValidarReporte() {
		ReporteVENDetalleNCMarcaUNForm form = (ReporteVENDetalleNCMarcaUNForm) this.formReporte;
	...
	protected BaseReporteForm devuelveFormReporte() throws Exception {
		ReporteVENDetalleNCMarcaUNForm form = new ReporteVENDetalleNCMarcaUNForm();
		return form;
	}
	...
	protected Map prepareParameterMap(Map params) throws Exception {
		log.info("Entro a ReporteVENDetalleNCMarcaUNAction - prepareParameterMap");

		ReporteVENDetalleNCMarcaUNForm f = (ReporteVENDetalleNCMarcaUNForm) this.formReporte;
		...
		log.info("Salio a ReporteVENDetalleNCMarcaUNAction - prepareParameterMap");
		return params;
	...
	protected void setViewAtributes() throws Exception {
		log.info("Entro a ReporteVENDetalleNCMarcaUNAction - setViewAttributes");
		...
		this.tipoReporte="NCR";

		log.info("Salio a ReporteVENDetalleNCMarcaUNAction - setViewAttributes");
	}
	
	@Override
	protected String devuelveBeanReporteService() {
		return "reportes.reporteVENDetalleNCMarcaUNService";
	}
