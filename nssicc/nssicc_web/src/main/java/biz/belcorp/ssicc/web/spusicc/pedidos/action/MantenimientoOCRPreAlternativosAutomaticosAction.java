...
import biz.belcorp.ssicc.dao.spusicc.pedidos.model.PreAlternativosAutomaticos;
...
public class MantenimientoOCRPreAlternativosAutomaticosAction extends BaseMantenimientoSearchAbstractAction {
	...
	protected void setViewAtributes() throws Exception {
		...
		this.setMostrarBotonEliminar(true);	
	}
	...
	protected boolean setDeleteAttributes() throws Exception {	
		...
		PreAlternativosAutomaticos pre =(PreAlternativosAutomaticos)this.beanRegistroSeleccionado;
		criteria.put("codigoPeriodo", pre.getCodigoPeriodo());
		criteria.put("codigoSAPPrincipal", pre.getCodigoSAPPrincipal());
		criteria.put("codigoSAPAlternativo", pre.getCodigoSAPAlternativo());
		//AUDITORIA
		criteria.put("usuario", usuario.getLogin());
		criteria.put("tipoAccion", Constants.TIPO_ACCION_ELIMINACION);
		//
		service.deleteAlternativosAutomaticos(criteria);
	...
	protected String devuelveMensajeKeyEliminarOK() {
		return "mantenimientoOCRPreAlternativosAutomaticosForm.delete";
	}
