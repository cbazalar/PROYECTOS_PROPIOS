...
public class MantenimientoCCCDigitacionCargosDirectosForm extends BaseSearchForm implements Serializable
{
	/**
	 * 
	 */
	...
	private String tipoCargoDirecto;	
	...
	/**
	 * @return the tipoCargoDirecto	   	
	 */
	public String getTipoCargoDirecto() {
		return tipoCargoDirecto;
	}

	/**
	 * @param tipoCargoDirecto the tipoCargoDirecto to set
	 * 				The tipoCargoDirecto to set.	 
	 * @struts.validator type = "required"
	 */
	public void setTipoCargoDirecto(String tipoCargoDirecto) {
		this.tipoCargoDirecto = tipoCargoDirecto;
	}
