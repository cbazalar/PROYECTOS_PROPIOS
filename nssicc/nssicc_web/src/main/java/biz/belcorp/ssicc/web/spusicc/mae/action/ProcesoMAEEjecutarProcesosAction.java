...
public class ProcesoMAEEjecutarProcesosAction extends
	...
	protected void setViewAtributes() throws Exception {
		...
		if (this.indicadorProceso.equals("G")
				|| this.indicadorProceso.equals("Z")
				|| this.indicadorProceso.equals("R")
				|| this.indicadorProceso.equals("P")
				|| this.indicadorProceso.equals("I")) {
	...
	protected Map<String, Object> prepareParamsBeforeExecute(Map params,
		...
		if (f.getZonaList() != null && f.getZonaList().length > 0)
			params.put("zonaListAux",
					StringUtil.obtieneListaCodigos(f.getZonaList(), "", ""));
