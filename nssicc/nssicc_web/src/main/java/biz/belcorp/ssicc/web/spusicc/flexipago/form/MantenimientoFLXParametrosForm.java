...
public class MantenimientoFLXParametrosForm extends BaseSearchForm{
	...
	private ParametroForm[] parametrosGrupo10 = new ParametroForm[0];
	...
	/**
	 * @return the parametrosGrupo10
	 */
	public ParametroForm[] getParametrosGrupo10() {
		return parametrosGrupo10;
	}

	/**
	 * @param parametrosGrupo10 the parametrosGrupo10 to set
	 */
	public void setParametrosGrupo10(ParametroForm[] parametrosGrupo10) {
		this.parametrosGrupo10 = parametrosGrupo10;
	}
