...
private static final long serialVersionUID = 1L;
	...
	private String campanyaRecaudo;
	...
	/**
	 * @return the campanyaRecaudo
	 */
	public String getCampanyaRecaudo() {
		return campanyaRecaudo;
	}
	/**
	 * @param campanyaRecaudo the campanyaRecaudo to set
	 */
	public void setCampanyaRecaudo(String campanyaRecaudo) {
		this.campanyaRecaudo = campanyaRecaudo;
	}
