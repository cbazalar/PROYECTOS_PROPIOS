...
public class MantenimientoZONUnidadGeograficaSearchAction extends BaseMantenimientoSearchAbstractAction {
	...
	protected boolean setDeleteAttributes() throws Exception {
		...
		try	{
			UnidadGeografica registroSeleccionado = (UnidadGeografica) this.beanRegistroSeleccionado; 
			
			service.deleteUnidadGeografica(registroSeleccionado.getOidValorEstructuraGeo(), this.getmPantallaPrincipalBean().getCurrentUser());
			
		}catch(InvalidIdentifierException iie){
			String errorCode = iie.getIdentifier().toString();
			this.addError("Error", this.getResourceMessage(errorCode));
			return false;
		}
		return true;
	}
	...
	public String setValidarMantenimiento() {
		...
		log.debug("Enter method - setValidarMantenimiento");
		MantenimientoZONUnidadGeograficaForm f = (MantenimientoZONUnidadGeograficaForm)this.formMantenimiento;
		String mensaje = null;
		String [] descripcion = new String [this.zonEstructuraGeopoliticaList.size()];
		
		for (int i = 0; i < this.zonEstructuraGeopoliticaList.size(); i++) {
			EstructuraGeopolitica zon = (EstructuraGeopolitica) this.zonEstructuraGeopoliticaList.get(i);
			descripcion[Integer.parseInt(zon.getCodigoOrden())-1] = zon.getDescripcion();
		...
		{
//			alert("El campo '" + desNivel1 + "' es requerido.");
			mensaje = this.getResourceMessage("mantenimientoZONUnidadGeograficaForm.requeridos", new Object[]{descripcion[0]});
//			this.getRequestContext().execute("PrimeFaces.focus('nivel1')");
			return mensaje;
		}
		
		if(!StringUtils.isBlank(f.getNivel3()) && StringUtils.isBlank(f.getNivel2()))
		{
//			alert("El campo '" + desNivel2 + "' es requerido.");
			mensaje = this.getResourceMessage("mantenimientoZONUnidadGeograficaForm.requeridos", new Object[]{descripcion[1]});
//			this.getRequestContext().execute("PrimeFaces.focus('nivel2')");
			return mensaje;
		}
		
		if(!StringUtils.isBlank(f.getNivel4()) && StringUtils.isBlank(f.getNivel3()))
		{
//			alert("El campo '" + desNivel3 + "' es requerido.");
			mensaje = this.getResourceMessage("mantenimientoZONUnidadGeograficaForm.requeridos", new Object[]{descripcion[2]});
//			this.getRequestContext().execute("PrimeFaces.focus('nivel3')");
			return mensaje;
		}
...
//			alert("El campo 'Descripcion' es requerido.");
			...
			mensaje = this.getResourceMessage("mantenimientoZONUnidadGeograficaForm.requeridos", new Object[]{desc});
			this.getRequestContext().execute("PrimeFaces.focus('descripcion')");
			return mensaje;
		}
	...
	protected String devuelveMensajeKeySaveOK() {
		...
		{
			mensaje = "mantenimientoZONUnidadGeograficaForm.created";
			return mensaje;
		}
			
		
		if(StringUtils.equals(this.accion, "MODIFICAR")){
			mensaje = "mantenimientoZONUnidadGeograficaForm.updated";
			return mensaje;
		}
...
//		cargarDatos(f, this.getId());
	...
	/**
	 * Rellena ceros a la izquierda del nivel 1
	 * 
	 */
	public void rellenarCeros1(){
		
		log.debug("Enter method - rellenarCeros1");
		try {
			MantenimientoZONUnidadGeograficaForm f = (MantenimientoZONUnidadGeograficaForm)this.formMantenimiento;
			if(StringUtils.isNotBlank(f.getNivel1())){
				String rel = "";
				rel = this.rellenar(6,f.getNivel1().length());				
				f.setNivel1(rel+f.getNivel1());				
			}			
		} catch (Exception e) {
	...
	/**
	 * Rellena ceros a la izquierda del nivel 2
	 * 
	 */
	public void rellenarCeros2(){
		
		log.debug("Enter method - rellenarCeros2");
		try {
			MantenimientoZONUnidadGeograficaForm f = (MantenimientoZONUnidadGeograficaForm)this.formMantenimiento;
			if(StringUtils.isNotBlank(f.getNivel2())){
				String rel = "";
				rel = this.rellenar(6,f.getNivel2().length());				
				f.setNivel2(rel+f.getNivel2());				
			}			
		} catch (Exception e) {
	...
	/**
	 * Rellena ceros a la izquierda del nivel 3
	 * 
	 */
	public void rellenarCeros3(){
		
		log.debug("Enter method - rellenarCeros3");
		try {
			MantenimientoZONUnidadGeograficaForm f = (MantenimientoZONUnidadGeograficaForm)this.formMantenimiento;
			if(StringUtils.isNotBlank(f.getNivel3())){
				String rel = "";
				rel = this.rellenar(6,f.getNivel3().length());				
				f.setNivel3(rel+f.getNivel3());				
			}			
		} catch (Exception e) {
	...
	/**
	 * Rellena ceros a la izquierda del nivel 4
	 * 
	 */
	public void rellenarCeros4(){
		
		log.debug("Enter method - rellenarCeros4");
		try {
			MantenimientoZONUnidadGeograficaForm f = (MantenimientoZONUnidadGeograficaForm)this.formMantenimiento;
			if(StringUtils.isNotBlank(f.getNivel4())){
				String rel = "";
				rel = this.rellenar(6,f.getNivel4().length());				
				f.setNivel4(rel+f.getNivel4());				
			}			
		} catch (Exception e) {
	 ...
	 * @return
	 */
	private String rellenar(int maxLenght,int tam){
		String relleno = "";		
		int n= maxLenght - tam;
		for (int i = 0; i < n; i++) {
			relleno = relleno + "0";
