...
import biz.belcorp.ssicc.web.scsicc.form.ReporteSACPedidoZonaForm;
...
@ManagedBean
@SessionScoped
public class ReporteSACPedidoZonaAction extends BaseReporteAbstractAction {
	...
	protected BaseReporteForm devuelveFormReporte() throws Exception {
		ReporteSACPedidoZonaForm form = new ReporteSACPedidoZonaForm();
		return form;
	}
	...
	protected String devuelveNombreReporte() throws Exception {
		ReporteSACPedidoZonaForm form = (ReporteSACPedidoZonaForm)this.formReporte;
		log.debug(form.getFormatoExportacion());
		
		if ("XLS".equals(form.getFormatoExportacion())) {
			return "reporteSACPedidoZonaXLS";
		}else{
	...
	protected String devuelveNombreSubReporte() throws Exception {
		...
		if ("PDF".equals(form.getFormatoExportacion())) {
			return "reporteSACPedidoZonaPDF";
		}else{
			return "reporteMaestroVertical";
		}
	}
	...
	protected Map prepareParameterMap(Map params) throws Exception {
		...
		StringBuilder zona = new StringBuilder(this.obtieneCondicion(form.getZonaList(), "d.COD_ZONA", "'"));
		StringBuilder region = new StringBuilder(this.obtieneCondicion(form.getRegionList(), "e.COD_REGI", "'"));
		String condicion = region.toString() + zona.toString();
		
		params.put("periodo", form.getCodigoPeriodo());
		params.put("condicion", condicion);
		params.put("tipoSol",Constants.TIPO_SOLICITUD_SOC);
		
		params.put("titulo", this.getReportResourceMessage("reporteSACPedidoZonaForm.titulo"));
		return params;
	}
