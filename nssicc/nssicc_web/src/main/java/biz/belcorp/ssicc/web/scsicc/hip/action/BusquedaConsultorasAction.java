...
@ManagedBean  
@SessionScoped
public class BusquedaConsultorasAction extends BasePopupAbstractAction {
	...
	protected List setFindAttributes() throws Exception {
		...
		List resultado = service.getClientesByCriteria2(getCriteriaSearch(searchForm));
	...
	private Map getCriteriaSearch(BusquedaHIPClienteSearchForm searchForm) {		
		...
		criteria.put("oidIdioma", clienteService.getOidPais(criteria));
		...
		criteria.put("criterioBusqueda1", searchForm.getCriterio1());
		criteria.put("criterioBusqueda2", searchForm.getCriterio2());
