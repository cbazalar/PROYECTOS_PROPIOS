...
private static final long serialVersionUID = 1L;
	...
	private boolean indicadorDocFiscalD;
    ...
    private String oidTipoDocumentoRFC;
	...
	/**
	 * @return the oidTipoDocumentoRFC
	 */
	public String getOidTipoDocumentoRFC() {
		return oidTipoDocumentoRFC;
	}
	...
	/**
	 * @param oidTipoDocumentoRFC the oidTipoDocumentoRFC to set
	 */
	public void setOidTipoDocumentoRFC(String oidTipoDocumentoRFC) {
		this.oidTipoDocumentoRFC = oidTipoDocumentoRFC;
	}
	...
	public boolean isIndicadorDocFiscalD() {
		return indicadorDocFiscalD;
	}

	public void setIndicadorDocFiscalD(boolean indicadorDocFiscalD) {
		this.indicadorDocFiscalD = indicadorDocFiscalD;
	}
