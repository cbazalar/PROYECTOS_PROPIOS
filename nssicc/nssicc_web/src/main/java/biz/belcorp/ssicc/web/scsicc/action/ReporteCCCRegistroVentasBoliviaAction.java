...
import biz.belcorp.ssicc.web.scsicc.form.ReporteCCCRegistroVentasBoliviaForm;
...
@ManagedBean
@SessionScoped
public class ReporteCCCRegistroVentasBoliviaAction extends BaseReporteAbstractAction {
	...
	protected BaseReporteForm devuelveFormReporte() throws Exception {
		ReporteCCCRegistroVentasBoliviaForm f = new ReporteCCCRegistroVentasBoliviaForm();
	...
	protected Map prepareParameterMap(Map params) throws Exception {
		ReporteCCCRegistroVentasBoliviaForm f = (ReporteCCCRegistroVentasBoliviaForm) formReporte;
	...
	protected String devuelveBeanReporteService() {		
		return "reportes.reporteCCCRegistroVentasBoliviaService";
	}
