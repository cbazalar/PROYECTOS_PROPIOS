...
import biz.belcorp.ssicc.web.sisicc.form.InterfazPERRecepcionarConsolidadosOtrosCanalesForm;


/**
 * The Class InterfazPERRecepcionarConsolidadosOtrosCanalesAction.
 *
...
@ManagedBean
@SessionScoped
public class InterfazPERRecepcionarConsolidadosOtrosCanalesAction extends BaseInterfazAbstractAction {

	private static final long serialVersionUID = -839943600311812836L;
	

	/** FIXME Para borrar porque se migro al nuevo esquema de Interfaces.
	 * 	Revision con Carlos Hurtado - RCDLRP 27/10/2006
	 */ 
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		InterfazPERRecepcionarConsolidadosOtrosCanalesForm form = new InterfazPERRecepcionarConsolidadosOtrosCanalesForm();
		return form;
	}
	...
	protected void setViewAtributes() throws Exception {	
		...
		InterfazPERRecepcionarConsolidadosOtrosCanalesForm f = (InterfazPERRecepcionarConsolidadosOtrosCanalesForm) this.formInterfaz;
