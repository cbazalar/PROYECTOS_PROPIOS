...
public class MantenimientoRECDigitacionCDRForm extends BaseSearchForm {
	...
	/** The indicador valida faltantes. */
	private String indicadorValidaFaltantes;
	
	/** The indicador valida cambios. */
	...
	/** The indicador valor acepta cdr. */
	private String indicadorValorAceptaCDR;
	
	public void reset() {
		listaOperacion = null;
		listaCUVCambia= null;
		listaCantidadCambia= null;
		listaMotivo= null;
		listaIgualEnvio= null;
		listaCUVDesea= null;
		listaCantidadDesea= null;
		
		numeroCDR="";
		numeroBoletaDespacho="";
		codigoConsejera="";
		periodo="";
		nombreConsejera="";
		indicadorModifica="0";
		indicadorHayRegistros="0";
		indicadorExpress=false;
		indicadorExpressHidden=null;
		indicadorPedidoChequeado=null;
