...
public class ProcesoCOMComisionGenerarArchivoNominaAction extends BaseReporteAbstractAction {
	...
	protected String devuelveNombreReporte() throws Exception {
		...
		if ("01".equals(form.getTipoComision())) {
			return "reporteCOMComisionNominaRegionXLS";
		} 
		else {
			return "reporteCOMComisionNominaZonaXLS";
		}
	}
	...
	protected Map prepareParameterMap(Map params) throws Exception{
		...
		String codigoIncRecupRegion = (String)criteria.get("codigoIncRecupRegion");
		
		params.put("codigoComision", obtieneCondicion(reporteForm.getCodigoComision(), "c.cod_comi", "'"));
		params.put("codigoIncRecup", codigoIncRecup);
		params.put("codigoCompania", codigoCompania);
		params.put("codigoIncRecupRegion", codigoIncRecupRegion);
