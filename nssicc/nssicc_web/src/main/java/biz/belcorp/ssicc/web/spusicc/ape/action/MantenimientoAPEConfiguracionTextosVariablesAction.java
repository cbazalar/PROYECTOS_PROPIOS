...
public class MantenimientoAPEConfiguracionTextosVariablesAction extends BaseMantenimientoSearchAbstractAction{
	...
	private List apeMaeTipoClien;
	private List apeMaeSubtiClien;
	private List apeMaeTipoClasiCLien;
	private List apeMaeClasi;
	...
	protected List setFindAttributes() throws Exception {
		...
		this.oidPais = reporteService.getOidString("getOidPaisByCodigoPais", criteriaPais);
	...
	protected void setViewAtributes() throws Exception {
		...
		this.apeMaeTipoClien = serviceConfiguracionTextosVariables.getTipoClienteList();
		
		this.apeMaeSubtiClien = new ArrayList();
		this.apeMaeTipoClasiCLien = new ArrayList();
		this.apeMaeClasi = new ArrayList();
		...
		this.setOidIdiomaIso(oidIdiomaIso);
	...
	public String getsConfTextVari() {
		return sConfTextVari;
	}

	public void setsConfTextVari(String sConfTextVari) {
		this.sConfTextVari = sConfTextVari;
	}

	public String getsCodigoTipoCliente() {
		return sCodigoTipoCliente;
	}

	public void setsCodigoTipoCliente(String sCodigoTipoCliente) {
		this.sCodigoTipoCliente = sCodigoTipoCliente;
	}

	public String getsCodigoSubTipoCliente() {
		return sCodigoSubTipoCliente;
	}

	public void setsCodigoSubTipoCliente(String sCodigoSubTipoCliente) {
		this.sCodigoSubTipoCliente = sCodigoSubTipoCliente;
	}

	public String getsCodigoTipoClasificacion() {
		return sCodigoTipoClasificacion;
	}

	public void setsCodigoTipoClasificacion(String sCodigoTipoClasificacion) {
		this.sCodigoTipoClasificacion = sCodigoTipoClasificacion;
	}

	public String getsCodigoClasificacion() {
		return sCodigoClasificacion;
	}

	public void setsCodigoClasificacion(String sCodigoClasificacion) {
		this.sCodigoClasificacion = sCodigoClasificacion;
	}

	public String getsValTextVari() {
		return sValTextVari;
	}

	public void setsValTextVari(String sValTextVari) {
		this.sValTextVari = sValTextVari;
	}
	...
	public List getApeMaeTipoClien() {
		return apeMaeTipoClien;
	}

	public void setApeMaeTipoClien(List apeMaeTipoClien) {
		this.apeMaeTipoClien = apeMaeTipoClien;
	}

	public List getApeMaeSubtiClien() {
		return apeMaeSubtiClien;
	}

	public void setApeMaeSubtiClien(List apeMaeSubtiClien) {
		this.apeMaeSubtiClien = apeMaeSubtiClien;
	}

	public List getApeMaeTipoClasiCLien() {
		return apeMaeTipoClasiCLien;
	}

	public void setApeMaeTipoClasiCLien(List apeMaeTipoClasiCLien) {
		this.apeMaeTipoClasiCLien = apeMaeTipoClasiCLien;
	}

	public List getApeMaeClasi() {
		return apeMaeClasi;
	}

	public void setApeMaeClasi(List apeMaeClasi) {
		this.apeMaeClasi = apeMaeClasi;
	}
