...
public class MantenimientoCOBCobradorUnidadAdministrativaSearchAction extends BaseMantenimientoSearchAbstractAction
{
	...
	protected String devuelveMensajeKeyEliminarOK() {
		...
		return "mantenimientoCOBCobradorUnidadAdministrativaForm.deleted";
	}
	...
	protected boolean setSaveAttributes() throws Exception 
	{
		...
		try {
			...
			if (!f.isNewRecord()) {
				...
				params.put("usuarioModificacion", (usuario.getAuditInfo().getUpdatedBy()));
				params.put("fechaModificacion", DateUtil.convertDateToString(Constants.DEFAULT_DATE_TIME_FORMAT, new Date()));

				service.updateCobradorUnidadAdministrativa(params);
			} else {
				if (log.isDebugEnabled()) {
	...
	protected BaseEditForm setObtenerRegistroAttributes() throws Exception 
	{
		...
		if (!this.accion.equals(this.ACCION_NUEVO)) 
		{
			...
			if (codigoPais != null && etapa != null && region != null && zona != null && cobrador != null) 
			{
				...
				f.setOldCodigoCobrador(CobradorUnidadAdministrativa.getCodigoCobrador());
	...
	/**
	 * @param isConsultar the isConsultar to set
	 */
