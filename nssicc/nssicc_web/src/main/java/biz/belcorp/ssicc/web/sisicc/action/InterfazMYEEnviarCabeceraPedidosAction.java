...
import biz.belcorp.ssicc.web.sisicc.form.InterfazMYEEnviarCabeceraPedidosForm;


@ManagedBean
@SessionScoped
public class InterfazMYEEnviarCabeceraPedidosAction extends BaseInterfazAbstractAction {
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		return new InterfazMYEEnviarCabeceraPedidosForm();
	}
	...
	protected void setViewAtributes() throws Exception {
		...
		InterfazMYEEnviarCabeceraPedidosForm form = (InterfazMYEEnviarCabeceraPedidosForm) this.formInterfaz;
	...
	protected Map<String, Object> prepareParamsBeforeExecute(Map params,
		...
		InterfazMYEEnviarCabeceraPedidosForm f = (InterfazMYEEnviarCabeceraPedidosForm) this.formInterfaz;
