...
import biz.belcorp.ssicc.web.scsicc.form.ReporteCOBDetalladoSaldosUnidadAdministrativaForm;


/**
 * The Class ReporteCOBDetalladoSaldosUnidadAdministrativaAction.
 *
...
@ManagedBean
@SessionScoped
public class ReporteCOBDetalladoSaldosUnidadAdministrativaAction extends BaseReporteAbstractAction {
		
	private static final long serialVersionUID = -7452958446101918373L;
	...
	protected BaseReporteForm devuelveFormReporte() throws Exception {
		ReporteCOBDetalladoSaldosUnidadAdministrativaForm form = new ReporteCOBDetalladoSaldosUnidadAdministrativaForm();
		return form;
	}
	...
	protected void setViewAtributes() throws Exception {
		if (log.isDebugEnabled()) {
			log.debug("Entering 'ReporteCOBDetalladoSaldosUnidadAdministrativaAction.setViewAtributes' method");
		}		
		...
		ReporteCOBDetalladoSaldosUnidadAdministrativaForm f = (ReporteCOBDetalladoSaldosUnidadAdministrativaForm) this.formReporte;
	...
	protected String devuelveNombreReporte() throws Exception {
		return  "reporteCOBDetalladoSaldosUnidadAdministrativa" + this.tipoVista + "XLS";
	}
	...
	protected Map prepareParameterMap(Map params) throws Exception {
		...
		ReporteCOBDetalladoSaldosUnidadAdministrativaForm reporteCOBForm = (ReporteCOBDetalladoSaldosUnidadAdministrativaForm) this.formReporte;
