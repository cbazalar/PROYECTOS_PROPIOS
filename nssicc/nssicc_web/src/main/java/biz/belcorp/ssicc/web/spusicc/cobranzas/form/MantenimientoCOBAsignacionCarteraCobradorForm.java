...
public class MantenimientoCOBAsignacionCarteraCobradorForm extends BaseEditForm implements Serializable
{
	...
	private String oldCodigoCobrador;
	...
	public String getOldCodigoCobrador() {
		return oldCodigoCobrador;
	}

	public void setOldCodigoCobrador(String oldCodigoCobrador) {
		this.oldCodigoCobrador = oldCodigoCobrador;
	}
}
