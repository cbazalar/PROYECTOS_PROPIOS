...
public class ReporteLETParametriaConcursoAction extends BaseReporteAbstractAction {
	...
	protected Map prepareParameterMap(Map params) throws Exception {
		...
		ClassPathResource resource = new ClassPathResource(Constants.JASPER_DIRECTORIO + "subReporteLETParametriaConcursoPC" + JASPER_EXTENSION);
		ClassPathResource resource1 = new ClassPathResource(Constants.JASPER_DIRECTORIO + "subReporteLETParametriaConcursoNC" + JASPER_EXTENSION);
		ClassPathResource resource2 = new ClassPathResource(Constants.JASPER_DIRECTORIO + "subReporteLETParametriaConcursoRP" + JASPER_EXTENSION);		
