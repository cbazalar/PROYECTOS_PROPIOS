...
public class MantenimientoRUVDocumentosContablesForm extends BaseSearchForm implements Serializable
{
	 ...
	 */
	public void setNumeroDocumentoInternoInicial(
			String numeroDocumentoInternoInicial) {
