...
public class ProcesoCCCRegistroIncobrablesAction extends
	...
	protected void setViewAtributes() throws Exception {
		...
		ProcesoCCCRegistroIncobrablesForm f = (ProcesoCCCRegistroIncobrablesForm) this.formProceso;
		...
		if (StringUtils.isEmpty(indicadorCompletarCerosNumDocumento)) {
			...
			f.setLongitudNumeroDocIdentidad(clienteService
					.getLongitudNumeroDocIdentidad(criteria));
		} else
