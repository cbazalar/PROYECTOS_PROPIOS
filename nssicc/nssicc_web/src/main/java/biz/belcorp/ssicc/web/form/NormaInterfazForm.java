...
public class NormaInterfazForm extends BaseEditForm{
	...
	/**
	 * @param alineamientoAlfanumerico The alineamientoAlfanumerico to set.
	 */
	...
	/**
	 * @param alineamientoNumerico The alineamientoNumerico to set.
	 */
	...
	/**
	 * @param flagAlineamientoAlfanumerico The flagAlineamientoAlfanumerico to set.
	 */
	...
	/**
	 * @param flagAlineamientoNumerico The flagAlineamientoNumerico to set.
	 */
	...
	/**
	 * @param flagFecha The flagFecha to set.
	 */
	...
	/**
	 * @param flagRellenoAlfanumerico The flagRellenoAlfanumerico to set.
	 */
	...
	/**
	 * @param flagRellenoNumerico The flagRellenoNumerico to set.
	 */
	...
	/**
	 * @param flagTruncamientoAlfanumerico The flagTruncamientoAlfanumerico to set.
	 */
	...
	/**
	 * @param flagTruncamientoNumerico The flagTruncamientoNumerico to set.
	 */
	...
	/**
	 * @param rellenoAlfanumerico The rellenoAlfanumerico to set.
	 */
	...
	/**
	 * @param rellenoNumerico The rellenoNumerico to set.
	 */
	...
	/**
	 * @param truncamientoAlfanumerico The truncamientoAlfanumerico to set.
	 */
	...
	/**
	 * @param truncamientoNumerico The truncamientoNumerico to set.
	 */
	...
	public String toString() {
		return "NormaInterfazForm [codigoPais=" + codigoPais + ", codigo="
				+ codigo + ", codigoTipoFormatoArchivo="
				+ codigoTipoFormatoArchivo + ", tipoFormatoArchivo="
				+ tipoFormatoArchivo + ", flagRellenoNumerico="
				+ flagRellenoNumerico + ", rellenoNumerico=" + rellenoNumerico
				+ ", flagRellenoAlfanumerico=" + flagRellenoAlfanumerico
				+ ", rellenoAlfanumerico=" + rellenoAlfanumerico
				+ ", flagAlineamientoNumerico=" + flagAlineamientoNumerico
				+ ", alineamientoNumerico=" + alineamientoNumerico
				+ ", flagAlineamientoAlfanumerico="
				+ flagAlineamientoAlfanumerico + ", alineamientoAlfanumerico="
				+ alineamientoAlfanumerico + ", flagFecha=" + flagFecha
				+ ", formatoFecha=" + formatoFecha
				+ ", flagTruncamientoNumerico=" + flagTruncamientoNumerico
				+ ", truncamientoNumerico=" + truncamientoNumerico
				+ ", flagTruncamientoAlfanumerico="
				+ flagTruncamientoAlfanumerico + ", truncamientoAlfanumerico="
				+ truncamientoAlfanumerico + ", estado=" + estado + "]";
	}
