...
import biz.belcorp.ssicc.web.spisicc.form.ProcesoIMPGeneracionSpoolLaserMultihiloMavForm;

@ManagedBean
@SessionScoped
@SuppressWarnings({ "rawtypes", "unchecked" })
public class ProcesoIMPGeneracionSpoolLaserMultihiloMavAction extends BaseInterfazAbstractAction{
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		ProcesoIMPGeneracionSpoolLaserMultihiloMavForm interfazForm = new ProcesoIMPGeneracionSpoolLaserMultihiloMavForm();
		return interfazForm;
	}
	...
	protected void setViewAtributes() throws Exception {
		...
		ProcesoIMPGeneracionSpoolLaserMultihiloMavForm f = (ProcesoIMPGeneracionSpoolLaserMultihiloMavForm) this.formInterfaz;
