...
public class ProcesoSTOCambioTipoOrdenPedidosCargadosAction extends BaseProcesoAbstractAction 
{
	...
	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.web.framework.base.action.BaseProcesoAbstractAction#setErrorLogicaNegocio(java.util.Map)
	 */
	@Override
	protected String setErrorLogicaNegocio(Map params) {
		List test = (List) params.get("listaClientes");

		if (test.isEmpty())
			return "No hay códigos de consultoras cargados";
		else
			return null;
	}
