...
public class MantenimientoCOBCarteraAsignadaSearchAction extends BaseMantenimientoSearchAbstractAction {
	...
	/**
	 * biz.belcorp.ssicc.web.spusicc.cobranzas.action.MantenimientoCOBCarteraAsignadaSearchAction#depurar;
	 * @param event
	 */
	...
	/**
	 * biz.belcorp.ssicc.web.spusicc.cobranzas.action.MantenimientoCOBCarteraAsignadaSearchAction#loadZonas;
	 * @param val
	 */
