...
import biz.belcorp.ssicc.web.sisicc.form.InterfazLETEnviarTarjetasAsociadasForm;
...
@ManagedBean
@SessionScoped
public class InterfazLETEnviarTarjetasAsociadasAction extends BaseInterfazAbstractAction{
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		InterfazLETEnviarTarjetasAsociadasForm f = new  InterfazLETEnviarTarjetasAsociadasForm();
		return f;
	}
	...
	public void executeInterfaz(ActionEvent actionEvent) {
		try {
			...
			archivos[1] = (String)this.getParamfiltros().get("nombreArchivoDetalle").toString()+"."+(String)this.getParamfiltros().get("extension");
			...
			if (log.isDebugEnabled()) {
				...
				String nombreArchivoConsolidado = String.format("%s%s.%s", "ALTAS_", (String)this.getParamfiltros().get("numeroLote"), (String)this.getParamfiltros().get("extension"));
			...
			//return mapping.findForward(getExecuteForward());
		} catch (Exception e) {
