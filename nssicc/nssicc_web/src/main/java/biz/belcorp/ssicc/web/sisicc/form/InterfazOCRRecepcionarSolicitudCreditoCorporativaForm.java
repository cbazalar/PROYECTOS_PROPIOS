...
/**
 * The Class InterfazOCRRecepcionarSolicitudCreditoCorporativaForm.
 *
 * @autor: Hernando Huaman Flores
 * @version: 1.0
 * 05/12/2014
 */
public class InterfazOCRRecepcionarSolicitudCreditoCorporativaForm extends BaseInterfazForm {
