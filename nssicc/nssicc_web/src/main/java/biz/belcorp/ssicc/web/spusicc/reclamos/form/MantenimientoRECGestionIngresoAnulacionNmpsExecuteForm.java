...
public class MantenimientoRECGestionIngresoAnulacionNmpsExecuteForm extends BaseProcesoForm{
	/**
	 * 
	 */
	...
	private String flagNotaMercaderia;
	...
	/**
	 * @return the flagNotaMercaderia
	 */
	public String getFlagNotaMercaderia() {
		return flagNotaMercaderia;
	}

	/**
	 * @param flagNotaMercaderia the flagNotaMercaderia to set
	 */
	public void setFlagNotaMercaderia(String flagNotaMercaderia) {
		this.flagNotaMercaderia = flagNotaMercaderia;
	}
