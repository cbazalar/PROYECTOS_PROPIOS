...
import biz.belcorp.ssicc.web.sisicc.form.InterfazIVREnviarNovedadIVRForm;
...
@ManagedBean
@SessionScoped
public class InterfazIVREnviarNovedadIVRAction extends
		BaseInterfazAbstractAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2073747667698131836L;
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		InterfazIVREnviarNovedadIVRForm form = new InterfazIVREnviarNovedadIVRForm();
		return form;
	}
	...
	protected void setViewAtributes() throws Exception {
		...
		InterfazIVREnviarNovedadIVRForm form = (InterfazIVREnviarNovedadIVRForm) this.formInterfaz;
	...
	protected Map<String, Object> prepareParamsBeforeExecute(Map params,
		...
		//Método que supuestamente tenia que ir en el ServiceImpl
		//sisicc.paqueteInterfazIVREnviarCompletoIVRService
		//no se migro en el ServiceImpl porque ya existia un beforeExecuteInterfaz
		//y tambien existia el mismo ID="IVR-P2"
