...
public class ConsultaCOBSupervisorForm extends BaseSearchForm implements
		Serializable {
	...
	/**
	 * @param indiceSearch the indiceSearch to set
	 */
	...
	/**
	 * @param criterioFiltro the criterioFiltro to set
	 */
	...
	/**
	 * @param gestionFiltro the gestionFiltro to set
	 */
	...
	/**
	 * @return the criterioOrdenamiento
	 */
	...
	/**
	 * @param criterioOrdenamiento the criterioOrdenamiento to set
	 */
	...
	/**
	 * @return the codigoSociedadSearch
	 */
	...
	/**
	 * @param codigoSociedadSearch the codigoSociedadSearch to set
	 */
	...
	/**
	 * @param codigoEtapaSearch the codigoEtapaSearch to set
	 */
	...
	/**
	 * @return the codigoCobradorSearch
	 */
	...
	/**
	 * @param codigoCobradorSearch the codigoCobradorSearch to set
	 */
	...
	/**
	 * @return the deudaAsignada
	 */
	public String getDeudaAsignada() {
		return deudaAsignada;
	}

	/**
	 * @param deudaAsignada the deudaAsignada to set
	 */
	public void setDeudaAsignada(String deudaAsignada) {
		this.deudaAsignada = deudaAsignada;
	}
