...
import biz.belcorp.ssicc.web.sisicc.form.ProcesoPEDEjecutarProcesoGP2MultihiloForm;


@ManagedBean
@SessionScoped
@SuppressWarnings({ "rawtypes", "unchecked" })
public class ProcesoPEDEjecutarProcesoGP2MultihiloAction extends BaseInterfazAbstractAction{
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		ProcesoPEDEjecutarProcesoGP2MultihiloForm interfazForm = new ProcesoPEDEjecutarProcesoGP2MultihiloForm();
		return interfazForm;
	}
	...
	protected void setViewAtributes() throws Exception {
		...
		ProcesoPEDEjecutarProcesoGP2MultihiloForm f = (ProcesoPEDEjecutarProcesoGP2MultihiloForm) this.formInterfaz;
