...
public class ProcesoOCRFechaProgramadaFacturacionAction extends
	...
	protected List setFindAttributes() throws Exception {
		...
		String valor = ajax.getRegistroByPeriodoTipoSoliFecha(periodo,
				solicitud, fecha, grupoProceso);
	...
	protected void setViewAtributes() throws Exception {
		...
		// request.getSession(true).setAttribute(Constants.TIPO_SOLICITUD_LIST,
		// ((ProcesoOCRFechaProgramadaFacturacionService)getBean("spusicc.procesoOCRFechaProgramadaFacturacionService")).getTiposSolicitudOcr());
		...
		f.setFecha(new SimpleDateFormat("dd/MM/yyyy").format(Calendar
				.getInstance().getTime()));
		f.setNuevaFecha(new SimpleDateFormat("dd/MM/yyyy").format(Calendar
				.getInstance().getTime()));
