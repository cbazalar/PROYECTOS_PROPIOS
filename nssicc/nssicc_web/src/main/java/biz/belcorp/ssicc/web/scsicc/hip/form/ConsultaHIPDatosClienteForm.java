...
public class ConsultaHIPDatosClienteForm extends BaseSearchForm {
	...
	private boolean mostrarPantallaConsulta;
	...
	//PER-SiCC-2013-0934 HIP (Requerimiento) @ghuertasa inicio
	
	private String indicadorBasparampais;
	
	//PER-SiCC-2013-0934 HIP (Requerimiento) @ghuertasa fin
	
	private String etapaDeCobro;
	private String cobrador;
	
	private String situacionEnFlx;
	
	public String indicadorMostrarNumeroFactura;
	
	private String indCamposAdicion;
	...
	/**
	 * @return the mostrarPantallaConsulta
	 */
	public boolean isMostrarPantallaConsulta() {
		return mostrarPantallaConsulta;
	}

	/**
	 * @param mostrarPantallaConsulta the mostrarPantallaConsulta to set
	 */
	public void setMostrarPantallaConsulta(boolean mostrarPantallaConsulta) {
		this.mostrarPantallaConsulta = mostrarPantallaConsulta;
	}
	 ...
	 */
	public void setIndicadorCompletarCerosNumDocumento(boolean indicadorCompletarCerosNumDocumento) {
	 ...
	 * @param etapaDeCobro
	 */
	public void setEtapaDeCobro(String etapaDeCobro) {
		this.etapaDeCobro = etapaDeCobro;
	}
	...
	/**
	 * @return the situacionEnFlx
	 */
	public String getSituacionEnFlx() {
		return situacionEnFlx;
	}

	/**
	 * @param situacionEnFlx the situacionEnFlx to set
	 */
	public void setSituacionEnFlx(String situacionEnFlx) {
		this.situacionEnFlx = situacionEnFlx;
	}
	...
	/**
	 * @return the indicadorMostrarNumeroFactura
	 */
	public String getIndicadorMostrarNumeroFactura() {
		return indicadorMostrarNumeroFactura;
	}

	/**
	 * @param indicadorMostrarNumeroFactura the indicadorMostrarNumeroFactura to set
	 */
	public void setIndicadorMostrarNumeroFactura(
			String indicadorMostrarNumeroFactura) {
		this.indicadorMostrarNumeroFactura = indicadorMostrarNumeroFactura;
	}

	/**
	 * @return the indCamposAdicion
	 */
	public String getIndCamposAdicion() {
		return indCamposAdicion;
	}

	/**
	 * @param indCamposAdicion the indCamposAdicion to set
	 */
	public void setIndCamposAdicion(String indCamposAdicion) {
		this.indCamposAdicion = indCamposAdicion;
	}
	...
	/**
	 * @param origenIngresos the origenIngresos to set
	 */
	...
	/**
	 * @param origenCliente the origenCliente to set
	 */
