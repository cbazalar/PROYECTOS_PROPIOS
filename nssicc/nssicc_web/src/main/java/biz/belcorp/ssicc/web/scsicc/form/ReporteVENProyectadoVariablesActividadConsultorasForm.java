...
/**
 * The Class ReporteVENProyectadoVariablesActividadConsultorasForm.
 *
 * @autor: Hernando Huaman Flores
 * @version: 1.0
 * 12/11/2014
 */
public class ReporteVENProyectadoVariablesActividadConsultorasForm extends BaseReporteForm {
	 ...
	 * @param codigoPeriodo The codigoPeriodoInicial to set.
	 * 
	 */
