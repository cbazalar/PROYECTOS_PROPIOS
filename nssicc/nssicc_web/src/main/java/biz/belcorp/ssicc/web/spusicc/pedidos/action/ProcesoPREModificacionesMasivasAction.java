...
public class ProcesoPREModificacionesMasivasAction extends BaseProcesoAbstractAction {
	...
	protected Map<String, Object> executeProcess(Map<String, Object> params) throws Exception {
    	...
    	ProcesoPREModificacionesMasivasService service = (ProcesoPREModificacionesMasivasService)getBean("spusicc.pedido.procesoPREModificacionesMasivasService");
...
//        validar(null);
	...
	public void validar(ActionEvent e) throws Exception {
        ...
        String codigoUsuario = this.getmPantallaPrincipalBean().getCurrentUser().getLogin();
	...
	public Boolean getMostrarPrimeraGrilla(){
		...
		return this.mostrarPrimeraGrilla;
	}
