...
public class MantenimientoCOBExcepcionAsignacionCarteraSearchAction extends BaseMantenimientoSearchAbstractAction {
	...
	/**
	 * biz.belcorp.ssicc.web.spusicc.cobranzas.action.MantenimientoCOBExcepcionAsignacionCarteraSearchAction#obtenerValorBoolean
	 * @param indicador
	 * @return
	 */
	...
	/**
	 *  * biz.belcorp.ssicc.web.spusicc.cobranzas.action.MantenimientoCOBExcepcionAsignacionCarteraSearchAction#obtenerValor
	 * @param estado
	 * @return
	 */
