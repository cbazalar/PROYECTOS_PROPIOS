...
@ManagedBean
@SessionScoped
public class ReporteOCRPedidosNoFacturadosBloqueoAction extends BaseReporteAbstractAction {
	...
	protected String devuelveNombreReporte() throws Exception {
		...
		if ("XLS".equals(form.getFormatoExportacion())){
			...
			if (StringUtils.equals(form.getTipoReporte(), "Historicos")
					|| StringUtils.isEmpty(form.getTipoReporte()))
	...
	protected String devuelveNombreSubReporte() throws Exception {
		...
		return "reporteOCRPedidosNoFacturadosBloquea" + form.getTipoReporte();
	}
	...
	protected Map prepareParameterMap(Map params) throws Exception {
		...
		reporteExcel = "OCRPedidosNoFactBloq";
		...
		String titulo = "";
		String tipoBloqueo = "";
		if (StringUtils.equals(form.getTipoBloqueo(), "1")) {
			condicion = "AND IND_BLOQ_ADMI = 1 ";
			tipoBloqueo = "A";
			titulo = this.getReportResourceMessage("reporteOCRPedidosNoFacturadosBloqueoForm.bloqueo.administrativo");
		}
		if (StringUtils.equals(form.getTipoBloqueo(), "2")) {
			condicion = "AND IND_BLOQ_ADMI = 2 ";
			tipoBloqueo = "F";
			titulo = this.getReportResourceMessage("reporteOCRPedidosNoFacturadosBloqueoForm.bloqueo.financiero");
		}
		if (StringUtils.equals(form.getTipoBloqueo(), "C")) {
			condicion = " AND (select 1 from sto_detal_docum_excep where sec_nume_docu=a.sec_nume_docu and cod_vali='OCC-31')=1 ";
			tipoBloqueo = "C";
			titulo = this.getReportResourceMessage("reporteOCRPedidosNoFacturadosBloqueoForm.bloqueo.control");
		}
		if (StringUtils.isBlank(form.getTipoBloqueo())) {
			condicion = " AND ( " +
					"(select 1 from sto_detal_docum_excep where sec_nume_docu=a.sec_nume_docu and cod_vali='OCC-31')=1 or "+ 
					"nvl(a.IND_BLOQ_ADMI,0)<>0 )";
			tipoBloqueo = "T";
			titulo = this.getReportResourceMessage("reporteOCRPedidosNoFacturadosBloqueoForm.bloqueo.todos");
		}

		params.put("NroReporte", this.getReportResourceMessage("reporteOCRPedidosNoFacturadosBloqueoForm.numero.reporte"));
		params.put("condicion", condicion);
		params.put("tipoBloqueo", tipoBloqueo);
		params.put("titulo", this.getReportResourceMessage("reporteOCRPedidosNoFacturadosBloqueoForm.titulo")
				+ " "
				+ StringUtils
