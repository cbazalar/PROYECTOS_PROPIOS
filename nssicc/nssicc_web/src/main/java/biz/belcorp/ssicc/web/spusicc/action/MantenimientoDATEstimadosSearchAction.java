...
public class MantenimientoDATEstimadosSearchAction extends
	...
	protected List setFindAttributes() throws Exception {
		...
		if (listaEstimadosAux.size() > 0)
			...
			addError("Error",this.getResourceMessage("errors.datos.fuentes.busqueda"));
		}
	...
	private Map obtenerPeriodoInicioFin(MantenimientoDATEstimadosSearchForm searchForm,MantenimientoDATEstimadosService service)
