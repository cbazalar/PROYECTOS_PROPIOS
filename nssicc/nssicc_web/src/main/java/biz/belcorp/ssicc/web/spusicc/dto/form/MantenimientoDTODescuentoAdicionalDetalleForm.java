...
public class MantenimientoDTODescuentoAdicionalDetalleForm extends BaseEditForm{

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6249959776590498338L;
	...
	public void reset() {
		this.codigoAdicional=this.codigoTipoCliente=null;
		this.codigoSubTipoCliente =null;
		this.codigoTipoClasificacion = this.codigoClasificacion = null;
