 ...
 * 
 */
public class ConsultaHIPResponsablesSeccionForm extends BaseSearchForm {

	private static final long serialVersionUID = -2398409448875019980L;
	...
	private File archivo; // objeto que se utilizara para el upload del
								// Archivo
	...
	public ConsultaHIPResponsablesSeccionForm() {
	...
	/**
	 * @param flagNotaMercaderiaPerdida
	 *            the flagNotaMercaderiaPerdida to set
	 */
	...
	/**
	 * @param flagMostrarError
	 *            the flagMostrarError to set
	 */
	...
	/**
	 * @param selectedItemsVacio
	 *            the selectedItemsVacio to set
	 */
	...
	/**
	 * @param tipoSeleccion1
	 *            the tipoSeleccion1 to set
	 */
	...
	/**
	 * @param tipoSeleccion2
	 *            the tipoSeleccion2 to set
	 */
	...
	/**
	 * @param tipoSeleccion3
	 *            the tipoSeleccion3 to set
	 */
