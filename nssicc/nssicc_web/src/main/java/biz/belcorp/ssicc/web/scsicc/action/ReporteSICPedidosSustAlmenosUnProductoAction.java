...
import biz.belcorp.ssicc.web.scsicc.form.ReporteSICPedidosSustAlmenosUnProductoForm;
...
@ManagedBean
@SessionScoped
public class ReporteSICPedidosSustAlmenosUnProductoAction extends BaseReporteAbstractAction {
	...
	protected void setAceptarPopup(ActionEvent event, String accion) {
		...
		if (this.busquedaProductoSearchAction.isSeleccionoRegistro()) {
			...
			ReporteSICPedidosSustAlmenosUnProductoForm f = (ReporteSICPedidosSustAlmenosUnProductoForm)this.formReporte;			
			if (accion.equals(this.POPUP_SACPRODUCTO)) {
				f.setCodigoSap((String)clienteHipMap.get("codigoSap"));
				f.setDescVentaReemplazo((String)clienteHipMap.get("descripcionCorta"));
			}
			if(accion.equals(this.POPUP_SACPROD_REEMP)){
				f.setCodigoSapReemplazo((String)clienteHipMap.get("codigoSap"));
				f.setDescVentaReemplazado((String)clienteHipMap.get("descripcionCorta"));
			}
	...
	protected BaseReporteForm devuelveFormReporte() throws Exception {
		ReporteSICPedidosSustAlmenosUnProductoForm form = new ReporteSICPedidosSustAlmenosUnProductoForm();
		return form;
	}
	...
	protected String devuelveNombreReporte() throws Exception {		
		ReporteSICPedidosSustAlmenosUnProductoForm form = (ReporteSICPedidosSustAlmenosUnProductoForm)this.formReporte;
		log.debug(form.getFormatoExportacion());
		
		if ("XLS".equals(form.getFormatoExportacion())) {
			return "reporteSICPedidosSustAlmenosUnProductoXLS";
		} else {
	...
	protected String devuelveNombreSubReporte() throws Exception {
		return "reporteSICPedidosSustAlmenosUnProductoPDF";
	}
	...
	protected Map prepareParameterMap(Map params) throws Exception {;
		...
		params.put("titulo", this.getResourceMessage("reporteSICPedidosSustAlmenosUnProductoForm.titulo"));
		...
		params.put("cuvReemplazo",f.getCuvReemplazo());
		params.put("productoReemplazo",f.getCodigoVentaReemplazo());
		params.put("cuvReemplazado",f.getCuvReemplazado());
		params.put("productoReemplazado",f.getCuvReemplazado());
	...
	protected void setViewAtributes() throws Exception {
		if(log.isDebugEnabled()){
			log.debug("ReporteSICPedidosSustAlmenosUnProductoAction - setViewAtributes");
		}
		...
		ReporteSICPedidosSustAlmenosUnProductoForm f = ( ReporteSICPedidosSustAlmenosUnProductoForm) formReporte ;
	...
	public void loadZonas(ValueChangeEvent val){
		...
		ReporteSICPedidosSustAlmenosUnProductoForm reporteSICForm = (ReporteSICPedidosSustAlmenosUnProductoForm) this.formReporte;
