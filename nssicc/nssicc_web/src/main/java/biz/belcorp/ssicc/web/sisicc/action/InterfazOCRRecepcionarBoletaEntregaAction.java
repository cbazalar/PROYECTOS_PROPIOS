...
import biz.belcorp.ssicc.web.sisicc.form.InterfazOCRRecepcionarBoletaEntregaForm;

@ManagedBean
@SessionScoped
@SuppressWarnings({ "rawtypes", "unchecked" })
public class InterfazOCRRecepcionarBoletaEntregaAction extends
		BaseInterfazAbstractAction {

	private static final long serialVersionUID = 3066676320732024277L;
	...
	protected Map<String, Object> prepareParamsBeforeExecute(Map params,
		...
		InterfazOCRRecepcionarBoletaEntregaForm f = (InterfazOCRRecepcionarBoletaEntregaForm) this.formInterfaz;
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		InterfazOCRRecepcionarBoletaEntregaForm form = new InterfazOCRRecepcionarBoletaEntregaForm();
		return form;
	}
