...
import biz.belcorp.ssicc.web.sisicc.form.InterfazMYEEnviarRegionesForm;


@ManagedBean
@SessionScoped
public class InterfazMYEEnviarRegionesAction extends BaseInterfazAbstractAction {
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		return new InterfazMYEEnviarRegionesForm();
	}
	...
	protected void setViewAtributes() throws Exception {
		if (log.isDebugEnabled()) {
		 ...
		 InterfazMYEEnviarRegionesForm form = (InterfazMYEEnviarRegionesForm)this.formInterfaz;
