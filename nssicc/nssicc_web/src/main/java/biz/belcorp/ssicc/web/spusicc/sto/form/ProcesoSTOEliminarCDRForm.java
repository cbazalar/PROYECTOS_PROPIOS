...
public class ProcesoSTOEliminarCDRForm extends BaseProcesoForm implements
		Serializable {
	...
	/**
	 * @param indicadorDocumento
	 *            The indicadorDocumento to set.
	 */
	...
	/**
	 * @param tipoDocumentoSearch
	 *            the tipoDocumentoSearch to set
	 */
	...
	/**
	 * @param selectedItemsSearch
	 *            the selectedItemsSearch to set
	 */
	...
	/**
	 * @param indicadorDocumentoSearch
	 *            the indicadorDocumentoSearch to set
	 */
	 ...
	 *            the codigoClienteSearch to set
	 */
	...
	/**
	 * @param agrupacionSearch
	 *            the agrupacionSearch to set
	 */
	 ...
	 *            the fechaInicioProcesoSearch to set
	 */
	 ...
	 *            the fechaFinProcesoSearch to set
	 */
	...
	/**
	 * @param agrupacionFechaProcesoSearch
	 *            the agrupacionFechaProcesoSearch to set
	 */
	public void setAgrupacionFechaProcesoSearch(
			String agrupacionFechaProcesoSearch) {
	...
	/**
	 * @param agrupacionLoteSearch
	 *            the agrupacionLoteSearch to set
	 */
	...
	/**
	 * @param agrupacionRegionSearch
	 *            the agrupacionRegionSearch to set
	 */
	...
	/**
	 * @param agrupacionZonaSearch
	 *            the agrupacionZonaSearch to set
	 */
	...
	/**
	 * @param agrupacionClienteSearch
	 *            the agrupacionClienteSearch to set
	 */
	 ...
	 *            the horaInicioCargaSearch to set
	 */
	 ...
	 *            the horaInicioProcesoSearch to set
	 */
	 ...
	 *            the horaFinProcesoSearch to set
	 */
	 ...
	 *            the codigoPeriodoSearch to set
	 */
	...
	/**
	 * @param agrupacionPeriodoSearch
	 *            the agrupacionPeriodoSearch to set
	 */
	...
	/**
	 * @param agrupacionOrigenSearch
	 *            the agrupacionOrigenSearch to set
	 */
	...
	/**
	 * @param numeroDocumentoSearch
	 *            the numeroDocumentoSearch to set
	 */
