...
public class MantenimientoCOBEtapaDeudaSearchAction extends BaseMantenimientoSearchAbstractAction {
	...
	/**
	 **biz.belcorp.ssicc.web.spusicc.cobranzas.action.MantenimientoCOBEtapaDeudaSearchAction#obtenerValorBoolean 
	 * @param indicador
	 * @return
	 */
	...
	/**
	 *  **biz.belcorp.ssicc.web.spusicc.cobranzas.action.MantenimientoCOBEtapaDeudaSearchAction#obtenerValor 
	 * @param estado
	 * @return
	 */
