...
@ManagedBean
@SessionScoped
public class ReporteINCConsultorasPuntajeUbicacionAction extends BaseReporteAbstractAction{
	...
	protected Map<String, Object> prepareParamsBeforeExecute(
		...
		ReporteService reporteService = (ReporteService)getBean("scsicc.reporteService");
		reporteService.executeReporteConsultoraPuntajeUbicacion(params);
		return params;
	}
