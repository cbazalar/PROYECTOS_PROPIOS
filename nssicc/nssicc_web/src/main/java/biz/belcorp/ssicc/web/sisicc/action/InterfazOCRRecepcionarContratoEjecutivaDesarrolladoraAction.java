...
import biz.belcorp.ssicc.web.sisicc.form.InterfazOCRRecepcionarContratoEjecutivaDesarrolladoraForm;

@ManagedBean
@SessionScoped
@SuppressWarnings({ "rawtypes", "unchecked" })
public class InterfazOCRRecepcionarContratoEjecutivaDesarrolladoraAction extends BaseInterfazAbstractAction {

	private static final long serialVersionUID = 4685674872631937918L;
	...
	protected Map<String, Object> prepareParamsBeforeExecute(Map params, BaseForm form) throws Exception{
		...
		InterfazOCRRecepcionarContratoEjecutivaDesarrolladoraForm f = (InterfazOCRRecepcionarContratoEjecutivaDesarrolladoraForm) this.formInterfaz;
		...
		criteriaInterfaz.put("codigoDocumento", Constants.STO_TIPO_DOCUMENTO_CED);		
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		InterfazOCRRecepcionarContratoEjecutivaDesarrolladoraForm f =  new InterfazOCRRecepcionarContratoEjecutivaDesarrolladoraForm();
		return f;
	}
