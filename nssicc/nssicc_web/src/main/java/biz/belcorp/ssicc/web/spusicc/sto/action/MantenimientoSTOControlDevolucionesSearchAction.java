...
import biz.belcorp.ssicc.web.spusicc.sto.form.MantenimientoSTOControlDevolucionesForm;
...
public class MantenimientoSTOControlDevolucionesSearchAction extends BaseMantenimientoSearchAbstractAction{
	...
	public void handleFileUploadSearch(FileUploadEvent event) throws Exception {
		...
		MantenimientoSTOControlDevolucionesSearchForm f = (MantenimientoSTOControlDevolucionesSearchForm) this.formBusqueda;
		if (event != null) {
	...
	public void uploadArchivoSearch() throws Exception {
		...
		MantenimientoSTOControlDevolucionesSearchForm f = (MantenimientoSTOControlDevolucionesSearchForm) formBusqueda;
	...
	public void uploadArchivoForm() throws Exception {
		...
		MantenimientoSTOControlDevolucionesForm f = (MantenimientoSTOControlDevolucionesForm) formMantenimiento;
	...
	public String setValidarMantenimiento() {
		...
		if(StringUtils.equals(f.getTipoBloqueo(), Constants.NUMERO_UNO)){
			if(StringUtils.isBlank(f.getCodigoPeriodo())){
				mensaje = this.getResourceMessage("mantenimientoSTOControlDevolucionesForm.periodo.requerido");
				return mensaje;
			}
		}		
		...
		if (StringUtils.isBlank(f.getCodigoCliente()) && StringUtils.isBlank(f.getCodigoRegion()) &&StringUtils.isBlank(f.getTipoCliente()) && flag == false) {
			mensaje = this.getResourceMessage("mantenimientoSTOControlDevolucionesForm.tipocliente.region.codigocliente.requerido");
			return mensaje;
		}
		
		if(StringUtils.isNotBlank(f.getCodigosErradosFile())){
			mensaje =this.getResourceMessage("mantenimientoSTOControlDevolucionesForm.codigocliente.corregir");
			return mensaje;
	...
	protected String getSalirForward() {
		return "mantenimientoSTOControlDevolucionesList";
	}
	...
	protected String getPaginaMantenimiento() throws Exception {
		return "mantenimientoSTOControlDevolucionesForm";
	}
	...
	protected BaseSearchForm devuelveFormBusqueda() throws Exception {
		MantenimientoSTOControlDevolucionesSearchForm searchForm = new MantenimientoSTOControlDevolucionesSearchForm();
		return searchForm;
	}
	...
	protected List setFindAttributes() throws Exception {
		...
		criteria.put("motivoBloqueo", Constants.MOTIVO_BLOQUEO_DEVOLUCIONES);
	...
	public String validadorBotonFind(){
		...
		try {
			...
			if(StringUtils.isNotBlank(f.getCodigoCliente())){
				...
				if(data == null)
					mensaje = this.getResourceMessage("mantenimientoSTOControlDevolucionesSearchForm.cliente.no.existe");
	...
	public void validador(){
		...
		try {			
			...
			if(StringUtils.isNotBlank(f.getCodigoCliente())){
				...
				if(data == null)
					this.addError("Error: ", this.getResourceMessage("mantenimientoSTOControlDevolucionesSearchForm.cliente.no.existe"));	
	...
	protected boolean setSaveAttributes() throws Exception {
		...
		String[] arrlistaClientes = new String[0];
		List clienteList = new ArrayList(); // result
		Long longitudPais = this.mPantallaPrincipalBean.getCurrentCountry()
	...
	public String devuelveMensajeAlertaDefaultAction() throws Exception {
		...
		if (this.isArchivo) 			
			return getResourceMessage("mensaje.mantenimientoSTOControlDevolucionesForm.satisfactorio.archivo", new Object[]{this.cantInsertado});					   
		else 
			return getResourceMessage("mensaje.mantenimientoSTOControlDevolucionesForm.satisfactorio");
	...
	protected BaseEditForm setObtenerRegistroAttributes() throws Exception {
		...
		MantenimientoSTOControlDevolucionesForm f = new MantenimientoSTOControlDevolucionesForm();
...
//      session.setAttribute("codigoIdiomaISO", usuario.getIdioma().getCodigoISO());        
	 ...
	 * @param f
	 */
	private void cleanForm(MantenimientoSTOControlDevolucionesSearchForm f) {
		f.setCodigoCliente("");
		f.setCodigoPeriodo("");
	...
	protected void setViewAtributes() throws Exception {
		log.debug("MantenimientoSTOControlDevolucionesSearchAction - setViewAttributes");
