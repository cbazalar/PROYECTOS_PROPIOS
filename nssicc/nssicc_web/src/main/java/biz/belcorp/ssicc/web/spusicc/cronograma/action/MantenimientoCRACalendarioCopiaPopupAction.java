...
public class MantenimientoCRACalendarioCopiaPopupAction extends
	...
	protected boolean setSaveAttributes() throws Exception {
		...
		//
		// MantenimientoCRACalendarioCopiaPopupForm f =
		// (MantenimientoCRACalendarioCopiaPopupForm) formBusqueda;
		// MantenimientoCRACalendarioService service =
		// (MantenimientoCRACalendarioService)
		// getBean("spusicc.mantenimientoCRACalendarioService");
		//
	...
	public void obtenerValores() {
		...
		f.setActividadRegenerar(null);
		this.craActividadRegenerarList.clear();
		this.craActividadRegenerarList = service
				.getActividadesExcepto(criteria);
