...
public class ProcesoPEDReemplazoProdImpNacAction extends
	...
	protected Map<String, Object> executeProcess(Map<String, Object> params)
		...
		ProcesoPEDReemplazoProdImpNacService service = (ProcesoPEDReemplazoProdImpNacService) getBean("spusicc.pedido.procesoPEDReemplazoProdImpNacService");
		...
		if (indicadorFaturacion.equals("N")) {
			...
			String mensaje = getResourceMessage(
					"procesoPEDReemplazoProdImpNacForm.pedidosFacturadosPeriodo",
					new Object[] { codigoPeriodo });
