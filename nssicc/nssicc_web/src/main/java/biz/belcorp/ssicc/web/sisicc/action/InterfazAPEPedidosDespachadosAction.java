...
@ManagedBean
@SessionScoped
public class InterfazAPEPedidosDespachadosAction extends BaseInterfazAbstractAction
{
	...
	protected BaseInterfazForm devuelveFormInterfaz() throws Exception {
		InterfazAPEPedidosDespachadosForm form = new InterfazAPEPedidosDespachadosForm(); 
		return form;
	}
