CREATE OR REPLACE FUNCTION OBT_NUM_SOL_OCR (COD_PAIS_PAR IN VARCHAR2, COD_SUBA_PAR IN VARCHAR2, VAL_OPER_PAR IN VARCHAR2, VAL_ANIO_PAR IN NUMBER) RETURN VARCHAR2
IS
NUME NUMBER;
BEGIN
