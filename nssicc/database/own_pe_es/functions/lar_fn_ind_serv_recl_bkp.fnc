CREATE OR REPLACE FUNCTION "LAR_FN_IND_SERV_RECL_BKP" (p_oid_soli_cabe IN NUMBER,
                              p_cod_peri IN VARCHAR2) RETURN VARCHAR2 IS
cont NUMBER;
...
PED_TIPO_SOLIC.OID_TIPO_SOLI)
  ...
  ( SELECT /*+ REWRITE (own_peru.vista_aux_perio_tipo) */nvl(A.SOCA_OID_SOLI_CABE,0)
