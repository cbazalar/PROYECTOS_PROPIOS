CREATE OR REPLACE FUNCTION OBT_COD_CLIE (COD_PAIS_PAR IN VARCHAR2, COD_SUBA_PAR IN VARCHAR2, VAL_OPER_PAR IN VARCHAR2, VAL_ANIO_PAR IN VARCHAR2) RETURN VARCHAR2
IS
NUME NUMBER;
BEGIN
