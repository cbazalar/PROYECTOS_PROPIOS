...
/**
 * TMsgOutObtenerDetalleConcursoConstanciaVentas.java
 *
 ...
 */
            ...
            /**
            *  TMsgOutObtenerDetalleConcursoConstanciaVentas bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TMsgOutObtenerDetalleConcursoConstanciaVentas
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tMsgOutObtenerDetalleConcursoConstanciaVentas
                ...
                */
						...
						public static class Factory{
						    ...
						    */
						    public static TMsgOutObtenerDetalleConcursoConstanciaVentas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
						        TMsgOutObtenerDetalleConcursoConstanciaVentas object =
						            new TMsgOutObtenerDetalleConcursoConstanciaVentas();
						        ...
						        try {
						            ...
						            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
						              ...
						              if (fullTypeName!=null){
						                ...
						                java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
						                        ...
						                        if (!"tMsgOutObtenerDetalleConcursoConstanciaVentas".equals(type)){
						                            //find namespace for the prefix
						                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
						                            return (TMsgOutObtenerDetalleConcursoConstanciaVentas)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
						                                 nsUri,type,reader);
						                          }
						            ...
						            java.util.Vector handledAttributes = new java.util.Vector();
						                ...
						                reader.next();
						                                ...
						                                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","datos").equals(reader.getName())){
						                            
						                                            object.setDatos(biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type6.Factory.parse(reader));
						                                ...
						                                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","paginacion").equals(reader.getName())){
						                                ...
						                                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","ordenamiento").equals(reader.getName())){
						                                ...
						                                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","auditoria").equals(reader.getName())){
							...
							*/
							            ...
							            protected biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type6 localDatos ;
                        ...
                        */
                        ...
                        /**
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type6
                           */
                           public  biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type6 getDatos(){
                               return localDatos;
                           }
      ...
      public org.apache.axiom.om.OMElement getOMElement (
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tMsgOutObtenerDetalleConcursoConstanciaVentas",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tMsgOutObtenerDetalleConcursoConstanciaVentas",
                           xmlWriter);
                   }
                                           ...
                                           localDatos.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","datos"),
                                               xmlWriter);
                                        
                                            if (localPaginacion==null){
                                                 throw new org.apache.axis2.databinding.ADBException("paginacion cannot be null!!");
                                            }
                                           localPaginacion.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","paginacion"),
                                               xmlWriter);
                                        
                                            if (localOrdenamiento==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ordenamiento cannot be null!!");
                                            }
                                           localOrdenamiento.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","ordenamiento"),
                                               xmlWriter);
                                        
                                            if (localAuditoria==null){
                                                 throw new org.apache.axis2.databinding.ADBException("auditoria cannot be null!!");
                                            }
                                           localAuditoria.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","auditoria"),
                                               xmlWriter);
        ...
        /**
		   ...
		   * @param param Datos
		   */
		   public void setDatos(biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type6 param){
	...
	private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart,
	    ...
	    if (writerPrefix != null) {
	        ...
	        //Si hay data 
	        if (localDatos.localListaDetalleConcursoConstanciaVentas.length > 0) {
                xmlWriter.writeNamespace("ns6", "http://www.belcorp.biz/canonico/ffvv/Motivar");
