 ...
 */
            ...
            /**
            *  TCDRTipoAtencion bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TCDRTipoAtencion
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tCDRTipoAtencion
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tCDRTipoAtencion",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tCDRTipoAtencion",
    ...
    public static class Factory{
        ...
        */
        public static TCDRTipoAtencion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TCDRTipoAtencion object =
                new TCDRTipoAtencion();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tCDRTipoAtencion".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TCDRTipoAtencion)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
