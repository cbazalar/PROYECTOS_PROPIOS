...
/**
 * TMsgInObtenerPedidosNuevas.java
 *
 ...
 */
            ...
            /**
            *  TMsgInObtenerPedidosNuevas bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TMsgInObtenerPedidosNuevas
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tMsgInObtenerPedidosNuevas
                ...
                */
                        ...
                        */
                                    ...
                                    protected biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type16 localDatos ;
                                

                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type16
                           */
                           public  biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type16 getDatos(){
                               return localDatos;
                           }
                            ...
                            /**
                               ...
                               * @param param Datos
                               */
                               public void setDatos(biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type16 param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tMsgInObtenerPedidosNuevas",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tMsgInObtenerPedidosNuevas",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static TMsgInObtenerPedidosNuevas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TMsgInObtenerPedidosNuevas object =
                new TMsgInObtenerPedidosNuevas();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tMsgInObtenerPedidosNuevas".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TMsgInObtenerPedidosNuevas)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","datos").equals(reader.getName())){
                                                ...
                                                object.setDatos(biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type16.Factory.parse(reader));
