 ...
 */
            ...
            /**
            *  TCDRMotivo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TCDRMotivo
    ...
    public static class Factory{
        ...
        */
        public static TCDRMotivo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TCDRMotivo object =
                new TCDRMotivo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tCDRMotivo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TCDRMotivo)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
