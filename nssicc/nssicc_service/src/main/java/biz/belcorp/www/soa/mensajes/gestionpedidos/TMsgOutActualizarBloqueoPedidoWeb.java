...
/**
 * TMsgOutActualizarBloqueoPedidoWeb.java
 *
 ...
 */
            ...
            /**
            *  TMsgOutActualizarBloqueoPedidoWeb bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TMsgOutActualizarBloqueoPedidoWeb
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tMsgOutActualizarBloqueoPedidoWeb
                ...
                */
                        ...
                        */
                                    ...
                                    protected biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type7 localDatos ;
                                

                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type7
                           */
                           public  biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type7 getDatos(){
                               return localDatos;
                           }
                            ...
                            /**
                               ...
                               * @param param Datos
                               */
                               public void setDatos(biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type7 param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tMsgOutActualizarBloqueoPedidoWeb",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tMsgOutActualizarBloqueoPedidoWeb",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static TMsgOutActualizarBloqueoPedidoWeb parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TMsgOutActualizarBloqueoPedidoWeb object =
                new TMsgOutActualizarBloqueoPedidoWeb();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tMsgOutActualizarBloqueoPedidoWeb".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TMsgOutActualizarBloqueoPedidoWeb)biz.belcorp.www.soa.business.ffvv.sicc.pedidosbs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionPedidos","datos").equals(reader.getName())){
                                                ...
                                                object.setDatos(biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type7.Factory.parse(reader));
