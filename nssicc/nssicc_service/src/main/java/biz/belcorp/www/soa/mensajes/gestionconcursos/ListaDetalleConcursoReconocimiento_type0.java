...
/**
 * ListaDetalleConcursoReconocimiento_type0.java
 *
 ...
 */
            ...
            /**
            *  ListaDetalleConcursoReconocimiento_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListaDetalleConcursoReconocimiento_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = listaDetalleConcursoReconocimiento_type0
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for ParticipadoReconocimiento
                        */

                        
                                    protected biz.belcorp.www.canonico.ffvv.motivar.TParticipadoReconocimiento localParticipadoReconocimiento ;
                                

                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.canonico.ffvv.motivar.TParticipadoReconocimiento
                           */
                           public  biz.belcorp.www.canonico.ffvv.motivar.TParticipadoReconocimiento getParticipadoReconocimiento(){
                               return localParticipadoReconocimiento;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ParticipadoReconocimiento
                               */
                               public void setParticipadoReconocimiento(biz.belcorp.www.canonico.ffvv.motivar.TParticipadoReconocimiento param){
                            
                                            this.localParticipadoReconocimiento=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listaDetalleConcursoReconocimiento_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listaDetalleConcursoReconocimiento_type0",
                           xmlWriter);
                   }
                                           ...
                                           localSeccion.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","seccion"),
                                            ...
                                            if (localParticipadoReconocimiento==null){
                                                 throw new org.apache.axis2.databinding.ADBException("participadoReconocimiento cannot be null!!");
                                            }
                                           localParticipadoReconocimiento.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","participadoReconocimiento"),
                                               xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos",
                                                                      "participadoReconocimiento"));
                            
                            
                                    if (localParticipadoReconocimiento==null){
                                         throw new org.apache.axis2.databinding.ADBException("participadoReconocimiento cannot be null!!");
                                    }
                                    elementList.add(localParticipadoReconocimiento);
    ...
    public static class Factory{
        ...
        */
        public static ListaDetalleConcursoReconocimiento_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListaDetalleConcursoReconocimiento_type0 object =
                new ListaDetalleConcursoReconocimiento_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listaDetalleConcursoReconocimiento_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListaDetalleConcursoReconocimiento_type0)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","participadoReconocimiento").equals(reader.getName())){
                                
                                                object.setParticipadoReconocimiento(biz.belcorp.www.canonico.ffvv.motivar.TParticipadoReconocimiento.Factory.parse(reader));
