 ...
 */
            ...
            /**
            *  Datos_type12 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Datos_type12
    ...
    public static class Factory{
        ...
        */
        public static Datos_type12 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Datos_type12 object =
                new Datos_type12();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"datos_type12".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Datos_type12)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
