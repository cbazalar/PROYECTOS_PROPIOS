...
/**
 * TMsgOutObtenerDetalleConcursoRecomendacion.java
 *
 ...
 */
            ...
            /**
            *  TMsgOutObtenerDetalleConcursoRecomendacion bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TMsgOutObtenerDetalleConcursoRecomendacion
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tMsgOutObtenerDetalleConcursoRecomendacion
                ...
                */
						...
						public static class Factory{
						    ...
						    */
						    public static TMsgOutObtenerDetalleConcursoRecomendacion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
						        TMsgOutObtenerDetalleConcursoRecomendacion object =
						            new TMsgOutObtenerDetalleConcursoRecomendacion();
						            ...
						            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
						              ...
						              if (fullTypeName!=null){
						                ...
						                java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
						                        ...
						                        if (!"tMsgOutObtenerDetalleConcursoRecomendacion".equals(type)){
						                            //find namespace for the prefix
						                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
						                            return (TMsgOutObtenerDetalleConcursoRecomendacion)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
						                                 nsUri,type,reader);
						                          }
						            ...
						            java.util.Vector handledAttributes = new java.util.Vector();
						                ...
						                reader.next();
						                                ...
						                                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","datos").equals(reader.getName())){
						                                            ...
						                                            object.setDatos(biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type2.Factory.parse(reader));
							...
							*/
							            ...
							            protected biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type2 localDatos ;
                        ...
                        */
                        ...
                        /**
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type2
                           */
                           public  biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type2 getDatos(){
                               return localDatos;
                           }
      ...
      public org.apache.axiom.om.OMElement getOMElement (
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tMsgOutObtenerDetalleConcursoRecomendacion",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tMsgOutObtenerDetalleConcursoRecomendacion",
                           xmlWriter);
                   }
        ...
        /**
		   ...
		   * @param param Datos
		   */
		   public void setDatos(biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type2 param){
	...
	private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart,
	    ...
	    if (writerPrefix != null) {
	        ...
	        //Si hay data 
	        if (localDatos.localListaDetallesConcursoRecomendacion.length > 0) {
