 ...
 */
            ...
            /**
            *  TMsgInObtenerPedidosWeb bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TMsgInObtenerPedidosWeb
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tMsgInObtenerPedidosWeb
                ...
                */
                        ...
                        */
                                    ...
                                    protected biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type0 localDatos ;
                                

                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type0
                           */
                           public  biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type0 getDatos(){
                               return localDatos;
                           }
                            ...
                            /**
                               ...
                               * @param param Datos
                               */
                               public void setDatos(biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type0 param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tMsgInObtenerPedidosWeb",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tMsgInObtenerPedidosWeb",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static TMsgInObtenerPedidosWeb parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TMsgInObtenerPedidosWeb object =
                new TMsgInObtenerPedidosWeb();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tMsgInObtenerPedidosWeb".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TMsgInObtenerPedidosWeb)biz.belcorp.www.soa.business.ffvv.sicc.pedidosbs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionPedidos","datos").equals(reader.getName())){
                                                ...
                                                object.setDatos(biz.belcorp.www.soa.mensajes.gestionpedidos.Datos_type0.Factory.parse(reader));
