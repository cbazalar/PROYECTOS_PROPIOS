 ...
 */
            ...
            /**
            *  TEstadoConcurso bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TEstadoConcurso
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tEstadoConcurso
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tEstadoConcurso",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tEstadoConcurso",
    ...
    public static class Factory{
        ...
        */
        public static TEstadoConcurso parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TEstadoConcurso object =
                new TEstadoConcurso();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tEstadoConcurso".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TEstadoConcurso)biz.belcorp.www.soa.business.ffvv.sicc.consultorabs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
