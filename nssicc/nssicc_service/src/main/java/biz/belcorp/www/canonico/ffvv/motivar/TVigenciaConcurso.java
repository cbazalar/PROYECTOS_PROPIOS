 ...
 */
            ...
            /**
            *  TVigenciaConcurso bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TVigenciaConcurso
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tVigenciaConcurso
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tVigenciaConcurso",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tVigenciaConcurso",
    ...
    public static class Factory{
        ...
        */
        public static TVigenciaConcurso parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TVigenciaConcurso object =
                new TVigenciaConcurso();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tVigenciaConcurso".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TVigenciaConcurso)biz.belcorp.www.soa.business.ffvv.sicc.consultorabs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
