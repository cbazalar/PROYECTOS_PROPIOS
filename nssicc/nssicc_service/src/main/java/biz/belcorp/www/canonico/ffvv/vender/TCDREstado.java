 ...
 */
            ...
            /**
            *  TCDREstado bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TCDREstado
    ...
    public static class Factory{
        ...
        */
        public static TCDREstado parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TCDREstado object =
                new TCDREstado();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tCDREstado".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TCDREstado)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
