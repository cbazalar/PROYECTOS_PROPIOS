 ...
 */
            ...
            /**
            *  TEnumeracion bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TEnumeracion
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getValor(){
                              ...
                              /**
                               * validate the array for Valor
                               */
                              protected void validateValor(java.lang.String[] param){
                             ...
                             */
                             public void addValor(java.lang.String param){
                                   if (localValor == null){
                                   localValor = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localValor);
                               list.add(param);
                               this.localValor =
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                             ...
                             if (localValor!=null) {
                                   namespace = "http://www.belcorp.biz/ssg/Comun";
                                   for (int i = 0;i < localValor.length;i++){
                                        
                                            if (localValor[i] != null){
                                        
                                                writeStartElement(null, namespace, "valor", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localValor[i]));
                                  ...
                                  for (int i = 0;i < localValor.length;i++){
                                         ...
                                         if (localValor[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://www.belcorp.biz/ssg/Comun",
                                                                              "valor"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localValor[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static TEnumeracion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TEnumeracion object =
                new TEnumeracion();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tEnumeracion".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TEnumeracion)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/ssg/Comun","valor").equals(reader.getName())){
                                    ...
                                    list2.add(reader.getElementText());
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://www.belcorp.biz/ssg/Comun","valor").equals(reader.getName())){
                                                         list2.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setValor((java.lang.String[])
