...
/**
 * ListaDetalleRegaloPedido_type0.java
 *
 ...
 */
            ...
            /**
            *  ListaDetalleRegaloPedido_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListaDetalleRegaloPedido_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = listaDetalleRegaloPedido_type0
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for ParticipadoRegaloXPedido
                        */

                        
                                    protected biz.belcorp.www.canonico.ffvv.motivar.TParticipadoRegaloXPedido localParticipadoRegaloXPedido ;
                                

                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.canonico.ffvv.motivar.TParticipadoRegaloXPedido
                           */
                           public  biz.belcorp.www.canonico.ffvv.motivar.TParticipadoRegaloXPedido getParticipadoRegaloXPedido(){
                               return localParticipadoRegaloXPedido;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ParticipadoRegaloXPedido
                               */
                               public void setParticipadoRegaloXPedido(biz.belcorp.www.canonico.ffvv.motivar.TParticipadoRegaloXPedido param){
                            
                                            this.localParticipadoRegaloXPedido=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listaDetalleRegaloPedido_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listaDetalleRegaloPedido_type0",
                           xmlWriter);
                   }
                                           ...
                                           localSeccion.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","seccion"),
                                            ...
                                            if (localParticipadoRegaloXPedido==null){
                                                 throw new org.apache.axis2.databinding.ADBException("participadoRegaloXPedido cannot be null!!");
                                            }
                                           localParticipadoRegaloXPedido.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","participadoRegaloXPedido"),
                                               xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos",
                                                                      "participadoRegaloXPedido"));
                            
                            
                                    if (localParticipadoRegaloXPedido==null){
                                         throw new org.apache.axis2.databinding.ADBException("participadoRegaloXPedido cannot be null!!");
                                    }
                                    elementList.add(localParticipadoRegaloXPedido);
    ...
    public static class Factory{
        ...
        */
        public static ListaDetalleRegaloPedido_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListaDetalleRegaloPedido_type0 object =
                new ListaDetalleRegaloPedido_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listaDetalleRegaloPedido_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListaDetalleRegaloPedido_type0)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","participadoRegaloXPedido").equals(reader.getName())){
                                
                                                object.setParticipadoRegaloXPedido(biz.belcorp.www.canonico.ffvv.motivar.TParticipadoRegaloXPedido.Factory.parse(reader));
