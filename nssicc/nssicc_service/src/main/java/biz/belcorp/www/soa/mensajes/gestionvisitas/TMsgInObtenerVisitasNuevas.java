...
/**
 * TMsgInObtenerVisitasNuevas.java
 *
 ...
 */
            ...
            /**
            *  TMsgInObtenerVisitasNuevas bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TMsgInObtenerVisitasNuevas
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tMsgInObtenerVisitasNuevas
                ...
                */
                        ...
                        */
                                    ...
                                    protected biz.belcorp.www.soa.mensajes.gestionvisitas.Datos_type1 localDatos ;
                                

                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.soa.mensajes.gestionvisitas.Datos_type1
                           */
                           public  biz.belcorp.www.soa.mensajes.gestionvisitas.Datos_type1 getDatos(){
                               return localDatos;
                           }
                            ...
                            /**
                               ...
                               * @param param Datos
                               */
                               public void setDatos(biz.belcorp.www.soa.mensajes.gestionvisitas.Datos_type1 param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tMsgInObtenerVisitasNuevas",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tMsgInObtenerVisitasNuevas",
                           xmlWriter);
                   }
                                           ...
                                           localDatos.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionVisitas","datos"),
                                               xmlWriter);
                                        
                                            if (localPaginacion==null){
                                                 throw new org.apache.axis2.databinding.ADBException("paginacion cannot be null!!");
                                            }
                                           localPaginacion.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionVisitas","paginacion"),
                                               xmlWriter);
                                        
                                            if (localOrdenamiento==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ordenamiento cannot be null!!");
                                            }
                                           localOrdenamiento.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionVisitas","ordenamiento"),
                                               xmlWriter);
                                        
                                            if (localAuditoria==null){
                                                 throw new org.apache.axis2.databinding.ADBException("auditoria cannot be null!!");
                                            }
                                           localAuditoria.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionVisitas","auditoria"),
                                               xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static TMsgInObtenerVisitasNuevas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TMsgInObtenerVisitasNuevas object =
                new TMsgInObtenerVisitasNuevas();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tMsgInObtenerVisitasNuevas".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TMsgInObtenerVisitasNuevas)biz.belcorp.www.soa.business.ffvv.sicc.visitasbs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionVisitas","datos").equals(reader.getName())){
                                
                                                object.setDatos(biz.belcorp.www.soa.mensajes.gestionvisitas.Datos_type1.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionVisitas","paginacion").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionVisitas","ordenamiento").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionVisitas","auditoria").equals(reader.getName())){
