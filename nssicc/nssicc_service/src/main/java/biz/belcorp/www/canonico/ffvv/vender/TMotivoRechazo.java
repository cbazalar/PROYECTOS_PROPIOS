 ...
 */
            ...
            /**
            *  TMotivoRechazo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TMotivoRechazo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tMotivoRechazo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tMotivoRechazo",
    ...
    public static class Factory{
        ...
        */
        public static TMotivoRechazo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TMotivoRechazo object =
                new TMotivoRechazo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tMotivoRechazo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TMotivoRechazo)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
