 ...
 */
            ...
            /**
            *  TEstadoPedido bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TEstadoPedido
    ...
    public static class Factory{
        ...
        */
        public static TEstadoPedido parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TEstadoPedido object =
                new TEstadoPedido();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tEstadoPedido".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TEstadoPedido)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
