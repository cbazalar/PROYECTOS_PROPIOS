 ...
 */
            ...
            /**
            *  TTipoVisita bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TTipoVisita
    ...
    public static class Factory{
        ...
        */
        public static TTipoVisita parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TTipoVisita object =
                new TTipoVisita();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tTipoVisita".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TTipoVisita)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
