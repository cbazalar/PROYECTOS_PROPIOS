...
/**
 * TMsgOutObtenerDetalleConsultoraRecomendada.java
 *
 ...
 */
            ...
            /**
            *  TMsgOutObtenerDetalleConsultoraRecomendada bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TMsgOutObtenerDetalleConsultoraRecomendada
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tMsgOutObtenerDetalleConsultoraRecomendada
                ...
                */
						...
						public static class Factory{
						    ...
						    */
						    public static TMsgOutObtenerDetalleConsultoraRecomendada parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
						        TMsgOutObtenerDetalleConsultoraRecomendada object =
						            new TMsgOutObtenerDetalleConsultoraRecomendada();
						            ...
						            if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
						              ...
						              if (fullTypeName!=null){
						                ...
						                java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
						                        ...
						                        if (!"tMsgOutObtenerDetalleConsultoraRecomendada".equals(type)){
						                            //find namespace for the prefix
						                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
						                            return (TMsgOutObtenerDetalleConsultoraRecomendada)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
						                                 nsUri,type,reader);
						                          }
						            ...
						            java.util.Vector handledAttributes = new java.util.Vector();
						                ...
						                reader.next();
						                                ...
						                                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","datos").equals(reader.getName())){
						                                            ...
						                                            object.setDatos(biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type11.Factory.parse(reader));
							...
							*/
							            ...
							            protected biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type11 localDatos ;
                        ...
                        */
                        ...
                        /**
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type11
                           */
                           public  biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type11 getDatos(){
                               return localDatos;
                           }
      ...
      public org.apache.axiom.om.OMElement getOMElement (
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tMsgOutObtenerDetalleConsultoraRecomendada",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tMsgOutObtenerDetalleConsultoraRecomendada",
                           xmlWriter);
                   }
        ...
        /**
		   ...
		   * @param param Datos
		   */
		   public void setDatos(biz.belcorp.www.soa.mensajes.gestionconcursos.Datos_type11 param){
	...
	private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart,
	    ...
	    if (writerPrefix != null) {
	        ...
	        //Si hay data 
	        if (localDatos.localListaConsultoraRecomendada.length > 0) {
