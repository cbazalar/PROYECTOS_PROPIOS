 ...
 */
            ...
            /**
            *  Datos_type4 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Datos_type4
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (localPais==null){
                                        ...
                                        writeStartElement(null, "http://www.belcorp.biz/soa/mensajes/GestionCobranzas", "pais", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static Datos_type4 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Datos_type4 object =
                new Datos_type4();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"datos_type4".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Datos_type4)biz.belcorp.www.soa.business.ffvv.sicc.cobranzasbs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
