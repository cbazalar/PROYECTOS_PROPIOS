...
/**
 * ListaDetallesConcursoProgramaNuevas_type0.java
 *
 ...
 */
            ...
            /**
            *  ListaDetallesConcursoProgramaNuevas_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListaDetallesConcursoProgramaNuevas_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = listaDetallesConcursoProgramaNuevas_type0
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for ParticipadoProgramaNuevas
                        */

                        
                                    protected biz.belcorp.www.canonico.ffvv.motivar.TParticipadoProgramaNuevas localParticipadoProgramaNuevas ;
                                

                           /**
                           * Auto generated getter method
                           * @return biz.belcorp.www.canonico.ffvv.motivar.TParticipadoProgramaNuevas
                           */
                           public  biz.belcorp.www.canonico.ffvv.motivar.TParticipadoProgramaNuevas getParticipadoProgramaNuevas(){
                               return localParticipadoProgramaNuevas;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ParticipadoProgramaNuevas
                               */
                               public void setParticipadoProgramaNuevas(biz.belcorp.www.canonico.ffvv.motivar.TParticipadoProgramaNuevas param){
                            
                                            this.localParticipadoProgramaNuevas=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listaDetallesConcursoProgramaNuevas_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listaDetallesConcursoProgramaNuevas_type0",
                           xmlWriter);
                   }
                                           ...
                                           localSeccion.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","seccion"),
                                            ...
                                            if (localParticipadoProgramaNuevas==null){
                                                 throw new org.apache.axis2.databinding.ADBException("participadoProgramaNuevas cannot be null!!");
                                            }
                                           localParticipadoProgramaNuevas.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","participadoProgramaNuevas"),
                                               xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos",
                                                                      "participadoProgramaNuevas"));
                            
                            
                                    if (localParticipadoProgramaNuevas==null){
                                         throw new org.apache.axis2.databinding.ADBException("participadoProgramaNuevas cannot be null!!");
                                    }
                                    elementList.add(localParticipadoProgramaNuevas);
    ...
    public static class Factory{
        ...
        */
        public static ListaDetallesConcursoProgramaNuevas_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListaDetallesConcursoProgramaNuevas_type0 object =
                new ListaDetallesConcursoProgramaNuevas_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listaDetallesConcursoProgramaNuevas_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListaDetallesConcursoProgramaNuevas_type0)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/soa/mensajes/GestionConcursos","participadoProgramaNuevas").equals(reader.getName())){
                                
                                                object.setParticipadoProgramaNuevas(biz.belcorp.www.canonico.ffvv.motivar.TParticipadoProgramaNuevas.Factory.parse(reader));
