 ...
 */
            ...
            /**
            *  TDuplaCyzone bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TDuplaCyzone
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for InformacionPersona
                        */

                        
                                    protected biz.belcorp.www.canonico.ffvv.persona.TPersona localInformacionPersona ;
                           ...
                           */
                           public  biz.belcorp.www.canonico.ffvv.persona.TPersona getInformacionPersona(){
                               return localInformacionPersona;
                           }
                            ...
                            /**
                               ...
                               * @param param InformacionPersona
                               */
                               public void setInformacionPersona(biz.belcorp.www.canonico.ffvv.persona.TPersona param){
                            
                                            this.localInformacionPersona=param;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (localInformacionPersona==null){

                                        writeStartElement(null, "http://www.belcorp.biz/canonico/ffvv/Vender", "informacionPersona", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localInformacionPersona.serialize(new javax.xml.namespace.QName("http://www.belcorp.biz/canonico/ffvv/Vender","informacionPersona"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.belcorp.biz/canonico/ffvv/Vender",
                                    ...
                                    elementList.add(localInformacionPersona==null?null:
                                    localInformacionPersona);
    ...
    public static class Factory{
        ...
        */
        public static TDuplaCyzone parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TDuplaCyzone object =
                new TDuplaCyzone();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tDuplaCyzone".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TDuplaCyzone)biz.belcorp.www.soa.business.ffvv.sicc.concursobs.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.belcorp.biz/canonico/ffvv/Vender","informacionPersona").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setInformacionPersona(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setInformacionPersona(biz.belcorp.www.canonico.ffvv.persona.TPersona.Factory.parse(reader));
