...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepcionarExcepcionesFechaEntregaExactaWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarExcepcionesFechaEntregaExactaWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSATRecepcionarExcepcionesFechaEntregaExactaWebServiceImpl
		extends BaseInterfazAbstractWebService implements
		ACOProcesoSATRecepcionarExcepcionesFechaEntregaExactaWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSATRecepcionarExcepcionesFechaEntregaExactaWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		String CODIGO_INTERFAZ = Constants.SAT_CODIGO_INTERFAZ_RECEPCIONAR_EXEPCIONES_FECHA_ENTREGA_EXACTA;
