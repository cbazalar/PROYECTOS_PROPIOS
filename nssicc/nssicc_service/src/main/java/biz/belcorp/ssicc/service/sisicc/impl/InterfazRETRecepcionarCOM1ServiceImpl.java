...
/**
 * Service para la recepcion del archivo COM-1 de la Interfaz RET.
 * 
 * @author <a href="mailto:lshimokawa@belcorp.biz">Lennon Shimokawa</a>
 */

@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazRETRecepcionarCOM1ServiceImpl extends
	...
	protected void processLine(InterfazParams interfazParams, int lineCount,
		...
		interfazSiCCDAO.insertarInterfazRETRecepcionarCOM1(row);
	}
