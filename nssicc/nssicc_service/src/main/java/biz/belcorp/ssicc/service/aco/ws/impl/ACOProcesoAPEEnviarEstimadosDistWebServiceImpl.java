...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoAPEEnviarEstimadosDistWebService;
 ...
 */
public class ACOProcesoAPEEnviarEstimadosDistWebServiceImpl extends BaseInterfazAbstractWebService implements ACOProcesoAPEEnviarEstimadosDistWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoACOProcesoAPEEnviarEstimadosDist(
		...
		String mensajeError = "";		
		final String CODIGO_INTERFAZ = "APE-9";
		final String CODIGO_SISTEMA = "APE";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso ejecutarProcesoACOProcesoAPEEnviarEstimadosDist");
		}
		try{
