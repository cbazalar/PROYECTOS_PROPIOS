...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoLARRecepResCheWebService;
 ...
 */
public class ACOProcesoLARRecepResCheWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoLARRecepResCheWebService {	
	
	private final String mensajeNoHayArchivos = "No hay archivos en el directorio";
	...
	public ACOWebServiceResponse ejecutarProcesoLARRecepResChe(
		...
		final String CODIGO_INTERFAZ = "LAR-P2";
		final String CODIGO_SISTEMA = "LAR";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoLARRecepResChe");
		}
		try{
...
//		    Usuario usuario = this.usuarioService.getUsuarioByUsername(codigoUsuario);
			...
			if(mensajeNoHayArchivos.equals(e.getMessage())) {
				estado = true;
