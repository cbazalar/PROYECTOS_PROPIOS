 ...
 * <p>
 * <a href="InterfazDATEnviarMaestroBajaServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author Yahir Rivas L.
 */
@Service("sisicc.interfazDATEnviarMaestroBajaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazDATEnviarMaestroBajaServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService{
	...
	protected void executeStoreProcedure(Map params) {
		interfazDATDAO.executeInterfazDATEnviarMaestroBajas(params);
