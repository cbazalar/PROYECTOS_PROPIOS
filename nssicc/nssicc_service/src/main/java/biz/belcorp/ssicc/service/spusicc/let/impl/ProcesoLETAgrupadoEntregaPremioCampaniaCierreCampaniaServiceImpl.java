 ...
 *
 */
@Service("spusicc.procesoLETAgrupadoEntregaPremioCampaniaCierreCampaniaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoLETAgrupadoEntregaPremioCampaniaCierreCampaniaServiceImpl extends BaseInterfazProcesoAbstractService{
