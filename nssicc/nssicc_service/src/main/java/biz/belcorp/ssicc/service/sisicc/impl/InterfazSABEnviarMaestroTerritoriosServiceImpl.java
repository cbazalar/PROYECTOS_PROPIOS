...
/**
 * Service InterfazVENEnviarMaestroTerritoriosServiceImpl.
 * 
 * @author <a href="mailto:">Sergio Buchelli</a>
 */
@Service("sisicc.interfazSABEnviarMaestroTerritoriosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSABEnviarMaestroTerritoriosServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSABDAO
				.executeInterfazVENEnviarMaestroTerritorios(params);
	}	
