...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoAPEPedidosDespachadosWebService;
 ...
 * <p>
 * <a href="ACOProcesoAPEPedidosDespachadosWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto</a>
 */
public class ACOProcesoAPEPedidosDespachadosWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoAPEPedidosDespachadosWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoAPEPedidosDespachadosWebService#ejecutarProcesoAPEPedidosDespachados(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProcesoAPEPedidosDespachados(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = Constants.APE_CODIGO_PROCESO_BATCH_PEDIDOS_DESPACHADOS;
		final String CODIGO_INTERFAZ = Constants.APE_CODIGO_INTERFAZ_PEDIDOS_DESPACHADOS;
		final String CODIGO_SISTEMA = Constants.APE_CODIGO_SISTEMA;
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoAPEPedidosDespachados");
		}
		try{
