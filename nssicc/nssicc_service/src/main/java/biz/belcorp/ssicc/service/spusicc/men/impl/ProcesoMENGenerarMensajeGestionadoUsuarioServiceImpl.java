 ...
 */
@Service("spusicc.procesoMENGenerarMensajeGestionadoUsuarioService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensajeGestionadoUsuarioServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENGenerarMensajeGestionadoUsuarioServiceImpl " + params);
