...
/**
 * <p>
 * <a href="ProcesoIMPSpoolNotaDebitoLaserMultihiloServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("spisicc.procesoIMPSpoolNotaDebitoLaserMultihiloService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolNotaDebitoLaserMultihiloServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolNotaDebitoLaserMultihilo(proceso);
		} catch (Exception e) {
