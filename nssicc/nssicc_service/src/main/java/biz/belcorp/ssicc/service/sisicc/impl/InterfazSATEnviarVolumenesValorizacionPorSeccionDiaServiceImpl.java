 ...
 */
@Service("sisicc.interfazSATEnviarVolumenesValorizacionPorSeccionDiaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSATEnviarVolumenesValorizacionPorSeccionDiaServiceImpl extends
BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO
				.getInterfazSATEnviarVolumenesValorizacionPorSeccionDia(params);
	}
