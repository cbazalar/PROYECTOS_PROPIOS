...
@Service("sisicc.interfazPRERecepcionarRangoOfertaNivelesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRERecepcionarRangoOfertaNivelesServiceImpl extends BaseInterfazEntradaAbstractService 
{
	...
	{	
		...
		for(int i=0; i< data.size(); i++)
		{
			...
			interfazPREDAO.insertRangoOfertaNiveles(criteria);
			j++;
		}
	}
