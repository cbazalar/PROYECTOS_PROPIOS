 ...
 * <p>
 * <a href="InterfazSAMEnviarInicializacionStoksServiceImpl.java.html"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazSAMEnviarInicializacionStoksService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSAMEnviarInicializacionStoksServiceImpl extends
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		List list = null;
		try {
			list = this.interfazSiCCDAO.getInterfazSAMEnviarInicializacionStocks(queryParams);
