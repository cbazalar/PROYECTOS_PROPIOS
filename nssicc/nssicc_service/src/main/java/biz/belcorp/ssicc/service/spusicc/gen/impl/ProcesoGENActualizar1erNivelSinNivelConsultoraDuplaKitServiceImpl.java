 ...
 *
 */
@Service("spusicc.procesoGENActualizar1erNivelSinNivelConsultoraDuplaKitService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoGENActualizar1erNivelSinNivelConsultoraDuplaKitServiceImpl extends BaseInterfazProcesoAbstractService{
	...
	protected void executeStoreProcedure(Map params) throws InterfazException,
		...
		procesoGENActualizarNivelConsultoraDuplaKitDAO.executeProcesoGENActualizar1erNivelSinNivelConsultoraDuplaKit(params);
	}
