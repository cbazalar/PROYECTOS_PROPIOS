...
@Service("sisicc.interfazWEBRecepcionarFamiliaSeguraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class  InterfazWEBRecepcionarFamiliaSeguraServiceImpl extends BaseInterfazEntradaAbstractService {
