 ...
 * 
 */
@Service("sisicc.interfazFLXRecepcionarConsultorasRecomendadasWEBService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFLXRecepcionarConsultorasRecomendadasWEBServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	throws InterfazException {
    	...
    	try {
    		...
    		interfazFLXDAO.executeRecepcionarConsultorasRecomendadasWEB(map);
