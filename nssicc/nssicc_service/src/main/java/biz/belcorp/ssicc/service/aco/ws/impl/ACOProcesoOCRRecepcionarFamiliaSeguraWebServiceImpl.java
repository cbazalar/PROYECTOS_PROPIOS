...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCRRecepcionarFamiliaSeguraWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoOCRRecepcionarFamiliaSeguraWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoOCRRecepcionarFamiliaSeguraWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoOCRRecepcionarFamiliaSeguraWebService {
	...
	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoOCRRecepcionarFamiliaSeguraWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.OCR_CODIGO_PROCESO_BATCH_RECEPCIONAR_ARCHIVO_FAMILIA_SEGURA;
		String CODIGO_INTERFAZ = Constants.OCR_CODIGO_INTERFAZ_RECEPCIONAR_ARCHIVO_FAMILIA_SEGURA;
