 ...
 * <p>
 * <a href="InterfazIMPEnviarBoletas065CabeceraPeruServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cbazalar@sigcomt.com">Carlos Bazalar</a>
 */
@Service("sisicc.interfazIMPEnviarBoletas065CabeceraPeruService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarBoletas065CabeceraPeruServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		...
		if (StringUtils.isNotBlank(codigoPeriodo) && StringUtils.isNotBlank(fechaFacturacion))
			interfazIMPDAO.executeInterfazIMPEnviarBoletas065CabeceraPeru(params);
		else
	...
	protected void afterProcessInterfaz(InterfazParams interfazParams)
		...
		List <String> listNombreArchivosSalida = interfazParams.getListNombreArchivosGenerados(nombreArchivo, "ZIP");
