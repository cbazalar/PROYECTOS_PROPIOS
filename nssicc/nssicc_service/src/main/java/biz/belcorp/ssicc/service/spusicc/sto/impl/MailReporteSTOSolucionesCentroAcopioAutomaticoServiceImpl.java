 ...
 */
@Service("sto.mailReporteSTOSolucionesCentroAcopioAutomaticoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class MailReporteSTOSolucionesCentroAcopioAutomaticoServiceImpl extends BaseMailReporteAbstractService {
	/* (non-Javadoc)
	...
	protected String getSubject(MailParams mailParams) throws Exception {
		...
		titulo = titulo + " - Centro de acopio: " + (String) parameterMap.get("nomCentroAcopio") 
						+ " - Compañia de transporte " + (String) parameterMap.get("ciaTransporte");
		return titulo;
	}
