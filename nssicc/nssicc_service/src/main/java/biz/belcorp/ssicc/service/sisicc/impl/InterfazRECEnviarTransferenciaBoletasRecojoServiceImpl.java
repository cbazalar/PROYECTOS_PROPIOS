 ...
 * </i> </a>
 * </p>
 * ="mailto:jc="mailto:jc="mailto:jc="mailto:jc="mailto:jc="mailto:jc="mailto:jc
 * @author <a href="mailto:jcairampoma@belcorp.biz">Jos A. Cairampoma</a>
 */
@Service("sisicc.interfazRECEnviarTransferenciaBoletasRecojoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazRECEnviarTransferenciaBoletasRecojoServiceImpl extends	BaseInterfazSalidaStoredProcedureAbstractService {
	...
	@Resource(name="sisicc.interfazRECService")
	protected InterfazRECService svc;
	...
	public Map prepareQueryParams(InterfazParams interfazParams) throws InterfazException {
		...
		String indicadorAnulacion =  interfazSiCCDAO.getIndicadorAnulacionByCriteria(queryParams);
		queryParams.put("indicadorAnulacion", indicadorAnulacion);
	...
	protected void beforeProcessInterfaz(InterfazParams interfazParams)	throws InterfazException {
		...
		interfazSiCCDAO.deleteInterfazRECEnviarTransferenciaBoletasRecojo();
		String indicadorAnulacion =  interfazSiCCDAO.getIndicadorAnulacionByCriteria(map);
		if (Constants.IND_OPERACION_ANULADO.equals(indicadorAnulacion)) 
			interfazSiCCDAO.insertInterfazRECEnviarTransferenciaBoletasRecojoAnulacion(map);
		else 
			interfazSiCCDAO.insertInterfazRECEnviarTransferenciaBoletasRecojo(map);
	...
	protected void executeStoreProcedure(Map params) {
		...
		interfazSiCCDAO.executeInterfazRECEnviarTransferenciaBoletasRecojo(params);
