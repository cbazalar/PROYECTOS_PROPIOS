...
/**
 * Service para el proceso que Genera mensajes gestionado por el usuario de Premios Atendidos por Consultora 
 * 
 * @author <a href="mailto:cdiaz@csigcomt.com">Carlos Diaz Valverde</a>
 */
@Service("spusicc.procesoMENMensajesPremiosAntendidosConsultoraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENMensajesPremiosAntendidosConsultoraServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENMensajesPremiosAntendidosConsultoraServiceImpl " + params);
