...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoAPERecepcionarChequeoWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoAPERecepcionarChequeoWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoAPERecepcionarChequeoWebServiceImpl extends
		BaseInterfazAbstractWebService implements
		ACOProcesoAPERecepcionarChequeoWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoAPERecepcionarChequeoWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		String CODIGO_INTERFAZ = Constants.APE_CODIGO_INTERFAZ_RECEPCIONAR_CHEQUEO;
