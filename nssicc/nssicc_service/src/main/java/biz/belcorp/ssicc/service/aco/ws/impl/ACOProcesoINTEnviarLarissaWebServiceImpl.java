...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoINTEnviarLarissaWebService;
 ...
 * <p>
 * <a href="ACOProcesoINTEnviarLarissaWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sapaza@belcorp.biz">Sergio Apaza</a>
 */
public class ACOProcesoINTEnviarLarissaWebServiceImpl extends BaseProcesoSICCAbstractWebService 
		implements ACOProcesoINTEnviarLarissaWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoINTEnviarLarissa(
		...
		if (log.isDebugEnabled()) {
			log.debug("ejecutarProcesoINTEnviarLarissa");
		}
		...
		try {
			...
			dtoEntrada.setProcesoNegocio(ConstantesIntegracion.PROCESO_INTERFAZ_LARISSA);
