...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoDATEnviarDatamartSacWebService;
 ...
 */
public class ACOProcesoDATEnviarDatamartSacWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoDATEnviarDatamartSacWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoDATEnviarDatamartSac(
		...
		final String CODIGO_INTERFAZ = "DAT-P3";
	...
	protected Map prepareParamsBeforeExecute(Map params, Pais pais) throws Exception {
		String numeroLote = this.interfazSiCCService.getNumeroLoteIntHistoLotes(params, Constants.PREFIJO_SISTEMA_DATAMART);
