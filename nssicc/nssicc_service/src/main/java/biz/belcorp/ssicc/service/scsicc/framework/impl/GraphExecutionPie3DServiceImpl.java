...
/**
 * Implementacion del Service de ejecucin de los Graficos SSiCC (Pie 3D)
 * 
 * @author <a href="mailto:cbazalar@belcorp.biz">Carlos Bazalar La Rosa</a>
 */
@Service("scsicc.graphExecutionPie3DService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class GraphExecutionPie3DServiceImpl implements GraphExecutionService {
	...
	public final GraphResult generarGrafico(GraphParams graphParam) throws Exception {
		...
		/* Generando grafico */
		pieChart = ChartFactory.createPieChart3D(graphParam.getTituloGrafico(), // chart title
                data,                // data
                true,                // include legend
                true,
                false
		...
		log.debug("Se genero el Grafico PIE 3D");
