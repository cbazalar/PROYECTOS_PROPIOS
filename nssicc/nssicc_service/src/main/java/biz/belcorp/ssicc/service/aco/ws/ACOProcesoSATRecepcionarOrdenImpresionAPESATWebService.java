 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarOrdenImpresionAPESATWebService.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public interface ACOProcesoSATRecepcionarOrdenImpresionAPESATWebService {
	/**
	 * 
	 * @param codigoPais
	 * @param codigoUsuario
