...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCREnvArchivosOCRDirWebService;
 ...
 */
public class ACOProcesoOCREnvArchivosOCRDirWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoOCREnvArchivosOCRDirWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoOCREnvArchivosOCRDir(
		...
		final String CODIGO_INTERFAZ = "OCR-P4";
		final String CODIGO_SISTEMA = "OCR";
		...
		try{
			...
			if (StringUtils.isBlank(codigoPeriodoDesde) || StringUtils.isEmpty(codigoPeriodoDesde)) {
				codigoPeriodoDesde = controlFacturacion.getCodigoPeriodo();
			}
			if(StringUtils.isBlank(codigoPeriodoHasta) || StringUtils.isEmpty(codigoPeriodoHasta)){
				codigoPeriodoHasta = controlFacturacion.getFechaProceso();
	        }
			...
			criteria.put("codigoPeriodoHasta", codigoPeriodoHasta);
