...
/**
 * Service del envio del cronograma de facturacion para la Proyeccion Parcial de
 * la Interfaz PRY.
 * 
 * @author <a href="">Jose Luis Rodriguez</a>
 */
@Service("sisicc.interfazPRYEnviarCronogramaFacturacionCentroService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRYEnviarCronogramaFacturacionCentroServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
    ...
    protected void executeStoreProcedure(Map params) {
    	interfazPRYDAO.executeEnvioCronogramaFacturacionCentro(params);
	}
