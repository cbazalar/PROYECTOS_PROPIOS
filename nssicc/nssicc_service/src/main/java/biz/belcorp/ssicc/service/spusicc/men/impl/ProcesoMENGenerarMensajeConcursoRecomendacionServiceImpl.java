...
/**
 * Service para el proceso que Genera mensajes para concursos de recomendacion
 * 
 * @author <a href="mailto:sbuchelli@belcorp.biz">Sergio Buchelli</a>
 */
@Service("spusicc.procesoMENGenerarMensajeConcursoRecomendacionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensajeConcursoRecomendacionServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENGenerarMensajeConcursoRecomendacionServiceImpl " + params);
