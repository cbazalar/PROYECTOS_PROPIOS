 ...
 */
@Service("spisicc.procesoIMPSpoolEstadoCtaCteService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolEstadoCtaCteServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolEstadoCtaCte(proceso);
		} catch (Exception e) {
