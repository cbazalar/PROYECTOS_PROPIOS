 ...
 * 
 */
@Service("sisicc.interfazPaqueteOCRRecepcionarMicaWebService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPaqueteOCRRRecepcionarMicaWebServiceImpl extends SSiCC_Desfasado_BasePaqueteInterfazServiceImpl {
