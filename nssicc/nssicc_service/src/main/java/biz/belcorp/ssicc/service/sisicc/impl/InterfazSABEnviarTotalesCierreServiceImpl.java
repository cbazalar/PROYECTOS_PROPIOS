...
/**
 * Service InterfazSABEnviarTotalesCierreServiceImpl.
 * 
 * @author <a href="mailto:">Sergio Apaza</a>
 */
@Service("sisicc.interfazSABEnviarTotalesCierreService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSABEnviarTotalesCierreServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSABDAO.executeInterfazSABEnviarTotalesCierre(params);
	}	
