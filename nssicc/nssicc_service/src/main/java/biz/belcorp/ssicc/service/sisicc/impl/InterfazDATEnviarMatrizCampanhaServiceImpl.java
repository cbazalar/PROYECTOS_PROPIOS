 ...
 * <p>
 * <a href="InterfazDATEnviarMatrizCampanhaServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("sisicc.interfazDATEnviarMatrizCampanhaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazDATEnviarMatrizCampanhaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazDATDAO.executeInterfazDATEnviarMatrizCampanha(params);
	}
