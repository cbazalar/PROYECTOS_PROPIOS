...
/**
 * Service InterfazSABEnviarPedidosPorMarcaServiceImpl.
 * 
 * @author <a href="mailto:">Sergio Apaza</a>
 */
@Service("sisicc.interfazSABEnviarPedidosPorMarcaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSABEnviarPedidosPorMarcaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSABDAO.executeInterfazSABEnviarPedidosPorMarca(params);
	}	
