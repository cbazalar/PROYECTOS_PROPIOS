 ...
 * <p>
 * <a href="InterfazFACRecepcionarNotaCreditoElectronicaServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sguerra@sigcomt.com">Sebastian Guerra</a>
 */
@Service("sisicc.interfazFACRecepcionarNotaCreditoElectronicaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFACRecepcionarNotaCreditoElectronicaServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	protected void executeStoreProcedure(Map params) throws InterfazException, Exception {
		...
		if(archivosProcesar != null && archivosProcesar.size() > 0){
			...
			for(int i=0; i<archivosProcesar.size(); i++){
				...
				String nombreCarpeta = Constants.FAC_NOMBRE_CARPETA_NOTAS_CREDITO;
				String serieDocumento = StringUtils.left(split2[0], 1)+"%";
				...
				String evaluaCaracter = StringUtils.substring(split2[0], 1, 2);
				if(StringUtils.equals(evaluaCaracter, "R"))
					mantenimientoFACGenericoDAO.updateIndicadorProcesoNCRetail(criteria);
			}
