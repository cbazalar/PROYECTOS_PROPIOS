...
@Service("sisicc.paqueteInterfazDATEnviarIncentivosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class PaqueteInterfazDATEnviarIncentivosServiceImpl extends BaseInterfazPaqueteAbstractServiceImpl {
