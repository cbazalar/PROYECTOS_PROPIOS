...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepcionarSeguimientoPedidoWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarSeguimientoPedidoWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSATRecepcionarSeguimientoPedidoWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoSATRecepcionarSeguimientoPedidoWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSATRecepcionarSeguimientoPedidoWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.SAT_CODIGO_PROCESO_BATCH_RECEPCIONAR_SEGUIMIENTO_PEDIDO;
		String CODIGO_INTERFAZ = Constants.SAT_CODIGO_INTERFAZ_RECEPCIONAR_SEGUIMIENTO_PEDIDO;
