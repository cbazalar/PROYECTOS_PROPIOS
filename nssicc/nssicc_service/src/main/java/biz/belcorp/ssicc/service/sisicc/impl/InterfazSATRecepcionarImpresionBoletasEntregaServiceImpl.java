...
/**
 * <p>
 * <a href="InterfazSATRecepcionarImpresionBoletasEntregaServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:aoviedo@sigcomt.com">Aurelio Oviedo</a>
 */
@Service("sisicc.interfazSATRecepcionarImpresionBoletasEntregaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSATRecepcionarImpresionBoletasEntregaServiceImpl extends
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try {
			interfazSATDAO.executeInterfazSATRecepcionarImpresionBoletasEntrega(map);
		} catch (Exception e) {
	...
	protected void processLine(InterfazParams interfazParams, int lineCount, Map row) throws InterfazException {
		interfazSATDAO.insertInterfazSATRecepcionarImpresionBoletasEntrega(row);
	}
}