 ...
 * 
 */
@Service("sisicc.interfazAVIRecepcionarDatosTelefonicosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazAVIRecepcionarDatosTelefonicosServiceImpl extends
			...
			while(it.hasNext()) {
				...
				/* Insertando en la cabecera */ 
					try {	
						...
						row.put("tipoRecepcion", Constants.NRO_UNO);
						//el prceose se encragada de actualiazr o insertar en el mae_clie_comun 
