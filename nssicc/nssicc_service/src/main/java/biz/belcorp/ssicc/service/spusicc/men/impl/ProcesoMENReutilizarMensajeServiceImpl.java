 ...
 */
@Service("spusicc.procesoMENReutilizarMensajeService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENReutilizarMensajeServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENReutilizarMensajeServiceImpl " + params);
