...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCREnvArchProlWebService;
 ...
 */
public class ACOProcesoOCREnvArchProlWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoOCREnvArchProlWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoOCREnvArchProl(
		...
		final String CODIGO_INTERFAZ = "OCR-P15";
		final String CODIGO_SISTEMA = "OCR";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoOCREnvArchProl");
		}
		try{
