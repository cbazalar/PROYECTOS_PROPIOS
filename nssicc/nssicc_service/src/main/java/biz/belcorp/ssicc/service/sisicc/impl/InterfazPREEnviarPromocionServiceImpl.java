 ...
 * <p>
 * <a href="InterfazPREEnviarPromocionServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="}">Jos Luis Rodriguez</a>
 */
@Service("sisicc.interfazPREEnviarPromocionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPREEnviarPromocionServiceImpl extends
	...
	protected void executeStoreProcedure(Map map) {
		InterfazPREDAO.executeInterfazPREEnviarPromocion(map);
	}
