 ...
 */
@Service("sisicc.interfazOCRRecepcionarOCCorporativoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCRRecepcionarOCCorporativoServiceImpl extends    BaseInterfazEntradaAbstractService {
    ...
    public void setInterfazEVIDAO(InterfazEVIDAO interfazEVIDAO) {
        this.interfazEVIDAO = interfazEVIDAO;
    }
     ...
     */
    protected void updateInterfazResultOnException(InterfazResult interfazResult, InterfazException interfazException) {
