...
@Service("sisicc.interfazPRYEnviarDemandaCodigosCerradosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRYEnviarDemandaCodigosCerradosServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService{
    ...
    protected void executeStoreProcedure(Map params) {
    	interfazPRYDAO.executeEnvioDemandaCodigoCerrado(params);
	}
