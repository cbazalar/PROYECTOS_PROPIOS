...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoFLXRecepcionArchivosWebManualWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoFLXRecepcionArchivosWebManualWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoFLXRecepcionArchivosWebManualWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoFLXRecepcionArchivosWebManualWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoFLXRecepcionArchivosWebManualWebService#ejecutarProceso(java.lang.String, java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoPeriodo, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.FLX_CODIGO_PROCESO_BATCH_RECEPCIONAR_ARCHIVOS_WEB_MANUAL;
		String CODIGO_INTERFAZ = Constants.FLX_CODIGO_INTERFAZ_RECEPCIONAR_ARCHIVOS_WEB_MANUAL;
		String CODIGO_SISTEMA = Constants.FLX_CODIGO_SISTEMA;
