 ...
 */
@Service("sisicc.interfazRECEnviarBoletasRecojoCabeceraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazRECEnviarBoletasRecojoCabeceraServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO
				.executeInterfazRECEnviarBoletasRecojoCabecera(params);
	}
