...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSABFuentVentRealWebService;
 ...
 */
public class ACOProcesoSABFuentVentRealWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoSABFuentVentRealWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoFuentVentReal(
		...
		final String CODIGO_INTERFAZ = "SAB-P1";
		final String CODIGO_SISTEMA = "SAB";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso ejecutarProcesoFuentVentReal");
		}
		try{
