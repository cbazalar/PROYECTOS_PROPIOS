 ...
 * 
 */
@Service("sisicc.interfazFLXRecepcionarConsultorasRechazadasWEBService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFLXRecepcionarConsultorasRechazadasWEBServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	throws InterfazException {
    	...
    	try {
    		...
    		interfazFLXDAO.executeRecepcionarConsultorasRechazadasWEB(map);
