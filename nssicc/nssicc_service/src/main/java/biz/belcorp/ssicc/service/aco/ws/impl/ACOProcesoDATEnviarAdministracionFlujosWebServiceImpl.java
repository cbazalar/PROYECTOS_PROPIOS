...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoDATEnviarAdministracionFlujosWebService;
 ...
 */
public class ACOProcesoDATEnviarAdministracionFlujosWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoDATEnviarAdministracionFlujosWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoDATEnviarAdministracionFlujos(
		...
		final String CODIGO_INTERFAZ = "DAT-P2";
...
//			Usuario usuario = this.usuarioService.getUsuarioByUsername(codigoUsuario);
			...
			log.debug("validacion interfaz datamart");
		    	
		    criteria.put("codigoPais", pais.getCodigo());
		    String mensaje = interfazDATService.getValidacionInterfazDatamart(criteria);
			...
			criteria.put("campannaRecaudo", "");
			criteria.put("codigoGrupoPago02", "");
			criteria.put("codigoTramo", new Integer(1));
