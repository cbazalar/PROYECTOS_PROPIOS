...
/**
 * <p>
 * <a href="ProcesoPEDPedidoZonaRecuperacionObligatoriaMultiHiloServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Gonzalo Javier Huertas Agurto</a>
 */
@Service("spisicc.procesoPEDPedidoZonaRecuperacionObligatoriaMultiHiloService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoPEDPedidoZonaRecuperacionObligatoriaMultiHiloServiceImpl extends BaseProcesoPEDPedidoZonaHiloAbstractService {
        ...
        try {
        	...
        	if(pedidos!=null && pedidos.size()>0){
        		...
        		for(int i=0;i<pedidos.size();i++){
        			...
        			procesoHiloPedidoZonaService.executeRecuperacionObligatoriaPedidoZonaMultihilo(criteriaProceso);
        		}
        	}
		} catch (Exception e) {
