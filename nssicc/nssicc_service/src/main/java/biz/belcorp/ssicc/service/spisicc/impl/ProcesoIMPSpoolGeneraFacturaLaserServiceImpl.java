...
/**
 * <p>
 * <a href="ProcesoIMPSpoolGeneraFacturaLaserServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("spisicc.procesoIMPSpoolGeneraFacturaLaserService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolGeneraFacturaLaserServiceImpl extends BaseInterfazSalidaAbstractService {
	...
	protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
		...
		procesoImpresionDAO.executeSpoolGeneraFacturaLaser(params);
