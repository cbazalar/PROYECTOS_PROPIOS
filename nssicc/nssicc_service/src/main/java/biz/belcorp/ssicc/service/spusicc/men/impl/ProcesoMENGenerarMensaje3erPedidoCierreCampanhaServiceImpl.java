...
/**
 * Service para el proceso que Genera mensajes 3er pedido al cierre de campanha
 * 
 * @author <a href="mailto:sbuchelli@belcorp.biz">Sergio Buchelli</a>
 */
@Service("spusicc.procesoMENGenerarMensaje3erPedidoCierreCampanhaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensaje3erPedidoCierreCampanhaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENGenerarMensaje3erPedidoCierreCampanhaServiceImpl " + params);
