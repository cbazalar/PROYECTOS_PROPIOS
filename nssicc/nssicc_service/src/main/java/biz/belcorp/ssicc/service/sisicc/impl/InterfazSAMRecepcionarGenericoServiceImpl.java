 ...
 *
 */
@Service("sisicc.interfazSAMRecepcionarGenericoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSAMRecepcionarGenericoServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void processLine(InterfazParams interfazParams, int lineCount,
		...
		try {
			...
			interfazSAMDAO.executeRecepcionGenerico(row);			
