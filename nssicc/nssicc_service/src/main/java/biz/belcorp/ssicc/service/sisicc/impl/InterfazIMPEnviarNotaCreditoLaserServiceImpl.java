...
/**
 * Clase que genera el archivo de documento Nota de Credito Laser
 ...
 * laser.
 * <p>
 * <a href="InterfazIMPEnviarNotaCreditoLaserServiceImpl"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="">Jose Luis Rodriguez</a>
 */
@Service("sisicc.interfazIMPEnviarNotaCreditoLaserService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarNotaCreditoLaserServiceImpl extends BaseInterfazSalidaAbstractService {
	...
	/**
	 * @param procesoIMPGeneracionDocumentosLaserDAO
	 */
	public void setProcesoIMPGeneracionDocumentosLaserDAO( ProcesoIMPGeneracionDocumentosLaserDAO procesoIMPGeneracionDocumentosLaserDAO) {
	...
	protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
		...
		procesoIMPGeneracionDocumentosLaserDAO.executeGeneraNotaCreditoLaser(params);
		
		cantidad = procesoIMPGeneracionDocumentosLaserDAO.getCantidadNotaCreditoLaser(params);
