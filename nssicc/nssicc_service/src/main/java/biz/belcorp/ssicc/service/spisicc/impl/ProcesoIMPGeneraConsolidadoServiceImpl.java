...
/**
 * <p>
 * <a href="ProcesoIMPGeneraConsolidadoServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergo Buchelli</a>
 */
@Service("spisicc.procesoIMPGeneraConsolidadoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPGeneraConsolidadoServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	protected void executeStoreProcedure(Map params) throws InterfazException,	Exception {
		procesoImpresionDAO.executeGeneraConsolidado(params);		
	}
