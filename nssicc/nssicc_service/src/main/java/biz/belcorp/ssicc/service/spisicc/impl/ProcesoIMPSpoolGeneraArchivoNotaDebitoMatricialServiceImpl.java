...
/**
 * <p>
 * <a href="ProcesoIMPSpoolGeneraArchivoNotaDebitoMatricialServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("spisicc.procesoIMPSpoolGeneraArchivoNotaDebitoMatricialService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolGeneraArchivoNotaDebitoMatricialServiceImpl extends BaseInterfazSalidaAbstractService {
	...
	protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
		...
		procesoImpresionDAO.executeSpoolGeneraArchivoNotaDebitoMatricial(params);
