...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoPRIEnviarCalificacionWebService;
 ...
 */
public class ACOProcesoPRIEnviarCalificacionWebServiceImpl extends BaseInterfazAbstractWebService implements ACOProcesoPRIEnviarCalificacionWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoPRIEnviarCalificacion(
		...
		String mensajeError = "";		
		final String CODIGO_INTERFAZ = "PRI-P4";
		final String CODIGO_SISTEMA = "PRI";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso ejecutarProcesoPRIEnviarCalificacion");
		}
		try{
