 ...
 */
@Service("sisicc.interfazRETEnviarInformacionRetailService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazRETEnviarInformacionRetailImpl extends	BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		interfazRETDAO.executeInterfazRETEnviarInformacionRetail(params);
	}
}