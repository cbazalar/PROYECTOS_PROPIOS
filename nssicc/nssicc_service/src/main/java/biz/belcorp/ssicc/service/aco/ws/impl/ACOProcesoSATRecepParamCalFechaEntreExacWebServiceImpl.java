...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepParamCalFechaEntreExacWebService;
 ...
 * 
 */
public class ACOProcesoSATRecepParamCalFechaEntreExacWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoSATRecepParamCalFechaEntreExacWebService {
	 ...
	 */
	public ACOWebServiceResponse ejecutarProcesoSATRecepParamCalFechaEntreExac(
		...
		String CODIGO_INTERFAZ = "SAT-17";
		String CODIGO_SISTEMA = "SAT";

		if (log.isDebugEnabled()) {
			log.debug("ejecutar Proceso Interfaz SATRecepParamCalFechaEntreExac");
		}
