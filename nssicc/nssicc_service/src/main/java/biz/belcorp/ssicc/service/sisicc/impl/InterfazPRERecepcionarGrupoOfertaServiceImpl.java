 ...
 * <p>
 * <a href="InterfazPRERecepcionarGrupoOfertaServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="}">Jos Luis Rodriguez</a>
 */
@Service("sisicc.interfazPRERecepcionarGrupoOfertaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRERecepcionarGrupoOfertaServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try { 
			InterfazPREDAO.executeInterfazPRERecepcionarGrupoOferta(map);
		} catch (Exception e) {
