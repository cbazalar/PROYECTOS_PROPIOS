 ...
 * 
 */
@Service("sisicc.interfazPaqueteOCRRecepcionarOCSService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPaqueteOCRRecepcionarOCSServiceImpl extends SSiCC_Desfasado_BasePaqueteInterfazServiceImpl {
