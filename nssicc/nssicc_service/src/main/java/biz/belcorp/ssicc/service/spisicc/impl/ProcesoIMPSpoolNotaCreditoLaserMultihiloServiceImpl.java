 ...
 */
@Service("spisicc.procesoIMPSpoolNotaCreditoLaserMultihiloService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolNotaCreditoLaserMultihiloServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolNotaCreditoLaserMultihilo(proceso);
		} catch (Exception e) {
