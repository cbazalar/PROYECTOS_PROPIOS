 ...
 * 
 */
@Service("sisicc.interfazOCREnviarArchivosWebService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPaqueteOCREnviarArchivosWebServiceImpl extends SSiCC_Desfasado_BasePaqueteInterfazServiceImpl {
