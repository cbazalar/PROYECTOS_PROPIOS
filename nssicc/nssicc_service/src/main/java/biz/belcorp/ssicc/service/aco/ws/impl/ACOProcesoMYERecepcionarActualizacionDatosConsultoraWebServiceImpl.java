...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoMYERecepcionarActualizacionDatosConsultoraWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoMYERecepcionarActualizacionDatosConsultoraWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoMYERecepcionarActualizacionDatosConsultoraWebServiceImpl
		extends BaseInterfazHiloAbstractWebService implements
		ACOProcesoMYERecepcionarActualizacionDatosConsultoraWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoMYERecepcionarActualizacionDatosConsultoraWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.MYE_CODIGO_PROCESO_BATCH_RECEPCIONAR_ACTUALIZACION_DATOS_CONSULTORA;
		String CODIGO_INTERFAZ = Constants.MYE_CODIGO_INTERFAZ_RECEPCIONAR_ACTUALIZACION_DATOS_CONSULTORA;
		String CODIGO_SISTEMA = Constants.MYE_CODIGO_SISTEMA;
