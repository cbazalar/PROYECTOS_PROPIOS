...
/**
 * <p>
 * <a href="InterfazAPECambioFechaPromesaServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:ghuertas@sigcomt.com">Gonzalo Huertas</a>
 */
@Service("sisicc.interfazAPECambioFechaPromesaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazAPECambioFechaPromesaServiceImpl extends
	...
	protected void processLine(InterfazParams interfazParams, int lineCount, Map row) throws InterfazException {
		...
		interfazAPEDAO.executeInterfazAPECambioFechaPromesa(row);
	}
}