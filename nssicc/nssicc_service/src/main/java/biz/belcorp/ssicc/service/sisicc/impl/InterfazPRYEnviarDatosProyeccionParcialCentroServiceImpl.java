 ...
 */
@Service("sisicc.interfazPRYEnviarDatosProyeccionParcialCentroService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRYEnviarDatosProyeccionParcialCentroServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
    ...
    protected void executeStoreProcedure(Map params) {
    	interfazPRYDAO.executeEnvioDatosProyeccionParcialCentro(params);
	}
