...
/**
 * Service InterfazLETEnviarPagosDetalle1ServiceImpl.
 * 
 * @author <a href="mailto:dtorres@sigcomt.com">Diego Torres L.</a>
 */
@Service("sisicc.interfazLETEnviarPagosDetalle1Service")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazLETEnviarPagosDetalle1ServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	public Map prepareQueryParams(InterfazParams interfazParams)
			throws InterfazException {
				...
				queryParams.put("directorioDetalle1", directorioDetalle);
	...
	protected void executeStoreProcedure(Map params) {
		this.interfazLETDAO.executeInterfazLETEnviarPagosDetalle1(params);
		params.put("nombreArchivoDetalle1", MapUtils.getString(params, "nombreArchivo"));
	}	
