...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoFLXEnvioResultadoProgramasWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoFLXEnvioResultadoProgramasWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */
public class ACOProcesoFLXEnvioResultadoProgramasWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoFLXEnvioResultadoProgramasWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoFLXEnvioResultadoProgramasWebService#ejecutarProceso(java.lang.String, java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoPeriodo, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		final String CODIGO_INTERFAZ = Constants.FLX_CODIGO_INTERFAZ_ENVIAR_RESULADO_PROGRAMA;
		final String CODIGO_BATCH = Constants.FLX_CODIGO_PROCESO_BATCH_ENVIAR_RESULADO_PROGRAMA;
