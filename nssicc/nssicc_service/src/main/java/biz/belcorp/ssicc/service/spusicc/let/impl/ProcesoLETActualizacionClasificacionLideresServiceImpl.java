 ...
 *
 */
@Service("spusicc.procesoLETActualizacionClasificacionLideresService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoLETActualizacionClasificacionLideresServiceImpl extends BaseInterfazProcesoAbstractService{
