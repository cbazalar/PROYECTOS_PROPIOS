 ...
 */
@Service("sisicc.interfazOCRRecepcionarOCSWebDDPROLCabeceraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCRRecepcionarOCSWebDDPROLCabeceraServiceImpl extends	BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		interfazOCRDAO.executeInterfazOCRWebDDPROLCabecera(map);
		return;
