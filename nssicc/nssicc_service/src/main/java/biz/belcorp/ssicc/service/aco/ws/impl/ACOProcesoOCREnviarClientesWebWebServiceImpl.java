...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCREnviarClientesWebWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoOCREnviarClientesWebWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoOCREnviarClientesWebWebServiceImpl extends
		BaseInterfazHiloAbstractWebService
		implements ACOProcesoOCREnviarClientesWebWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoOCREnviarClientesWebWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = Constants.OCR_CODIGO_PROCESO_BATCH_ENVIAR_CLIENTES_A_WEB;
		final String CODIGO_INTERFAZ = Constants.OCR_CODIGO_INTERFAZ_ENVIAR_CLIENTES_A_WEB;
