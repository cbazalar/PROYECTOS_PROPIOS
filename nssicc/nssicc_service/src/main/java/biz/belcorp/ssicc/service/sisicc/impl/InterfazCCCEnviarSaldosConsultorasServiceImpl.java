...
/**
 * Service de la Interfaz de Enviar Saldos Consultora
 * 
 * @author <a href="mailto:jflorencio@belcorp.biz">Jorge Florencio</a>
 */
@Service("sisicc.interfazCCCEnviarSaldosConsultorasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazCCCEnviarSaldosConsultorasServiceImpl extends
    ...
    protected void executeStoreProcedure(Map params) {
    	...
    	interfazCCCDAO.executeInterfazCCCEnviarSaldosConsultoras(params);
    }
}