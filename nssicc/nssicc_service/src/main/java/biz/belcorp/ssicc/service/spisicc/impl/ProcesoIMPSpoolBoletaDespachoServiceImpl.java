 ...
 */
@Service("spisicc.procesoIMPSpoolBoletaDespachoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolBoletaDespachoServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolBoletaDespacho(proceso);
		} catch (Exception e) {
