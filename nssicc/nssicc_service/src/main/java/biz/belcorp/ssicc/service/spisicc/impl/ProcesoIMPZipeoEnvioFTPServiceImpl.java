 ...
 * <p>
 * <a href="ProcesoIMPZipeoEnvioFTPServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sbuchelli@belcorp.biz">Sergio Buchelli</a>
 */
@Service("sisicc.procesoIMPZipeoEnvioFTPService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPZipeoEnvioFTPServiceImpl extends	BaseInterfazSalidaAbstractService {
	
	@Resource(name = "spisicc.procesoImpresionGenericoService")
	BaseProcesoImpresionService baseProcesoImpresion;
		...
		protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
			...
			params.put("codigoProcesoImpresion", Constants.PROCESO_IMPRESION_APE);//APE
