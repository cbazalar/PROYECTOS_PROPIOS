 ...
 */
@Service("sisicc.interfazEVIRecepcionarPrimerosPedidosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazEVIRecepcionarPrimerosPedidosServiceImpl extends
    ...
    protected void processLine(InterfazParams interfazParams, int lineCount,
        ...
        try {
            ...
            List primerosPedidosList = interfazEVIDAO
                    .getInterfazEVIRecepcionarPrimerosPedidos(row);
