...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoFLXProcesosCierreCampaniaG2WebService;
...
public class ACOProcesoFLXProcesosCierreCampaniaG2WebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoFLXProcesosCierreCampaniaG2WebService {
	...
	public ACOWebServiceResponse ejecutarProceso(String codigoPais,
			String codigoPeriodo, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		final String CODIGO_INTERFAZ = Constants.FLX_CODIGO_INTERFAZ_PROCESOS_CIERRE_CAMPANIA_G2;
		final String CODIGO_BATCH = Constants.FLX_CODIGO_PROCESO_BATCH_PROCESOS_CIERRE_CAMPANIA_G2;
		final String CODIGO_SISTEMA = Constants.FLX_CODIGO_SISTEMA;
				
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ACOProcesoFLXProcesosCierreCampania");
		}
		try{
