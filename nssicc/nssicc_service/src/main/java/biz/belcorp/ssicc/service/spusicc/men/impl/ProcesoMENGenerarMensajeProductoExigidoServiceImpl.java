 ...
 *
 */
@Service("spusicc.procesoMENGenerarMensajeProductoExigidoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensajeProductoExigidoServiceImpl extends BaseInterfazProcesoAbstractService{
