 ...
 * <p>
 * <a href="InterfazPRIEnviarControlFacturacionServiceImpl.java.html"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazPRIEnviarControlFacturacionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRIEnviarControlFacturacionServiceImpl extends
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		try {
			...
			list = this.controlFacturacionDAO.getControlFacturacionMap(codigoPais);
		} catch (Exception e) {
