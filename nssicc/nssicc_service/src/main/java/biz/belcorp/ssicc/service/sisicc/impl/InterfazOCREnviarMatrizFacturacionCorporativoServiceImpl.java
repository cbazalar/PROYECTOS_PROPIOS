 ...
 */
@Service("sisicc.interfazOCREnviarMatrizFacturacionCorporativoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCREnviarMatrizFacturacionCorporativoServiceImpl extends	BaseInterfazSalidaStoredProcedureAbstractService {
...
public Map prepareQueryParams(InterfazParams interfazParams) throws InterfazException {
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazOCREnviarMatrizFacturacionCorporativo(params);
	}
