...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoPRYEnviarProyeccionParcialCentroWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoPRYEnviarProyeccionParcialCentroWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoPRYEnviarProyeccionParcialCentroWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoPRYEnviarProyeccionParcialCentroWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoPRYEnviarProyeccionParcialCentroWebService#ejecutarProceso(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoPeriodo, String fechaFacturacion, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		final String CODIGO_BATCH = Constants.PRY_CODIGO_PROCESO_BATCH_ENVIAR_PROYECCION_PARCIAL_CENTRO;
		final String CODIGO_INTERFAZ = Constants.PRY_CODIGO_INTERFAZ_ENVIAR_PROYECCION_PARCIAL_CENTRO;
		final String CODIGO_SISTEMA = Constants.PRY_CODIGO_SISTEMA;
