 ...
 */
@Service("msg.mailReporteCCCGenerarReporteCargaLotesBancariosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class MailReporteCCCGenerarReporteCargaLotesBancariosServiceImpl extends BaseMailReporteAbstractService {
