...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoEMPEnvioVariablesWebService;
 ...
 * <p>
 * <a href="ACOProcesoEMPEnvioVariablesWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto</a>
 */
public class ACOProcesoEMPEnvioVariablesWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoEMPEnvioVariablesWebService {

	
	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoEMPEnvioVariablesWebService#ejecutarProcesoEMPEnvioVariables(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProcesoEMPEnvioVariables(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = Constants.EMP_CODIGO_PROCESO_BATCH_ENVIAR_VARIABLES_PROGRAMA_EMPRESARIAS;
		final String CODIGO_INTERFAZ = Constants.EMP_CODIGO_INTERFAZ_ENVIAR_VARIABLES_PROGRAMA_EMPRESARIAS;
