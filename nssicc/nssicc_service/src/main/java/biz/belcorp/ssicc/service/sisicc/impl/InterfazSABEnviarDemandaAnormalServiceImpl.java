...
/**
 * Service InterfazSABEnviarDemandaAnormalServiceImpl.
 * 
 * @author <a href="mailto:">Sergio Apaza</a>
 */
@Service("sisicc.interfazSABEnviarDemandaAnormalService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSABEnviarDemandaAnormalServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSABDAO.executeInterfazSABEnviarDemandaAnormal(params);
	}	
