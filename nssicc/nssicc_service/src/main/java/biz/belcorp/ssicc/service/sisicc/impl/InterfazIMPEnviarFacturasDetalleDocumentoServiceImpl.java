 ...
 * <p>
 * <a href="InterfazIMPEnviarFacturasDetalleDocumentoServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sguerra@sigcomt.com">Sebastian Guerra</a>
 */

@Service("sisicc.interfazIMPEnviarFacturasDetalleDocumentoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarFacturasDetalleDocumentoServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		...
		interfazIMPDAO.executeInterfazIMPEnviarFacturasDetalleDocumento(params);
	}
