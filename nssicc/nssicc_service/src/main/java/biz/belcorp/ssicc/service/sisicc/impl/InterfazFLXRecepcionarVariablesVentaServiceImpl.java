 ...
 *
 */
@Service("sisicc.interfazFLXRecepcionarVariablesVentaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFLXRecepcionarVariablesVentaServiceImpl extends
	...
	protected void beforeReadData(InterfazParams interfazParams)
    	...
    	try {
    		...
    		interfazFLXDAO.executeRecepcionarVariablesVenta(map);
