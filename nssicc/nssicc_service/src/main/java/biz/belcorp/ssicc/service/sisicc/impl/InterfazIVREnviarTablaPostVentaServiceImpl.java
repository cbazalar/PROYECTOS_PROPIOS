 ...
 */
@Service("sisicc.interfazIVREnviarTablaPostVentaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIVREnviarTablaPostVentaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazIVREnviarTablaPostVenta(params);
	}
