...
@Service("sisicc.interfazPRERecepcionarOfertaNivelesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRERecepcionarOfertaNivelesServiceImpl extends BaseInterfazEntradaAbstractService 
{
	...
	protected void processData(InterfazParams interfazParams, List data) throws InterfazException 
	{
		...
		for(int i=0; i< data.size(); i++)
		{
			...
			interfazPREDAO.insertOfertaNiveles(criteria);
			j++;
		}
	}
