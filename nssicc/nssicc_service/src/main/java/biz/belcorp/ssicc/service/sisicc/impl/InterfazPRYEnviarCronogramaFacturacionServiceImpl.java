 ...
 */
@Service("sisicc.interfazPRYEnviarCronogramaFacturacionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRYEnviarCronogramaFacturacionServiceImpl extends
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        try {
            result = this.interfazPRYDAO
                    .getInterfazPRYEnviarCronogramaFacturacion(queryParams);
        } catch (Exception e) {
