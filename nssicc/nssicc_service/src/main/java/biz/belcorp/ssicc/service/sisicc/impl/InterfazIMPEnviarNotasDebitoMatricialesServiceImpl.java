/*
 * Created on 29/05/2009 11:35:46 PM
 * biz.belcorp.ssicc.sisicc.service.impl.InterfazIMPEnviarNotasDebitoMatricialesServiceImpl
 */
...
/**
 * Clase que genera el archivo de documento matricial de notas de debito, 
 ...
 * <p>
 * <a href="InterfazIMPEnviarNotasDebitoMatricialesServiceImpl"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazIMPEnviarNotasDebitoMatricialesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarNotasDebitoMatricialesServiceImpl extends
	...
	protected int writeData(InterfazParams interfazParams, File tempFile,
		...
		procesoIMPGeneracionDocumentosMatricialesDAO.executeProcesaNotasDebitoMatriciales(params);
		procesoIMPGeneracionDocumentosMatricialesDAO.executeGeneraNotasDebitoMatriciales(params);
		
		cantidadNotasDebito = procesoIMPGeneracionDocumentosMatricialesDAO.getCantidadDocumentosMatriciales(params);
		
		return cantidadNotasDebito;
	}
