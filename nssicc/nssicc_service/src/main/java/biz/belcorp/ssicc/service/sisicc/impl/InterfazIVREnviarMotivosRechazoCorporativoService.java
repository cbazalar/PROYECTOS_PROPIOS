 ...
 */
@Service("sisicc.interfazIVREnviarMotivosRechazoCorporativoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIVREnviarMotivosRechazoCorporativoService extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		interfazIVRDAO.executeInterfazIVREnviarMotivosRechazoCorporativo(params);
	}
