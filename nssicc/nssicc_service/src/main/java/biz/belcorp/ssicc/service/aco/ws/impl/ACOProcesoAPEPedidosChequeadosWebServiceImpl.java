...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoAPEPedidosChequeadosWebService;
 ...
 * <p>
 * <a href="ACOProcesoAPEPedidosChequeadosWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto</a>
 */
public class ACOProcesoAPEPedidosChequeadosWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoAPEPedidosChequeadosWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoAPEPedidosChequeadosWebService#ejecutarProcesoAPEPedidosChequeados(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProcesoAPEPedidosChequeados(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = Constants.APE_CODIGO_PROCESO_BATCH_PEDIDOS_CHEQUEADOS;
		final String CODIGO_INTERFAZ = Constants.APE_CODIGO_INTERFAZ_PEDIDOS_CHEQUEADOS;
		final String CODIGO_SISTEMA = Constants.APE_CODIGO_SISTEMA;
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoAPEPedidosChequeados");
		}
		try{
