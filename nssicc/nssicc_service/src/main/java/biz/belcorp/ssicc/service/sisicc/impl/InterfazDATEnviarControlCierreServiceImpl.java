 ...
 * <p>
 * <a href="InterfazDATEnviarControlCierreServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("sisicc.interfazDATEnviarControlCierreService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazDATEnviarControlCierreServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazDATDAO.executeInterfazDATEnviarControlCierre(params);
	}
