 ...
 * 
 */
@Service("sisicc.interfazPaqueteOCREnviarArchivosOCSService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPaqueteOCREnviarArchivosOCSServiceImpl extends SSiCC_Desfasado_BasePaqueteInterfazServiceImpl {
