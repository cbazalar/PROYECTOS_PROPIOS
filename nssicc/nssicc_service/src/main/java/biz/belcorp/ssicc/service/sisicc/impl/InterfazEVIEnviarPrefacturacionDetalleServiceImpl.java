 ...
 * biz.belcorp.ssicc.sisicc.service.impl.InterfazEVIEnviarPrefacturacionDetalleServiceImpl
 */
 ...
 * <p>
 * <a href="InterfazEVIEnviarPrefacturacionDetalleServiceImpl.java.html">
 * <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cmarius@belcorp.biz">Carla Marius </a>
 */
@Service("sisicc.interfazEVIEnviarPrefacturacionDetalleService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazEVIEnviarPrefacturacionDetalleServiceImpl extends
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        try {
        	listPrefacturacionDetalle = this.interfazEVIDAO
            		.getInterfazEVIPrefacturacionDetalle(queryParams);
