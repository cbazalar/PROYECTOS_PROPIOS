...
/**
 * <p>
 * <a href="ProcesoPEDPedidoZonaValidarAgregadosMavMultiHiloServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Gonzalo Javier Huertas Agurto</a>
 */
@Service("spisicc.procesoPEDPedidoZonaValidarAgregadosMavMultiHiloService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoPEDPedidoZonaValidarAgregadosMavMultiHiloServiceImpl extends BaseProcesoPEDPedidoZonaHiloAbstractService {
        ...
        try {
        	...
        	if(pedidos!=null && pedidos.size()>0){
        		...
        		for(int i=0;i<pedidos.size();i++){
        			...
        			procesoHiloPedidoZonaService.executeValidarAgregadosMavPedidoZonaMultihilo(criteriaProceso);
        		}
        	}
		} catch (Exception e) {
