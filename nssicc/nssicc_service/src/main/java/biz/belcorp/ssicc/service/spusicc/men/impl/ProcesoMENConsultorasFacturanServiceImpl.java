 ...
 */
@Service("spusicc.procesoMENConsultorasFacturanService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENConsultorasFacturanServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENConsultorasFacturanServiceImpl " + params);
