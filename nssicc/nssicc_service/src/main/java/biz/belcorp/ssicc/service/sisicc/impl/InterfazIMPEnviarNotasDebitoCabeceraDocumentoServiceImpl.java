 ...
 * <p>
 * <a href="InterfazIMPEnviarNotasDebitoCabeceraDocumentoServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sguerra@sigcomt.com">Sebastian Guerra</a>
 */
@Service("sisicc.interfazIMPEnviarNotasDebitoCabeceraDocumentoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarNotasDebitoCabeceraDocumentoServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		...
		interfazIMPDAO.executeInterfazIMPEnviarNotasDebitoCabeceraDocumento(params);
	}
