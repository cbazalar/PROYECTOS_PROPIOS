...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoLETEjecutarProcesosWebService;
 ...
 */
public class ACOProcesoLETEjecutarProcesosWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoLETEjecutarProcesosWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoLETEjecutarProcesos(
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = "13";
		final String CODIGO_INTERFAZ = "LET-P4";
		final String CODIGO_SISTEMA = "LET";
		final String TIPO_CIERRE = "I";
		final String TIPO_TRANSACCION = "1";
		final String TIPO_OPERACION = "2";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso ejecutarProcesoDATEnviarDatamartSac");
		}
		try{
			...
			String indicadorProceso = (String)criteria.get("indicadorProceso");
			if(StringUtils.isNotBlank(indicadorProceso) || StringUtils.isNotEmpty(indicadorProceso)){ 
				if(StringUtils.equals(indicadorProceso, "G") || 
					StringUtils.equals(indicadorProceso, "Z") ||
					StringUtils.equals(indicadorProceso,"R") || 
					StringUtils.equals(indicadorProceso,"P") || 
					StringUtils.equals(indicadorProceso,"I") ){
