...
/**
 * Service para el proceso que Genera mensajes genericos n procesos
 * 
 * @author <a href="mailto:sbuchelli@belcorp.biz">Sergio Buchelli</a>
 */
@Service("spusicc.procesoMENGenerarMensajeGenericoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensajeGenericoServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENGenerarMensajeGenericoServiceImpl " + params);
