...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSAMEnviarMovimientosAlmacenSiccWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSAMEnviarMovimientosAlmacenSiccWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSAMEnviarMovimientosAlmacenSiccWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoSAMEnviarMovimientosAlmacenSiccWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSAMEnviarMovimientosAlmacenSiccWebService#ejecutarProceso(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoPeriodo, String fechaProceso, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		final String CODIGO_BATCH = Constants.SAM_CODIGO_PROCESO_BATCH_ENVIAR_MOVIMIENTOS_ALMACEN_SICC;
		final String CODIGO_INTERFAZ = Constants.SAM_CODIGO_INTERFAZ_ENVIAR_MOVIMIENTOS_ALMACEN_SICC;
		final String CODIGO_SISTEMA = Constants.CODIGO_SISTEMA_SAM;
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz SAMEnviarMovimientosAlmacenSicc");
		}
		try{
