...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepcionarCoberturaCodigoTerritorialWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarCoberturaCodigoTerritorialWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSATRecepcionarCoberturaCodigoTerritorialWebServiceImpl
		extends BaseInterfazHiloAbstractWebService implements
		ACOProcesoSATRecepcionarCoberturaCodigoTerritorialWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSATRecepcionarCoberturaCodigoTerritorialWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.SAT_CODIGO_PROCESO_BATCH_RECEPCIONAR_COBERTURA_POR_CODIGO_TERRITORIAL;
		String CODIGO_INTERFAZ = Constants.SAT_CODIGO_INTERFAZ_RECEPCIONAR_COBERTURA_POR_CODIGO_TERRITORIAL;
