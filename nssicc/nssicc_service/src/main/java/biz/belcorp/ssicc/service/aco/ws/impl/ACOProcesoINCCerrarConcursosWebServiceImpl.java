...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoINCCerrarConcursosWebService;
 ...
 * <p>
 * <a href="ACOProcesoINCCerrarConcursosWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sapaza@belcorp.biz">Sergio Apaza</a>
 */
public class ACOProcesoINCCerrarConcursosWebServiceImpl extends BaseProcesoSICCAbstractWebService 
		implements ACOProcesoINCCerrarConcursosWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoINCCerrarConcursos(
		...
		if (log.isDebugEnabled()) {
			log.debug("ejecutarProcesoINCCerrarConcursos");
		}
		...
		try {
			...
			dtoEntrada.setProcesoNegocio(ConstantesIntegracion.PROCESO_CERRAR_CONCURSOS);
