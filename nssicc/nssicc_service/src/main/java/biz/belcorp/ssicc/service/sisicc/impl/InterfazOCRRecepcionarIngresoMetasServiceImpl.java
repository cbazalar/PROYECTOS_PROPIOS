...
/**
 * 
 * @author <a href="mailto:nlopez@csigcomt.biz">Nicols Lpez Ramos</a>
 */
@Service("sisicc.interfazOCRRecepcionarIngresoMetasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCRRecepcionarIngresoMetasServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try { 
				interfazOCRDAO.deleteInterfazOCRRecepcionarIngresoMetas();
				interfazOCRDAO.executeInterfazOCRRecepcionarIngresoMetas(map);
		} catch (Exception e) {
	...
	protected void afterProcessInterfaz(InterfazParams interfazParams)	throws InterfazException {
		...
		String codTipoDocu = Constants.STO_TIPO_DOCUMENTO_SIM;
		...
		try{
			interfazOCRDAO.executeInterfazOCRProcesarConsolidadoIngresoMetas(map);
		}catch (Exception e) {
			throw new InterfazException("Error al procesar executeInterfazOCRProcesarConsolidadoIngresoMetas: "	+ e.getMessage());
		}
