...
/**
 * <p>
 * <a href="InterfazAPEPedidosDespachadosServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:aoviedo@sigcomt.com">Aurelio Oviedo</a>
 */
@Service("sisicc.interfazAPEPedidosDespachadosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazAPEPedidosDespachadosServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void processLine(InterfazParams interfazParams, int lineCount, Map row) throws InterfazException {
		...
		interfazAPEDAO.insertInterfazAPEPedidosDespachados(row);
	}
}