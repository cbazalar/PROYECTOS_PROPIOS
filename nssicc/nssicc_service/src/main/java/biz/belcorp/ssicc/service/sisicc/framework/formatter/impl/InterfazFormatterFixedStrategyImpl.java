...
/**
 * Implementa el formateo y el parseo de archivos de longitud fija.
 * 
 * @author <a href="mailto:lshimokawa@belcorp.biz">Lennon Shimokawa</a>
 */
@Service("sisicc.interfazFormatterFixedStrategy")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFormatterFixedStrategyImpl implements
	...
	public String formatField(Object field, InterfazFormat interfazFormat,
		...
		try {
			...
			String numberFormattedField = InterfazFormatterUtil.formatNumber(
			...
			log.error("Error al formatear el campo de longitud fija: "
					+ e.getMessage());
		}
		return result;
	}
		...
		for (Iterator iter = estructuras.iterator(); iter.hasNext();) {
			...
			if (tipoDato.equals(Constants.TIPO_DATO_NUMERICO)) {
				...
				try {
					...
					log.error("Error al convertir el campo a numero, campo="
