...
/**
 * <p>
 * <a href="InterfazAPERecepcionarPicadoDetalleServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto</a>
 */
@Service("sisicc.interfazAPERecepcionarPicadoDetalleService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazAPERecepcionarPicadoDetalleServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try {
			interfazAPEDAO.executeInterfazAPERecepcionarPicadoDetalle(map);
		} catch (Exception e) {
