 ...
 *
 */
@Service("spusicc.procesoMENGenerarMensajeInformacionGerenteService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensajeInformacionGerenteServiceImpl extends BaseInterfazProcesoAbstractService{
	...
	protected void executeStoreProcedure(Map params) throws InterfazException {
		log.debug("inicio ProcesoMENGenerarMensajeInformacionGerenteServiceImpl " + params);
