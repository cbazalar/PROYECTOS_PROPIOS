 ...
 * 
 */
@Service("sisicc.interfazPaqueteOCREnviarRegionZonaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPaqueteOCREnviarRegionZonaServiceImpl extends SSiCC_Desfasado_BasePaqueteInterfazServiceImpl {
