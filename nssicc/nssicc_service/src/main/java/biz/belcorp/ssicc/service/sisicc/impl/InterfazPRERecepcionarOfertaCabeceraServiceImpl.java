 ...
 * <p>
 * <a href="InterfazPRERecepcionarOfertaCabeceraServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="}">Jos Luis Rodriguez</a>
 */
@Service("sisicc.interfazPRERecepcionarOfertaCabeceraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRERecepcionarOfertaCabeceraServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try { 
			InterfazPREDAO.executeInterfazPRERecepcionarOfertaCabecera(map);
		} catch (Exception e) {
