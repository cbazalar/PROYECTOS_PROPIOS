 ...
 * <p>
 * <a href="InterfazMYEEnviarCodigoAutorizacionSUNATServiceImpl"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazMYEEnviarCodigoAutorizacionSUNATService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazMYEEnviarCodigoAutorizacionSUNATServiceImpl extends
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		List list = null;
		try {
			list = interfazSiCCDAO.getInterfazMYECodigoAutorizacionSunat(queryParams);
		} catch (Exception e) {
