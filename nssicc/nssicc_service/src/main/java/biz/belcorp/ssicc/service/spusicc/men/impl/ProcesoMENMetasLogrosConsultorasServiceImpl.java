 ...
 */
@Service("spusicc.procesoMENMetasLogrosConsultorasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENMetasLogrosConsultorasServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENMetasLogrosConsultorasServiceImpl " + params);
