 ...
 * <p>
 * <a href="InterfazIVREnviarTablaMotivosReclamoServiceImpl.java.html"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:jcairampoma@belcorp.biz">Jos A. Cairampoma</a>
 */
@Service("sisicc.interfazIVREnviarTablaMotivosRechazoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIVREnviarTablaMotivosRechazoServiceImpl extends
	...
	public Map prepareQueryParams(InterfazParams interfazParams)
		...
		paramsIVR.put("infoAdic", Constants.IVR_ENVIAR_COMPLETO);
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazIVREnviarTablaMotivosRechazo(params);
	}
