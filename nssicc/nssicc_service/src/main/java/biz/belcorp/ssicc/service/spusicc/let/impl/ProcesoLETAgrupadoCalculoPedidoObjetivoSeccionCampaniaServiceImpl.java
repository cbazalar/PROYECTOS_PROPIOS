 ...
 *
 */
@Service("spusicc.procesoLETAgrupadoCalculoPedidoObjetivoSeccionCampaniaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoLETAgrupadoCalculoPedidoObjetivoSeccionCampaniaServiceImpl extends BaseInterfazProcesoAbstractService{
