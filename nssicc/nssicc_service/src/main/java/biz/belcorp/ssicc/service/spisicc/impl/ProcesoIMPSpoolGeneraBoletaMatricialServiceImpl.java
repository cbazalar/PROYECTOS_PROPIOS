...
/**
 * <p>
 * <a href="ProcesoIMPSpoolGeneraBoletaMatricialServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio buchelli</a>
 */
@Service("spisicc.procesoIMPSpoolGeneraBoletaMatricialService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolGeneraBoletaMatricialServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolGeneraBoletaMatricial(proceso);
		} catch (Exception e) {
