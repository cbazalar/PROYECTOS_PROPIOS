 ...
 */
@Service("spisicc.procesoIMPSpoolActualizacionSecuenciacionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolActualizacionSecuenciacionServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	@Resource(name="spisicc.procesoImpresionDAO")
	  private ProcesoImpresionDAO procesoImpresionDAO;
		...
		protected void executeStoreProcedure(Map params) {
			procesoImpresionDAO.executeSpoolProcesoSecuenciacion(params);
		}
