 ...
 *
 */
@Service("spusicc.procesoMENGenerarMensajeConsideracionRestriccionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensajeConsideracionRestriccionServiceImpl extends BaseInterfazProcesoAbstractService{
	...
	protected void executeStoreProcedure(Map params) throws InterfazException {
		log.debug("inicio ProcesoMENGenerarMensajeConsideracionRestriccionServiceImpl " + params);
