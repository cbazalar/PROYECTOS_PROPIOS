...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoMYERecepActDatConWebService;
 ...
 * 
 */
public class ACOProcesoMYERecepActDatConWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoMYERecepActDatConWebService {
	 ...
	 */
	public ACOWebServiceResponse ejecutarProcesoMYERecepActDatConWeb(
		...
		if (log.isDebugEnabled()) {
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoMYERecepActDatCon");
		}
