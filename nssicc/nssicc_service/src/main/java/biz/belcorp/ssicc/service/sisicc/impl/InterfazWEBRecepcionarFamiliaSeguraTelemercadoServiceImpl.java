 ...
 */
@Service("sisicc.interfazWEBRecepcionarFamiliaSeguraTelemercadoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class  InterfazWEBRecepcionarFamiliaSeguraTelemercadoServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try { 
				...
				interfazOCRDAO.executeInterfazWEBRecepcionarFamiliaSegura(map);
		} catch (Exception e) {
	...
	protected void afterProcessInterfaz(InterfazParams interfazParams)	throws InterfazException {
		...
		try{
			...
			throw new InterfazException("Error al procesar executeInterfazOCRProcesarConsolidadoFamiliaWebSegura: "	+ e.getMessage());
		}
