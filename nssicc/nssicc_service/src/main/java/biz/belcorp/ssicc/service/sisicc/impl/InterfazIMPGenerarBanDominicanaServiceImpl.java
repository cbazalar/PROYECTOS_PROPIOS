 ...
 * <p>
 * <a href="InterfazIMPGenerarBanDominicanaServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="mailto:ghuertas@sigcomt.com">Gonzalo Huertas</a>
 */
@Service("sisicc.interfazIMPGenerarBanDominicanaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPGenerarBanDominicanaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazIMPGenerarBanDominicana(params);
	}
