...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoIVREnvCompIVRCorpWebService;
 ...
 */
public class ACOProcesoIVREnvCompIVRCorpWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoIVREnvCompIVRCorpWebService{

	InterfazIVRService interfazIVRService;
	...
	protected void onInit() throws ServiceException {
		...
		this.interfazIVRService = (InterfazIVRService) getWebApplicationContext().getBean("sisicc.interfazIVRService");
	}
	...
	public ACOWebServiceResponse ejecutarProcesoIVREnviarCompletoIVRCorporativo(
		...
		final String CODIGO_INTERFAZ = "IVR-P8";
		final String CODIGO_SISTEMA = "IVR";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoIVREnviarCompletoIVRCorporativo");
		}
		try{
...
//			Usuario usuario = this.usuarioService.getUsuarioByUsername(codigoUsuario);
			...
			List siccAccesoTodosList = this.interfazSiCCService.getAccesosTodosByCanalByCodigoISO(usuario.getIdioma().getCodigoISO());
	...
	protected Map executeProcessBeforeInterfaz(Map params) throws Exception {
		this.interfazIVRService.deleteTablaControlIVRCorporativo();
