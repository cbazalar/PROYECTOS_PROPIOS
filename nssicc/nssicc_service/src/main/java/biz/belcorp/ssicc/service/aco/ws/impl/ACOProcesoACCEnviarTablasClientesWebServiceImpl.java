...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoACCEnviarTablasClientesWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoACCEnviarTablasClientesWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoACCEnviarTablasClientesWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoACCEnviarTablasClientesWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoACCEnviarTablasClientesWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = Constants.ACC_CODIGO_PROCESO_BATCH_ENVIAR_TABLA_CLIENTES;
		final String CODIGO_INTERFAZ = Constants.ACC_CODIGO_INTERFAZ_ENVIAR_TABLA_CLIENTES;
		final String CODIGO_SISTEMA = Constants.ACC_CODIGO_SISTEMA;
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProceso");
		}
		try{
