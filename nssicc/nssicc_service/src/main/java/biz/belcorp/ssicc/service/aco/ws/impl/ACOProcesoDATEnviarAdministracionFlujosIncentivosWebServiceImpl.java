...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoDATEnviarAdministracionFlujosIncentivosWebService;
 ...
 * <p>
 * <a href="ACOProcesoDATEnviarAdministracionFlujosIncentivosWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto</a>
 */
public class ACOProcesoDATEnviarAdministracionFlujosIncentivosWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoDATEnviarAdministracionFlujosIncentivosWebService {
	...
	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoDATEnviarAdministracionFlujosIncentivosWebService#ejecutarProcesoDATEnviarAdministracionFlujos(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProcesoDATEnviarAdministracionFlujos(
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = Constants.DAT_CODIGO_PROCESO_BATCH_ENVIAR_FLUJOS_INCENTIVOS;
		final String CODIGO_INTERFAZ = Constants.DAT_CODIGO_INTERFAZ_ENVIAR_FLUJOS_INCENTIVOS;
		final String CODIGO_SISTEMA = Constants.CODIGO_SISTEMA_DAT;
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoDATEnviarAdministracionFlujos");
		}
		try{
