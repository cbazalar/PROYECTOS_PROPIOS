...
/**
 * Service para el Proceso que permite Actualizar la Clasificacin de las Consultoras
 * 
 * @author <a href="mailto:yrivas@sigcomt.com">Yahir Rivas Luna</a>
 */
@Service("spusicc.procesoSGRActualizarClasificacionConsultoraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoSGRActualizarClasificacionConsultoraServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) throws InterfazException, Exception {
		...
		{
			procesoSGRGenericoDAO.executeActualizarClasificacionConsultora(params);
		}
		else
		{
