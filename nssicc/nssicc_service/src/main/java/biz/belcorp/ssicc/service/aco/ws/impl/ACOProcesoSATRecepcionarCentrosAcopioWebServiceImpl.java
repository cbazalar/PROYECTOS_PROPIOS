...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepcionarCentrosAcopioWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarCentrosAcopioWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSATRecepcionarCentrosAcopioWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoSATRecepcionarCentrosAcopioWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSATRecepcionarCentrosAcopioWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.SAT_CODIGO_PROCESO_BATCH_RECEPCIONAR_CENTROS_ACOPIO;
		String CODIGO_INTERFAZ = Constants.SAT_CODIGO_INTERFAZ_RECEPCIONAR_CENTROS_ACOPIO;
