 ...
 */
@Service("sisicc.interfazOCRRecepcionarActualizacionDatosCorporativaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCRRecepcionarActualizacionDatosCorporativaServiceImpl extends	BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try { 
				...
				interfazOCRDAO.executeInterfazOCRRecepcionarActualizacionDatosCorporativa(map);
