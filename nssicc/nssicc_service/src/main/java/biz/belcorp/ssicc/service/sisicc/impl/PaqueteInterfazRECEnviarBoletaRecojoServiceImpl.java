...
@Service("sisicc.paqueteInterfazRECEnviarBoletaRecojoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class PaqueteInterfazRECEnviarBoletaRecojoServiceImpl extends BaseInterfazPaqueteAbstractServiceImpl {
