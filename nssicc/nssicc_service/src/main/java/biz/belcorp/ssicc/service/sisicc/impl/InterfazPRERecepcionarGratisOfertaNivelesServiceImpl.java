...
@Service("sisicc.interfazPRERecepcionarGratisOfertaNivelesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRERecepcionarGratisOfertaNivelesServiceImpl extends BaseInterfazEntradaAbstractService
{
	...
	{	
		...
		for(int i=0; i< data.size(); i++)
		{
			...
			interfazPREDAO.insertGratisOfertaNiveles(criteria);	
			j++;
		}
	}
