 ...
 */
@Service("lec.mailReporteLECAvanceGestion")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class MailReporteLECAvanceGestionServiceImpl extends BaseMailReporteAbstractService {
	...
	/**
	 * @return the procesoSACGenerarReporteDAO
	 */
	public ProcesoSACGenerarReporteDAO getProcesoSACGenerarReporteDAO() {
		return procesoSACGenerarReporteDAO;
	}

	/**
	 * @param procesoSACGenerarReporteDAO the procesoSACGenerarReporteDAO to set
	 */
	public void setProcesoSACGenerarReporteDAO(
			ProcesoSACGenerarReporteDAO procesoSACGenerarReporteDAO) {
		this.procesoSACGenerarReporteDAO = procesoSACGenerarReporteDAO;
	}
