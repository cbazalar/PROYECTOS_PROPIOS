 ...
 * <p>
 * <a href="InterfazIMPEnviarSecuenciaBoletaElectronicaServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto</a>
 */
@Service("sisicc.interfazIMPEnviarSecuenciaBoletaElectronicaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarSecuenciaBoletaElectronicaServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	protected void executeStoreProcedure(Map params) throws InterfazException,
		...
		if (StringUtils.isNotBlank(codigoPeriodo) && StringUtils.isNotBlank(fechaFacturacion))
			interfazIMPDAO.executeInterfazIMPEnviarSecuenciaBoletaElectronica(params);
		else
