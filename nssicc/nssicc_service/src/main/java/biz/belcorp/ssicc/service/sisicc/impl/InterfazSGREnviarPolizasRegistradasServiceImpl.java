 ...
 */
@Service("sisicc.interfazSGREnviarPolizasRegistradasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSGREnviarPolizasRegistradasServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSGRDAO.executeInterfazSGREnviarPolizasRegistradas(params);
	}
