 ...
 */
@Service("spisicc.procesoIMPSpoolUltimaNoticaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolUltimaNoticaServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolUltimasNoticias(proceso);
		} catch (Exception e) {
