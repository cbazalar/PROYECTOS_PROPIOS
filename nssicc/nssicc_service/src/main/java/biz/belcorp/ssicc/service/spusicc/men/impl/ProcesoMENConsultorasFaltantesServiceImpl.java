 ...
 */
@Service("spusicc.procesoMENConsultorasFaltantesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENConsultorasFaltantesServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENConsultorasFaltantesServiceImpl " + params);
