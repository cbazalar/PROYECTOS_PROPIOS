...
/**
 * <p>
 * <a href="ProcesoIMPSpoolUltimaNoticaServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Jose Luis Rodriguez</a>
 */
@Service("spisicc.procesoIMPSpoolDetalleFacturaZonaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolDetalleFacturaZonaServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolDetalleFacturaZona(proceso);
		} catch (Exception e) {
