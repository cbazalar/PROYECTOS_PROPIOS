...
/**
 * <p>
 * <a href="ProcesoIMPSpoolGeneraArchivoBoletaMatricialServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("spisicc.procesoIMPSpoolGeneraArchivoBoletaMatricialService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolGeneraArchivoBoletaMatricialServiceImpl extends BaseInterfazSalidaAbstractService {
	...
	protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
		...
		procesoImpresionDAO.executeSpoolGeneraArchivoBoletaMatricial(params);
