 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarSeguimientoPedidoWebService.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public interface ACOProcesoSATRecepcionarSeguimientoPedidoWebService {
	/**
	 * 
	 * @param codigoPais
	 * @param codigoUsuario
