 ...
 * 
 */
@Service("sisicc.interfazIMPEnviarSMSBoletaSegundoRecojoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarSMSBoletaSegundoRecojoServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		...
		interfazSiCCService.executeEnviarSMSBoletaSegundoRecojo(params);
	}
	...
	protected String adicionarKeyTituloCabecera() {
		return "interfazIMPEnviarSMSBoletaSegundoRecojo";
	}
}
