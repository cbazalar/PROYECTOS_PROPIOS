 ...
 * Reporte de Control preliminar de boletas a escanear
 * 
 * @author <a href="mailto:doliva@csigcomt.com">Dennys Oliva Iriarte</a>
 */
@Service("sto.mailReporteSTOBoletasEscanearService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class MailReporteSTOBoletasEscanearServiceImpl extends BaseMailReporteAbstractService {
