 ...
 */
@Service("spisicc.procesoIMPZipeoEnvioRV3Service")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPZipeoEnvioRV3ServiceImpl extends BaseInterfazSalidaAbstractService {
	...
	protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
		...
		params.put("codigoProcesoImpresion", Constants.PROCESO_IMPRESION_RV3);//RV3
