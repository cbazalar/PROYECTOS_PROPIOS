 ...
 * <p>
 * <a href="InterfazCOMEnviarPagoLideresServiceImpl.java.html"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazCOMEnviarPagoLideresService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazCOMEnviarPagoLideresServiceImpl extends
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		List list = null;
		try {
			list = this.interfazSiCCDAO.getInterfazCOMEnviarPagoLideres(queryParams);
		} catch (Exception e) {
