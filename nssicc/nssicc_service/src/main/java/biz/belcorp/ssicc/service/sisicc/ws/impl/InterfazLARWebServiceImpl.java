...
import biz.belcorp.ssicc.service.sisicc.ws.InterfazLARWebService;
import biz.belcorp.ssicc.service.sisicc.ws.beans.InterfazResultado;

/**
 * TODO Include class description here.
 * <p>
 * <a href="InterfazLARWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cdiaz@csigcomt.com">Carlos Diaz Valverde </a>
 */
public class InterfazLARWebServiceImpl extends ServletEndpointSupport implements
        InterfazLARWebService {
	
	//-- Variables
    Log log = LogFactory.getLog(InterfazLARWebServiceImpl.class);
	...
	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.sisicc.web.ws.InterfazLARWebService#executeRecepcionLARWeb(java.lang.String, java.lang.String, java.lang.String)
	 */
	public InterfazResultado executeRecepcionLARWeb(String codigoPais,
        ...
        try {
            ...
            Map params = prepareParamsBeforeExecuteInterfazLAR(codigoPais,usuario,codigoInterfaz);
...
//            interfazSAMEnviarMovimientosAlmacenService = (BaseInterfazService)mapInterfaz.get(codigoInterfaz);
	 ...
	 * @return
	 */
	private Map prepareParamsBeforeExecuteInterfazLAR(String codigoPais,
