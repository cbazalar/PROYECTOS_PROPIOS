 ...
 */
@Service("spusicc.procesoMENMensajesFamiliaSeguraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENMensajesFamiliaSeguraServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENMensajesFamiliaSeguraServiceImpl " + params);
