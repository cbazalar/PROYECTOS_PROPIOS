...
@Service("spusicc.reporteSTOEnvioSolucionesCentroAcopioAutomaticoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ReporteSTOEnvioSolucionesCentroAcopioAutomaticoServiceImpl extends	BaseSubReporteAbstractService implements ReporteSTOEnvioSolucionesCentroAcopioAutomaticoService{
	...
	protected void prepareParameterMap(Map params) throws Exception {
		...
		String titulo = messageSource.getMessage("reporteSTOCentroAcopioAuto.titulo",null,getLocale(usuario));
		log.debug("titulo");
	...
	protected String getNombreArchivoReporte(ReporteParams reporteParams) {
		...
		nombreArchivoReporte = getPrefijoArchivo()+ "_(NV)_" + 
	 ...
	 */
	@Autowired
	@Qualifier("sto.mailReporteSTOSolucionesCentroAcopioAutomaticoService")
