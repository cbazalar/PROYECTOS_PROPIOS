 ...
 * <p>
 * <a href="InterfazPRIEnviarFichasInscripcionServiceImpl"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazPRIEnviarFichasInscripcionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRIEnviarFichasInscripcionServiceImpl extends
    ...
    protected void beforeProcessInterfaz(InterfazParams interfazParams) throws InterfazException {
        ...
        clienteDAO.updatePeriodoClienteByPais(codigoPais);
    }
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		try {
			...
			list = this.clienteDAO.getClientesMapByPais(codigoPais);
		} catch (Exception e) {
