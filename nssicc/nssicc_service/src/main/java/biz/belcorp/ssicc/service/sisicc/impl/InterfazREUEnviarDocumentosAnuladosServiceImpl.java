 ...
 * <p>
 * <a href="InterfazREUEnviarDocumentosAnuladosServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazREUEnviarDocumentosAnuladosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazREUEnviarDocumentosAnuladosServiceImpl extends
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        try {
            list = this.interfazSiCCDAO
                    .getInterfazREUDocumentosAnulados(queryParams);
        } catch (Exception e) {
