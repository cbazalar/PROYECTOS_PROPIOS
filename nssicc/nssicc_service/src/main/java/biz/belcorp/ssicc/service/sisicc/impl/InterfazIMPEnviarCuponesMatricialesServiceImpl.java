/*
 * Created on 14/05/2009 05:37:46 PM
 * biz.belcorp.ssicc.sisicc.service.impl.InterfazIMPEnviarCuponesMatricialesServiceImpl
 */
 ...
 * <p>
 * <a href="InterfazIMPEnviarCuponesMatricialesServiceImpl"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazIMPEnviarCuponesMatricialesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarCuponesMatricialesServiceImpl extends
	...
	protected int writeData(InterfazParams interfazParams, File tempFile,
		...
		procesoIMPGeneracionDocumentosMatricialesDAO.executeProcesaCuponesMatriciales(params);
		procesoIMPGeneracionDocumentosMatricialesDAO.executeGeneraCuponesMatriciales(params);
		
		cantidadCupones = procesoIMPGeneracionDocumentosMatricialesDAO.getCantidadCuponesMatriciales(params);
