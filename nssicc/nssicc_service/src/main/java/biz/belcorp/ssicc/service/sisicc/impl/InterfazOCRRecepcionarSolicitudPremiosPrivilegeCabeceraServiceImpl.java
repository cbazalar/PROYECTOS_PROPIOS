...
public class InterfazOCRRecepcionarSolicitudPremiosPrivilegeCabeceraServiceImpl extends	BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException { 
		...
		try {
			interfazSiCCDAO.deleteInterfazOCRRecepcionarSolicitudPremiosPrivilegeCabecera();
			interfazSiCCDAO.executeInterfazOCRRecepcionarSolicitudPremiosPrivilegeCabecera(map);
		} catch (Exception e) {
