 ...
 * 
 */
@Service("sisicc.interfazPaqueteOCRRecepcionarOCSWebService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPaqueteOCRRecepcionarOCSWebServiceImpl extends SSiCC_Desfasado_BasePaqueteInterfazServiceImpl {
