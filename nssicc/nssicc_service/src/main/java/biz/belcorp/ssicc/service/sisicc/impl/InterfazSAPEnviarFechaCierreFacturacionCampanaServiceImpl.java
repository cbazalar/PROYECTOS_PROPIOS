...
@Service("sisicc.interfazSAPEnviarFechaCierreFacturacionCampanaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSAPEnviarFechaCierreFacturacionCampanaServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService{
	...
	protected void executeStoreProcedure(Map params) {	
		interfazSAFDAO.executeInterfazSAPEnviarFechaCierreFacturacion(params);		
	}
	...
	protected String adicionarKeyTituloCabecera() {
		return "interfazSAPEnviarFechaCierreFacturacionCampanaTituloCabecera";
	}
