 ...
 *
 */
public interface ProcesoCCCCargarPagosBancariosPorRegularizarMasivosService extends Service {
	 ...
	 * @throws Exception 
	 */
	public void executeValidarPagosBancariosPorRegularizarMasivos(Map datos) throws Exception;
