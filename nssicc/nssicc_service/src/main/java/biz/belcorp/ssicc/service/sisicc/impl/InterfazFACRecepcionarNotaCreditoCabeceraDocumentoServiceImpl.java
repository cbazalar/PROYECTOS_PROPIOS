 ...
 * <p>
 * <a href="InterfazFACRecepcionarNotaCreditoCabeceraDocumentoServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sguerra@sigcomt.com">Sebastian Guerra</a>
 */
@Service("sisicc.interfazFACRecepcionarNotaCreditoCabeceraDocumentoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFACRecepcionarNotaCreditoCabeceraDocumentoServiceImpl extends BaseInterfazEntradaAbstractService {

	@Resource(name="sisicc.InterfazFACDAO")
	InterfazFACDAO interfazFACDAO;
	List archivosProcesar;
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try {
			interfazFACDAO.executeInterfazFACRecepcionarNotasCreditoCabeceraDocumento(map);
		} catch (Exception e) {
			throw new InterfazException("Error al recepcionar datos de la cabecera de Notas de Credito: "+ e.getMessage());
		}
	}
