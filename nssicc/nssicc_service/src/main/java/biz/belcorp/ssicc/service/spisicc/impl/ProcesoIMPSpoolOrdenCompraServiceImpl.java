 ...
 */
@Service("spisicc.procesoIMPSpoolOrdenCompraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolOrdenCompraServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolOrdenCompra(proceso);
		} catch (Exception e) {
