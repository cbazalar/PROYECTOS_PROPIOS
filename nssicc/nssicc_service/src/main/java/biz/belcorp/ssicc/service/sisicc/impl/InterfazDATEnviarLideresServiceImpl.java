 ...
 * <p>
 * <a href="InterfazDATEnviarLideresServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author Danny Amaro
 */
@Service("sisicc.interfazDATEnviarLideresService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazDATEnviarLideresServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService{
	...
	protected void executeStoreProcedure(Map params) {
		interfazDATDAO.executeInterfazDATEnviarLideres(params);
