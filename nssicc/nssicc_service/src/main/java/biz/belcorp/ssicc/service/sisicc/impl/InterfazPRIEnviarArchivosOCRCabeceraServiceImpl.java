 ...
 * <p>
 * <a href="InterfazPRIEnviarArchivosOCRCabeceraServiceImpl"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazPRIEnviarArchivosOCRCabeceraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRIEnviarArchivosOCRCabeceraServiceImpl extends
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		List list = null;
		try {
			list = this.premioDAO.getPremiosCabecera(queryParams);
		} catch (Exception e) {
