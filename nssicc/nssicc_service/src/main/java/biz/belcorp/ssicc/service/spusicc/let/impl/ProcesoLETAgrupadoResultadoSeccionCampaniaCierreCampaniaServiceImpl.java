 ...
 *
 */
@Service("spusicc.procesoLETAgrupadoResultadoSeccionCampaniaCierreCampaniaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoLETAgrupadoResultadoSeccionCampaniaCierreCampaniaServiceImpl extends BaseInterfazProcesoAbstractService{
