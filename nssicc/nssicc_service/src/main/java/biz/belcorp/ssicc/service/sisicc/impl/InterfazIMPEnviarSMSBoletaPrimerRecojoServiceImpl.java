 ...
 * 
 */
@Service("sisicc.interfazIMPEnviarSMSBoletaPrimerRecojoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarSMSBoletaPrimerRecojoServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		...
		interfazSiCCService.executeEnviarSMSBoletaPrimerRecojo(params);
	}
	...
	protected String adicionarKeyTituloCabecera() {
		return "interfazIMPEnviarSMSBoletaPrimerRecojo";
	}
}
