...
/**
 * <p>
 * <a href="InterfazCOBEnviarRetroalimentacionGestionesServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:aoviedo@sigcomt.com">Aurelio Oviedo</a>
 */
@Service("sisicc.interfazCOBEnviarRetroalimentacionGestionesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazCOBEnviarRetroalimentacionGestionesServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazCOBDAO.executeInterfazCOBEnviarRetroalimentacionGestiones(params);
	}
