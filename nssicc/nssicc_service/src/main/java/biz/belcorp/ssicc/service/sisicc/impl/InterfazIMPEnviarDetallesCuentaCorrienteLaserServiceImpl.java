...
/**
 * Clase que genera el archivo de documento laser de detalles de cuenta
 * corriente, se sobrescribe el metodo writeData para reutilizar el framework de
 * interfaces pero el archivo generado en realidad es un spool de impresion
 * laser.
 * <p>
 * <a href="InterfazIMPEnviarDetallesCuentaCorrienteLaserServiceImpl"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazIMPEnviarDetallesCuentaCorrienteLaserService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarDetallesCuentaCorrienteLaserServiceImpl extends
	...
	protected int writeData(InterfazParams interfazParams, File tempFile,
		...
		procesoIMPGeneracionDocumentosLaserDAO.executeProcesaDetallesCuentaCorrienteLaser(params);
		procesoIMPGeneracionDocumentosLaserDAO.executeGeneraDetallesCuentaCorrienteLaser(params);
		
		cantidad = procesoIMPGeneracionDocumentosLaserDAO.getCantidadDetallesCuentaCorrienteLaser(params);
