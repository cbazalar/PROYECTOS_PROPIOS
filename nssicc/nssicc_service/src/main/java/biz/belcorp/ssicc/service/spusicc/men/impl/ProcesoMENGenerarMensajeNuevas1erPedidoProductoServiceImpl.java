...
/**
 * Service para el proceso que Genera mensajes para Nuevas con Primer Pedido con Productos de una determinada marca 
 * 
 * @author <a href="mailto:sapaza@belcorp.biz">Sergio Apaza</a>
 */
@Service("spusicc.procesoMENGenerarMensajeNuevas1erPedidoProductoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensajeNuevas1erPedidoProductoServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENGenerarMensajeNuevas1erPedidoProductoServiceImpl " + params);
