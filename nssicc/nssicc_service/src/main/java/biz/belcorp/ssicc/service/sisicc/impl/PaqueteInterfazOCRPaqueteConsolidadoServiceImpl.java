...
@Service("sisicc.paqueteInterfazOCRPaqueteConsolidadoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class PaqueteInterfazOCRPaqueteConsolidadoServiceImpl extends BaseInterfazPaqueteAbstractServiceImpl {
