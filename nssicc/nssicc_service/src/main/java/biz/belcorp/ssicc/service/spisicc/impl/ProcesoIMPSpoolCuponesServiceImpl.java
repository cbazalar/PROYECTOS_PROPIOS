 ...
 */
@Service("spisicc.procesoIMPSpoolCuponesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolCuponesServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
	...
	protected void beforeProcessInterfaz(InterfazParams interfazParams)	throws InterfazException {
		procesoHiloImpresionService.deleteProcesoIMPSpoolCupones();
	}
    ...
    {
        try {
        	procesoHiloImpresionService.executeSpoolCupones(proceso);
		} catch (Exception e) {
