 ...
 *
 */
public interface ConsultaPEJProgramaEjecutivasService extends Service{
	...
	/**
	 * Obtiene el rango de campaas por etapa
	 * @param criteria 
	 * @return
	 */
	...
	/**
	 * Obtiene la campanha inicial segun la etapaba seleccionada
	 * @param codigoPais
	 * @param codigoEtapa
	 * @return
	 */
	...
	/**
	 * Obtiene la campanha final segun la etapaba seleccionada
	 * @param codigoPais
	 * @param codigoEtapa
	 * @return
	 */
