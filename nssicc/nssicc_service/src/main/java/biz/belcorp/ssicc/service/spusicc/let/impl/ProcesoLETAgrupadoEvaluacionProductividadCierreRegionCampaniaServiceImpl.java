 ...
 *
 */
@Service("spusicc.procesoLETAgrupadoEvaluacionProductividadCierreRegionCampaniaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoLETAgrupadoEvaluacionProductividadCierreRegionCampaniaServiceImpl extends BaseInterfazProcesoAbstractService{
