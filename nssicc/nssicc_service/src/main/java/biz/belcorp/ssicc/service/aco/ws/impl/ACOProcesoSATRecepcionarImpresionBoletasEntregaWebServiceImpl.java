...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepcionarImpresionBoletasEntregaWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarImpresionBoletasEntregaWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSATRecepcionarImpresionBoletasEntregaWebServiceImpl
		extends BaseInterfazAbstractWebService implements
		ACOProcesoSATRecepcionarImpresionBoletasEntregaWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSATRecepcionarImpresionBoletasEntregaWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		String CODIGO_INTERFAZ = Constants.SAT_CODIGO_INTERFAZ_RECEPCIONAR_IMPRESION_BOLETAS_ENTREGA;
