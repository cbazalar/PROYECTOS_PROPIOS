...
/**
 * Service InterfazSABEnviarMaestroTerritorios2ServiceImpl.
 * 
 * @author <a href="mailto:">Sergio Apaza</a>
 */
@Service("sisicc.interfazSABEnviarMaestroTerritorios2Service")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSABEnviarMaestroTerritorios2ServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSABDAO.executeInterfazSABEnviarMaestroTerritorios(params);
	}	
