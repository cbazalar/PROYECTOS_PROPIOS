 ...
 * <p>
 * <a href="InterfazCOBEnviarCobranzaSaldoPendienteServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="">Jose Luis Rodriguez</a>
 */
@Service("sisicc.interfazCOBEnviarCobranzaSaldoPendienteService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazCOBEnviarCobranzaSaldoPendienteServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	public Map prepareQueryParams(InterfazParams interfazParams) throws InterfazException {
	    ...
	    String nombreArchivo = "SC_" + soc + "_02_" + lsAnhio + lsMes;
    ...
    protected void executeStoreProcedure(Map params) {
    	...
    	interfazCOBDAO.executeInterfazCOBEnviarCobranzaSaldoPendiente(params);
    }
}
