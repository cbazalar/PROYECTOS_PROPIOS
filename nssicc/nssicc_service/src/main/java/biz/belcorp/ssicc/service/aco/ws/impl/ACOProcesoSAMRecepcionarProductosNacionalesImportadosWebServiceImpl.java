...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSAMRecepcionarProductosNacionalesImportadosWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSAMRecepcionarProductosNacionalesImportadosWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSAMRecepcionarProductosNacionalesImportadosWebServiceImpl extends BaseInterfazHiloAbstractWebService implements
		ACOProcesoSAMRecepcionarProductosNacionalesImportadosWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSAMRecepcionarProductosNacionalesImportadosWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		String CODIGO_BATCH = Constants.SAM_CODIGO_PROCESO_BATCH_RECEPCIONAR_PRODUCTOS_NACIONALES_IMPORTADOS;
		String CODIGO_INTERFAZ = Constants.SAM_CODIGO_INTERFAZ_RECEPCIONAR_PRODUCTOS_NACIONALES_IMPORTADOS;
