 ...
 * 
 */
@Service("ssicc.procesoZONWebService02")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoZONWebService02Impl extends BaseService implements ProcesoZONWebService {

	Log log = LogFactory.getLog(ProcesoZONWebServiceImpl.class);

	@Resource(name="spusicc.procesoZONActualizarUnidadesGeograficasService")
	...
	@Resource(name="spusicc.mantenimientoLETLideresService")
	...
	@Resource(name="spusicc.consultaPEJProgramaEjecutivasService")
	ConsultaPEJProgramaEjecutivasService servicePEJ;
	
	@Resource(name="scsicc.reporteService")
	ReporteService reporteService;
	
	@Resource(name="spusicc.mantenimientoZonDirectorioService")
	...
	@Resource(name="spusicc.mantenimientoPEJProgramaEjecutivasService")
	...
	public ResponsableZONWebServiceResultado asignarResponsable(
		...
		try {
			if (StringUtils.isBlank(codigoUsuario)) {
				mensajeError = this.getKeyMessage("responsableZONWebService.msg.codigoUsuario");
				
				throw new Exception(mensajeError);
			}
			if (StringUtils.isBlank(codigoRegion)) {
				
				mensajeError = this.getKeyMessage("responsableZONWebService.msg.codigoRegion");					
				
				throw new Exception(mensajeError);
			}
			if (StringUtils.isBlank(codigoZona)) {
				mensajeError = this.getKeyMessage("responsableZONWebService.msg.codigoZona");
				
				throw new Exception(mensajeError);
			}
			if (StringUtils.isBlank(codigoSeccion)) {
				mensajeError = this.getKeyMessage("responsableZONWebService.msg.codigoSeccion");
								
				throw new Exception(mensajeError);
			}
			if (StringUtils.isBlank(campaniaNombramiento)) {
				
				mensajeError = this.getKeyMessage("responsableZONWebService.msg.codigoCampaniaNombramiento");				
				
				throw new Exception(mensajeError);
			}
			if (StringUtils.isBlank(indUA)) {
				mensajeError = this.getKeyMessage("responsableZONWebService.msg.indUA");
				
				throw new Exception(mensajeError);
			}
			if (StringUtils.isBlank(indOperacion)) {
				mensajeError = this.getKeyMessage("responsableZONWebService.msg.indOperacion");					
			...
			if (estadoCampania == 1) {
				...
				mensajeError = this.getKeyMessage("mantenimientoLETLideresForm.msg.campanaCerrada");
			...
			if (vsParamValid.equals(Constants.NUMERO_UNO)) {
				if (indicadorProgramaLet != null && indicadorProgramaLet.intValue() == 2 
					...
					mensajeError = this.getKeyMessage("mantenimientoLETLideresForm.mensaje.error.NoEncontroConcurso");
			...
			if (vsParamValid.equals(Constants.NUMERO_UNO)) {
				if (indicadorProgramaLet != null && indicadorProgramaLet.intValue() == 4) {
					...
					if (StringUtils.isBlank(codProg)) {
						mensajeError = this.getKeyMessage("mantenimientoLECLideresForm.mensaje.error.NoEncontroConcurso");
						 
						throw new Exception(mensajeError);
					}else if (iiport == 0) {
						
						mensajeError = this.getKeyMessage("mantenimientoLECLideresForm.mensaje.error.NoNombramientosWeb");								
						
						throw new Exception(mensajeError);
					} else if (iicome == 0) {
						
							mensajeError = this.getKeyMessage("mantenimientoLECLideresForm.mensaje.error.NoNombramientosCome");
	...
	private String[] asignarResponsablesUA(Map params, String vsParamValid) throws Exception {
		...
		if (codigoRespuesta.equals("1")) {
			...
			mensajeError = this.getKeyMessage(
			...
			if (codigo.equals("n")) {
				...
				String mensajeError = this.getKeyMessage("mantenimientoLETLideresForm.msg.liderOtraSeccion", datos, getLocaleIdioma(pais.getCodigoIdiomaIso()));
				throw new Exception(mensajeError);*/
			...
			mensajeError =this.getKeyMessage("mantenimientoLETLideresForm.msg.liderOtraSeccion.asignacion",
								datos);				
			...
			if (vsParamValid.equals(Constants.NUMERO_UNO)) {
				...
				if (respuestas[1].equals("0")) {
					mensajeError =this.getKeyMessage("mantenimientoLETLideresForm.msg.campanasReingreso",datos);
					

				} else {
					
					mensajeError = this.getKeyMessage("mantenimientoLETLideresForm.msg.campanasReingresoError",datos);
			...
			if (vsParamValid.equals(Constants.NUMERO_UNO)) {
				...
				mensajeError = this.getKeyMessage(mensajeZona, datos);
			...
			if (vsParamValid.equals(Constants.NUMERO_UNO)) {
				...
				mensajeError = this.getKeyMessage(mensajeSeccion, datos);
			...
			if (vsParamValid.equals(Constants.NUMERO_UNO)) {
				...
				mensajeError = this.getKeyMessage("mantenimientoLETLideresForm.msg.estatusLider", datos);
			...
			mensajeError = this.getKeyMessage("mantenimientoLETLideresForm.msg.errorValidacion", datos);
		...
		if (codigoRespuesta.equals("0")) {
			...
			if (codigoClienteBuscar.equals("")) {
				...
				mensaje = this.getKeyMessage("mantenimientoLETLideresForm.msg.deasignacionCorrecta", datos);
				...
				String mensaje ="La asignaci�n de la consultora "+ datos[0] +"como l�der de la secci�n "+ datos[1] +"se realizo correctamente desde campa�a "+datos[2]; 
					//this.getKeyMessage("mantenimientoLETLideresForm.msg.asignacionCorrecta",
