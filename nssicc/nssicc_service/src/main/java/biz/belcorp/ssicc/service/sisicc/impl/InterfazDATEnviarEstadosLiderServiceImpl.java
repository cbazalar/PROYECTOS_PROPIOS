 ...
 * <p>
 * <a href="InterfazDATEnviarEstadosLiderServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author Danny Amaro
 */
@Service("sisicc.interfazDATEnviarEstadosLiderService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazDATEnviarEstadosLiderServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService{
	...
	protected void executeStoreProcedure(Map params) {
		interfazDATDAO.executeInterfazDATEnviarEstadosLider(params);		
	}
