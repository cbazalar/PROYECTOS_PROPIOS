 ...
 * 
 */
@Service("sisicc.interfazFLXEnviarResultadoProgramasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFLXEnviarResultadoProgramasServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazFLXDAO.executeEnviarResultadoProgramas(params);
	}
