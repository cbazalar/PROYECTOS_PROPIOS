...
/**
 * Service para el proceso que Genera mensajes 4to pedido al cierre de campanha
 * 
 * @author <a href="mailto:sbuchelli@belcorp.biz">Sergio Buchelli</a>
 */
@Service("spusicc.procesoMENGenerarMensaje4toPedidoCierreCampanhaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensaje4toPedidoCierreCampanhaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENGenerarMensaje4toPedidoCierreCampanhaServiceImpl " + params);
