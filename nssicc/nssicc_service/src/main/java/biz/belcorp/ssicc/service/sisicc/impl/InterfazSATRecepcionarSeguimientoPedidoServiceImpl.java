...
/**
 * <p>
 * <a href="InterfazSATRecepcionarSeguimientoPedidoServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:aoviedo@sigcomt.com">Aurelio Oviedo</a>
 */
@Service("sisicc.interfazSATRecepcionarSeguimientoPedidoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSATRecepcionarSeguimientoPedidoServiceImpl extends
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try {
			interfazSATDAO.executeInterfazSATRecepcionarSeguimientoPedido(map);
		} catch (Exception e) {
	...
	protected void processLine(InterfazParams interfazParams, int lineCount, Map row) throws InterfazException {
		interfazSATDAO.insertInterfazSATRecepcionarSeguimientoPedido(row);
	}		
}