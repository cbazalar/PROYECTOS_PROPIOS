...
/**
 * <p>
 * <a href="ProcesoIMPSpoolGeneraArchivoBoletaPremioMatricialServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("spisicc.procesoIMPSpoolGeneraArchivoBoletaPremioMatricialService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolGeneraArchivoBoletaPremioMatricialServiceImpl extends BaseInterfazSalidaAbstractService {
	...
	protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
		...
		procesoImpresionDAO.executeSpoolGeneraArchivoBoletaPremioMatricial(params);
