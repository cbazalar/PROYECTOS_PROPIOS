 ...
 */
@Service("spisicc.procesoIMPSpoolDetalleFacturaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolDetalleFacturaServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    {
        try {
        	procesoHiloImpresionService.executeSpoolDetalleFactura(proceso);
		} catch (Exception e) {
