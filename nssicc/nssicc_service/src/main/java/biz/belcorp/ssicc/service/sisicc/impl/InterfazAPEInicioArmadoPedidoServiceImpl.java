...
/**
 * <p>
 * <a href="InterfazAPEInicioArmadoPedidoServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:aoviedo@sigcomt.com">Aurelio Oviedo</a>
 */
@Service("sisicc.interfazAPEInicioArmadoPedidoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazAPEInicioArmadoPedidoServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void processLine(InterfazParams interfazParams, int lineCount, Map row) throws InterfazException {
		...
		interfazAPEDAO.insertInterfazAPEInicioArmadoPedido(row);
	}
}