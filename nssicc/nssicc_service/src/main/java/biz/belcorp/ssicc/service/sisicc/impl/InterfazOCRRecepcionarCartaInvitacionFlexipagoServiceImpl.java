 ...
 */
@Service("sisicc.interfazOCRRecepcionCartaInvitacionFlexipagoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCRRecepcionarCartaInvitacionFlexipagoServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams)
		...
		try { 
				interfazOCRDAO.deleteInterfazOCRRecepcionarCartaInvitacionFlexipago();
				interfazOCRDAO.executeInterfazOCRRecepcionarCartaInvitacionFlexipago(map);
		} catch (Exception e) {
	...
	protected void afterProcessInterfaz(InterfazParams interfazParams)
		...
		String codTipoDocu = Constants.STO_TIPO_DOCUMENTO_CIF;
		...
		try{
			interfazOCRDAO.executeInterfazOCRProcesarConsolidadoCartaInvitacionFlexipago(map);
		}catch (Exception e) {
			throw new InterfazException("Error al procesar executeInterfazOCRProcesarCartaInvitacionFlexipago: " + e.getMessage());
		}
