...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepExcepFechEntrExacWebService;
 ...
 * 
 */
public class ACOProcesoSATRecepExcepFechEntrExacWebServiceImpl extends BaseInterfazAbstractWebService implements ACOProcesoSATRecepExcepFechEntrExacWebService {
	 ...
	 */
	public ACOWebServiceResponse ejecutarProcesoSATRecepExcepFechEntrExac(
		...
		String mensajeError = "";		
		String CODIGO_INTERFAZ = "SAT-18";
		String CODIGO_SISTEMA = "SAT";

		if (log.isDebugEnabled()) {
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoSATRecepExcepFechEntrExac");
		}
