 ...
 * <p>
 * <a href="InterfazFACRecepcionarNotaDebitoElectronicaServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sguerra@sigcomt.com">Sebastian Guerra</a>
 */
@Service("sisicc.interfazFACRecepcionarNotaDebitoElectronicaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFACRecepcionarNotaDebitoElectronicaServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	protected void executeStoreProcedure(Map params) throws InterfazException, Exception {
		...
		if(archivosProcesar != null && archivosProcesar.size() > 0){
			...
			for(int i=0; i<archivosProcesar.size(); i++){
				...
				String nombreCarpeta = Constants.FAC_NOMBRE_CARPETA_NOTAS_DEBITO;
