...
/**
 * Clase que genera el archivo de documento matricial de guias, 
 ...
 * <p>
 * <a href="InterfazIMPEnviarGuiasRemisionMatricialesServiceImpl"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazIMPEnviarGuiasRemisionMatricialesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarGuiasRemisionMatricialesServiceImpl extends
	...
	protected int writeData(InterfazParams interfazParams, File tempFile,
		...
		procesoIMPGeneracionDocumentosMatricialesDAO.executeProcesaGuiasRemisionMatriciales(params);
		procesoIMPGeneracionDocumentosMatricialesDAO.executeGeneraGuiasRemisionMatriciales(params);
		
		cantidadGuias = procesoIMPGeneracionDocumentosMatricialesDAO.getCantidadDocumentosMatriciales(params);
