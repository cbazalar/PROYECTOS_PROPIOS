 ...
 */
@Service("sisicc.interfazIVREnviarTablaClientesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIVREnviarTablaClientesServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazIVREnviarTablaClientes(params);
	}
