...
/**
 * <p>
 * <a href="ProcesoIMPSpoolCompaginacionFinalServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("spisicc.procesoIMPSpoolCompaginacionFinalService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolCompaginacionFinalServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolCompaginacionFinal(proceso);
		} catch (Exception e) {
