...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoMAEEjecutarProcesosWebService;
 ...
 */
public class ACOProcesoMAEEjecutarProcesosWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoMAEEjecutarProcesosWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoMAEEjecutarProcesos(
		...
		final String CODIGO_INTERFAZ = "MAE-P1";
		final String CODIGO_SISTEMA = "MAE";
		final String INDICADOR_PROCESO = "I";
		...
		try{
			...
			if (indicadorProceso.equals("G") || indicadorProceso.equals("Z") ||
					indicadorProceso.equals("R") || indicadorProceso.equals("P") || indicadorProceso.equals("I") ){
