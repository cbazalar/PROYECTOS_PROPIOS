...
@Service("sisicc.procesoFLXCalculoVariablesModeloService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoFLXCalculoVariablesModeloServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	protected void executeStoreProcedure(Map params) throws InterfazException, Exception {
		interfazFLXDAO.executeCalculoVariablesModelo(params);
	}
