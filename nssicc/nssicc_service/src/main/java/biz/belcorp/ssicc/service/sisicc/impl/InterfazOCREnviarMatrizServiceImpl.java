 ...
 */
@Service("sisicc.interfazOCREnviarMatrizService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCREnviarMatrizServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		...
		interfazSiCCDAO.executeInterfazOCREnviarMatriz(params);
	}
