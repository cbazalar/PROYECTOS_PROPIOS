...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCRRecepcionarSolicitudCreditoWebWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoOCRRecepcionarSolicitudCreditoWebWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoOCRRecepcionarSolicitudCreditoWebWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoOCRRecepcionarSolicitudCreditoWebWebService {
	...
	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoOCRRecepcionarSolicitudCreditoWebWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.OCR_CODIGO_PROCESO_BATCH_RECEPCIONAR_SOLICITUD_CREDITO_WEB;
		String CODIGO_INTERFAZ = Constants.OCR_CODIGO_INTERFAZ_RECEPCIONAR_SOLICITUD_CREDITO_WEB;
		String CODIGO_SISTEMA = Constants.SISTEMA_OCR;

		if (log.isDebugEnabled()) {
			log.debug("ejecutar Proceso ACOProcesoOCRRecepcionarSolicitudCreditoWeb");
		}
		...
		try {
			...
			criteria.put("codigoDocumento", Constants.STO_TIPO_DOCUMENTO_SCC);
