 ...
 * 
 * <p>
 * <a href="InterfazSAMEnviarMovimientosAlmacenSiccColombiaServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="">Yahir Rivas Luna</a>
 */
@Service("sisicc.interfazSAMEnviarMovimientosAlmacenSiccColombiaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSAMEnviarMovimientosAlmacenSiccColombiaServiceImpl extends	BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		...
		if(numeroRegistros==0){
			interfazSAMDAO.executeInterfazSAMEnviarMovimientosAlmacenSiccColombia(params);
	...
	public InterfazSAMDAO getInterfazSAMDAO() {
		return interfazSAMDAO;
	}

	public void setInterfazSAMDAO(InterfazSAMDAO interfazSAMDAO) {
		this.interfazSAMDAO = interfazSAMDAO;
	}
	/* (non-Javadoc)
