 ...
 */
@Service("msg.mailReporteGenerarMensajesEmitidosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class MailReporteGenerarMensajesEmitidosServiceImpl extends BaseMailReporteAbstractService {
	...
	protected String getEnviarCorreoElectronico(MailParams mailParams)
		...
		String correoElectronico = (String) parameterMap.get("correoGerenteZona");
