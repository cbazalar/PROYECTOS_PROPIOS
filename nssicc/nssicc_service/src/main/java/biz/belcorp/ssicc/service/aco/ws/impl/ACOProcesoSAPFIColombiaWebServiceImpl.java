...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSAPFIColombiaWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSAPFIColombiaWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSAPFIColombiaWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoSAPFIColombiaWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSAPFIColombiaWebService#ejecutarProceso(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoPeriodo, String fechaProceso, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		final String CODIGO_BATCH = Constants.SAF_CODIGO_PROCESO_BATCH_INTERFAZ_SAPFI_COLOMBIA;
		final String CODIGO_INTERFAZ = Constants.SAF_CODIGO_INTERFAZ_SAPFI_COLOMBIA;
		final String CODIGO_SISTEMA = Constants.SAF_CODIGO_SISTEMA;
