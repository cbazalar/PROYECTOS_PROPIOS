...
/**
 * Service InterfazVENEnviarFuenteVentasRealServiceImpl.
 * 
 * @author <a href="mailto:">Sergio Buchelli</a>
 */
@Service("sisicc.interfazSABEnviarFuenteVentasRealService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSABEnviarFuenteVentasRealServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSABDAO
				.executeInterfazVENEnviarFuenteVentasReal(params);
	}	
