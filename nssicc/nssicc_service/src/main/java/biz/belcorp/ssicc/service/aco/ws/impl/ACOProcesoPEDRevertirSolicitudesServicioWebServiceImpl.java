...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoPEDRevertirSolicitudesServicioWebService;
 ...
 * <p>
 * <a href="ACOProcesoPEDRevertirSolicitudesServicioWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sapaza@belcorp.biz">Sergio Apaza</a>
 */
public class ACOProcesoPEDRevertirSolicitudesServicioWebServiceImpl extends BaseProcesoSICCAbstractWebService 
		implements ACOProcesoPEDRevertirSolicitudesServicioWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoPEDRevertirSolicitudesServicio(
		...
		if (log.isDebugEnabled()) {
			log.debug("ejecutarProcesoPEDRevertirSolicitudesServicio");
		}
		...
		try {
			...
			if (StringUtils.isBlank(fechaInicio)) {
				fechaInicio = controlFacturacion.getFechaProceso();
			}
			...
			DTOEntradaSICC dtoEntrada = obtenerDTOEntradaSICC(codigoPais, codigoUsuario, codigoPeriodo, 
																fechaInicio, pais.getCodigoIdiomaIso());
			dtoEntrada.setProcesoNegocio(ConstantesIntegracion.PROCESO_REVERTIR_SOLICITUDES);
