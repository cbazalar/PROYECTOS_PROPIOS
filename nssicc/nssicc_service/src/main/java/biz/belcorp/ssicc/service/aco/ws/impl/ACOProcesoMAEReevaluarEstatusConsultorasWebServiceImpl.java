...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoMAEReevaluarEstatusConsultorasWebService;
 ...
 * <p>
 * <a href="ACOProcesoMAEReevaluarEstatusConsultorasWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sapaza@belcorp.biz">Sergio Apaza</a>
 */
public class ACOProcesoMAEReevaluarEstatusConsultorasWebServiceImpl extends BaseProcesoSICCAbstractWebService 
		implements ACOProcesoMAEReevaluarEstatusConsultorasWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoMAEReevaluarEstatusConsultoras(
		...
		if (log.isDebugEnabled()) {
			log.debug("ejecutarProcesoMAEReevaluarEstatusConsultoras");
		}
		...
		try {
			...
			dtoEntrada.setProcesoNegocio(ConstantesIntegracion.PROCESO_REEVALUAR_ESTATUS);
