...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoCOBEnviarRecuCobranzaFFVVDatamartWebService;
 ...
 */
public class ACOProcesoCOBEnviarRecuCobranzaFFVVDatamartWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoCOBEnviarRecuCobranzaFFVVDatamartWebService{
	...
	public ACOWebServiceResponse ejecutarProcesoCOBEnviarRecuCobranzaFFVVDatamart(
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = "16";
		final String CODIGO_INTERFAZ = "COB-14";
		final String CODIGO_SISTEMA = "COB";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoCOBEnviarRecuCobranzaFFVVDatamart");
		}
		try{
