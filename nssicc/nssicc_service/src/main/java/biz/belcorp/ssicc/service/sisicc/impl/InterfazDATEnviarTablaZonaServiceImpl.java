 ...
 * <p>
 * <a href="InterfazDATEnviarTablaZonaServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("sisicc.interfazDATEnviarTablaZonaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazDATEnviarTablaZonaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazDATDAO.executeInterfazDATEnviarTablaZona(params);
	}
