 ...
 * <p>
 * <a href="InterfazDATEnviarNivelLetServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author Yahir Rivas L.
 */
@Service("sisicc.interfazDATEnviarNivelLetService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazDATEnviarNivelLetServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService{
	...
	protected void executeStoreProcedure(Map params) {
		interfazDATDAO.executeInterfazDATEnviarNivelLet(params);
