 ...
 * <p>
 * <a href="InterfazPREEnviarRangoPromocionServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="}">Jos Luis Rodriguez</a>
 */
@Service("sisicc.interfazPREEnviarRangoPromocionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPREEnviarRangoPromocionServiceImpl extends
	...
	protected void executeStoreProcedure(Map map) {
		InterfazPREDAO.executeInterfazPREEnviarRangoPromocion(map);
