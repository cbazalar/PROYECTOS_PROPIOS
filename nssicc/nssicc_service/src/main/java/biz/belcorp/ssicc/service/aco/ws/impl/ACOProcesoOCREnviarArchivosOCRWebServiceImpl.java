...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCREnviarArchivosOCRWebService;
 ...
 */
public class ACOProcesoOCREnviarArchivosOCRWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoOCREnviarArchivosOCRWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoOCREnviarArchivosOCR(
		...
		final String CODIGO_INTERFAZ = "IVR-P10";
		final String CODIGO_SISTEMA = "IVR";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz OCREnviarArchivosOCR");
		}
		try{
