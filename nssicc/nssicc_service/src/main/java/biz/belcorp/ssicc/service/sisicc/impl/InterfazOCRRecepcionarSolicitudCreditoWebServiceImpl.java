 ...
 * 
 */
@Service("sisicc.interfazOCRRecepcionarSolicitudCreditoWebService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCRRecepcionarSolicitudCreditoWebServiceImpl extends
	...
	protected void beforeReadData(InterfazParams interfazParams)
		...
		try {
			...
			interfazOCRDAO.deleteInterfazOCRRecepcionarSolicitudCreditoWeb();
			interfazOCRDAO
					.executeInterfazOCRRecepcionarSolicitudCreditoWeb(map);
	...
	protected void afterProcessInterfaz(InterfazParams interfazParams)
		...
		try {
			...
			throw new InterfazException(
					"Error al procesar executeInterfazOCRProcesarConsolidadoSolicitudCreditoWeb: "
							+ e.getMessage());
		}
	}
