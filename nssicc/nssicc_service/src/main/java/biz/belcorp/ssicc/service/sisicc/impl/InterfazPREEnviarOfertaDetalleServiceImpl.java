 ...
 * <p>
 * <a href="InterfazPREEnviarOfertaDetalleServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="}">Jos Luis Rodriguez</a>
 */
@Service("sisicc.interfazPREEnviarOfertaDetalleService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPREEnviarOfertaDetalleServiceImpl extends
	...
	protected void executeStoreProcedure(Map map) {
		InterfazPREDAO.executeInterfazPREEnviarOfertaDetalle(map);
	}
}
