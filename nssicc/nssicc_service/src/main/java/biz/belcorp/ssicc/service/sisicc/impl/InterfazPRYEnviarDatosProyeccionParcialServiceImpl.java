 ...
 */
@Service("sisicc.interfazPRYEnviarDatosProyeccionParcialService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRYEnviarDatosProyeccionParcialServiceImpl extends
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        try {
           ...
           Date dateFechaFacturacion = DateUtil.convertStringToDate(Constants.DEFAULT_DATE_FORMAT, fechaFacturacion);
            String fechaS = DateUtil.convertDateToString("yyyyMMdd", dateFechaFacturacion);
            queryParams
            ...
            result = this.interfazPRYDAO
                    .getInterfazPRYEnviarDatosProyeccionParcial(queryParams);
        } catch (Exception e) {
