 ...
 * 
 * <p>
 * <a href="InterfazSMSEnviarConsultorasPagosCCRecaudoBancarioServiceImpl.java.html"><i>View Source</i></a>
 * </p>
 * 
 * @author sguerra
 *
 */
@Service("sisicc.interfazSMSEnviarConsultorasPagosCCRecaudoBancarioService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSMSEnviarConsultorasPagosCCRecaudoBancarioServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		interfazSMSDAO.executeInterfazSMSEnviarConsultorasPagosCCRecaudoBancario(params);
	}
