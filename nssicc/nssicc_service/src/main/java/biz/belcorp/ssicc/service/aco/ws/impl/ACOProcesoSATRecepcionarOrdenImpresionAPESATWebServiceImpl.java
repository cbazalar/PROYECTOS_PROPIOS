...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepcionarOrdenImpresionAPESATWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarOrdenImpresionAPESATWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSATRecepcionarOrdenImpresionAPESATWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoSATRecepcionarOrdenImpresionAPESATWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSATRecepcionarOrdenImpresionAPESATWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		String CODIGO_INTERFAZ = Constants.SAT_CODIGO_INTERFAZ_RECEPCIONAR_ORDEN_IMPRESION_APESAT;
		String CODIGO_SISTEMA = Constants.SAT_CODIGO_SISTEMA;
		String CODIGO_BATCH = Constants.SAT_CODIGO_PROCESO_BATCH_RECEPCIONAR_ORDEN_IMPRESION_APESAT;
