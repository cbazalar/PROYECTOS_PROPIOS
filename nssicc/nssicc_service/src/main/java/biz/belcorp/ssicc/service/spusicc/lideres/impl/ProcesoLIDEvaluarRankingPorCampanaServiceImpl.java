...
/**
 * Service para el Proceso que permite ebaluar ranking por campanha
 * 
 * @author <a href="mailto:sbuchelli@belcorp.biz">Sergio Buchelli</a>
 */
@Service("spusicc.procesoLIDEvaluaRankingPorCampanaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoLIDEvaluarRankingPorCampanaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		procesoLIDEvaluarRankingDAO.executeEvaluarRankingLideresCampana(params);
	}
