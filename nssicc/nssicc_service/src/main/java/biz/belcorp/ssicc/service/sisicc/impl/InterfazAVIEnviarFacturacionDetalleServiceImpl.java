...
/**
 * Service para el envio de Facturacion Detalle de la Interfaz AVI.
 *   
 * @author <a href="mailto:sapaza@belcorp.biz">Sergio Apaza </a>
 */
@Service("sisicc.interfazAVIEnviarFacturacionDetalleService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazAVIEnviarFacturacionDetalleServiceImpl extends
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        try {
        	listFacturacionDetalle = this.interfazAVIDAO
            		.getInterfazAVIFacturacionDetalle(queryParams);
