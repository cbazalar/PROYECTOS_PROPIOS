...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCRRetCodAsigWebService;
 ...
 */
public class ACOProcesoOCRRetCodAsigWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoOCRRetCodAsigWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoOCRRetCodAsig(
		...
		String mensajeError = "";
		final String CODIGO_INTERFAZ = Constants.OCR_CODIGO_INTERFAZ_RETORNO_CODIGOS_ASIGNADOS;
		final String CODIGO_SISTEMA = Constants.OCR_CODIGO_SISTEMA;
		final String CODIGO_BATCH = Constants.OCR_CODIGO_PROCESO_BATCH_RETORNO_CODIGOS_ASIGNADOS;				
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoOCRRetCodAsig");
		}
		try{
