 ...
 */
@Service("spusicc.procesoMENConsultorasTipoOfertaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENConsultorasTipoOfertaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENConsultorasTipoOfertaServiceImpl " + params);
