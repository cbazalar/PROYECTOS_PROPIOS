...
/**
 * Service InterfazLETEnviarPagosCabecera1ServiceImpl.
 * 
 * @author <a href="mailto:dtorres@sigcomt.com">Diego Torres L.</a>
 */
@Service("sisicc.interfazLETEnviarPagosCabecera1Service")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazLETEnviarPagosCabecera1ServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	public Map prepareQueryParams(InterfazParams interfazParams)
			throws InterfazException {
				...
				queryParams.put("directorioCabecera1", directorioCabecera);
	...
	protected void executeStoreProcedure(Map params) {
		this.interfazLETDAO.executeInterfazLETEnviarPagosCabecera1(params);
		params.put("nombreArchivoCabecera1", MapUtils.getString(params, "nombreArchivo"));
	}	
