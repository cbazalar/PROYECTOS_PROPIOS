 ...
 */
@Service("sisicc.InterfazACCEnviarTablasClientesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazACCEnviarTablasClientesServiceImpl extends	BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		...
		interfazACCDAO.executeInterfazACCEnviarTablasClientes(params);
	}
