 ...
 */
@Service("sisicc.interfazOCRRecepcionarBoletaEntregaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCRRecepcionarBoletaEntregaServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try { 
				interfazOCRDAO.executeInterfazOCRRecepcionarBoletaEntrega(map);
		} catch (Exception e) {
	...
	protected void beforeExecuteInterfaz(Map params) throws Exception {
		...
		this.afterTransaccionIndependienteDobleTransaccion = true;
	}
