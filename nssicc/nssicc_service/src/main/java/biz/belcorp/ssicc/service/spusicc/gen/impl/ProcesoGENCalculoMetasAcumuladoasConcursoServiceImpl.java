 ...
 *
 */
@Service("spusicc.procesoGENCalculoMetasAcumuladoasConcursoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoGENCalculoMetasAcumuladoasConcursoServiceImpl extends BaseInterfazProcesoAbstractService{
