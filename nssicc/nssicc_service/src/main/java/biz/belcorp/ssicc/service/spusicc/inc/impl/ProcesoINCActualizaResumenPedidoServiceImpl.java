 ...
 *
 */
@Service("spusicc.procesoINCActualizaResumenPedidoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoINCActualizaResumenPedidoServiceImpl extends BaseInterfazProcesoAbstractService{
