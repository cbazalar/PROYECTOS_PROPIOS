...
/**
 * Service InterfazSABEnviarPedidosTotalesServiceImpl.
 * 
 * @author <a href="mailto:">Sergio Apaza</a>
 */
@Service("sisicc.interfazSABEnviarPedidosTotalesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSABEnviarPedidosTotalesServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSABDAO.executeInterfazSABEnviarPedidosTotales(params);
	}	
