...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoIMPEnviarDocumentosElectronicosWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoIMPEnviarDocumentosElectronicosWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoIMPEnviarDocumentosElectronicosWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoIMPEnviarDocumentosElectronicosWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoIMPEnviarDocumentosElectronicosWebService#ejecutarProceso(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoPeriodo, String fechaFacturacion, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		final String CODIGO_BATCH = Constants.IMP_CODIGO_PROCESO_BATCH_ENVIAR_DOCUMENTOS_ELECTRONICOS;
		final String CODIGO_INTERFAZ = Constants.IMP_CODIGO_INTERFAZ_ENVIAR_DOCUMENTOS_ELECTRONICOS;
		final String CODIGO_SISTEMA = Constants.IMP_CODIGO_SISTEMA;
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ACOProcesoIMPEnviarDocumentosElectronicos");
		}
		try{
