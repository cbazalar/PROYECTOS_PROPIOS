 ...
 * 
 */
@Service("sisicc.interfazOCREnviarOfertasProlService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCREnviarOfertasProlServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazOCRDAO
				.executeInterfazOCREnviarOfertasProl(params);
	}
}