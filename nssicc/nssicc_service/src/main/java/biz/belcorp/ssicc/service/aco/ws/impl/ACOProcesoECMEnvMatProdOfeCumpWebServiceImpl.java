...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoECMEnvMatProdOfeCumpWebService;
 ...
 */
public class ACOProcesoECMEnvMatProdOfeCumpWebServiceImpl extends BaseInterfazAbstractWebService implements ACOProcesoECMEnvMatProdOfeCumpWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoECMEnvMatProdOfeCump(
		...
		String mensajeError = "";		
		final String CODIGO_INTERFAZ = "ECM-9";
		final String CODIGO_SISTEMA = "ECM";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso ejecutarProcesoECMEnvMatProdOfeCump");
		}
		try{
