 ...
 */
@Service("spisicc.procesoIMPSpoolDetalleFactura3Service")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolDetalleFactura3ServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
	...
	protected void beforeProcessInterfaz(InterfazParams interfazParams)	throws InterfazException {
		procesoHiloImpresionService.deleteProcesoIMPSpoolDetalleFactura();
	}
    ...
    {
        try {
        	procesoHiloImpresionService.executeSpoolDetalleFactura3(proceso);
		} catch (Exception e) {
