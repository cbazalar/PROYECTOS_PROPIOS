...
/**
 * Clase que genera el archivo de documento Nota de Debito Laser
 ...
 * laser.
 * <p>
 * <a href="InterfazIMPEnviarNotaDebitoLaserServiceImpl"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="">Jose Luis Rodriguez</a>
 */
@Service("sisicc.interfazIMPEnviarNotaDebitoLaserService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarNotaDebitoLaserServiceImpl extends BaseInterfazSalidaAbstractService {
	...
	protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
		...
		procesoIMPGeneracionDocumentosLaserDAO.executeGeneraNotaDebitoLaser(params);
