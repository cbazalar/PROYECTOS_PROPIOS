...
/**
 * <p>
 * <a href="InterfazCOBRecepcionarGestionCobranzaTerceroServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:jvelasquez@sigcomt.com">Jorge Velasquez</a>
 */
@Service("sisicc.interfazCOBRecepcionarGestionCobranzaTerceroService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazCOBRecepcionarGestionCobranzaTerceroServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams)
		...
		this.interfazCOBDAO.executeInterfazCOBRecepcionarGestionCobranzaTercero(params);
