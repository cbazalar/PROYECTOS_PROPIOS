...
/**
 * Service de la recepcion de OCS Web - DD Detalle de la Interfaz OCR.
 * 
 * @author <a href="mailto:doliva@belcorp.biz">Dennys Oliva</a>
 */
@Service("sisicc.interfazOCRRecepcionarOCSWebDDDetalleService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCRRecepcionarOCSWebDDDetalleServiceImpl extends BaseInterfazEntradaAbstractService {
