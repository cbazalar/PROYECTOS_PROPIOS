 ...
 */
@Service("sisicc.interfazCOMEnviarFicheroPagoComisionEjecutivaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazCOMEnviarFicheroPagoComisionEjecutivaServiceImpl extends	BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazCOMEnviarFicheroPagoComisionEjecutiva(params);
	}
