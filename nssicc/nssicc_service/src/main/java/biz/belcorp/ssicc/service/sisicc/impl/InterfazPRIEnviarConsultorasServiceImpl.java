 ...
 */
@Service("sisicc.interfazPRIEnviarConsultorasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRIEnviarConsultorasServiceImpl extends
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		try {
			...
			list = this.consultoraDAO.getConsultorasMapByPais(codigoPais);
		} catch (Exception e) {
