 ...
 */
@Service("sisicc.interfazPRYEnviarPedidosDiaPedidosAcumuladosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRYEnviarPedidosDiaPedidosAcumuladosServiceImpl extends
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        try {
            ...
            Date dateFechaFacturacion = DateUtil.convertStringToDate(Constants.DEFAULT_DATE_FORMAT, fechaFacturacion);
             String fechaStr = DateUtil.convertDateToString("yyyyMMdd", dateFechaFacturacion);
             queryParams
                     .put("fechaFacturacionDate", fechaFacturacion);
             
             queryParams
             .put("fechaStr", fechaStr);
            
            log.debug("queryParams=" + queryParams);
            result = this.interfazPRYDAO
                    .getInterfazPRYEnviarPedidosDiaPedidosAcumulados(queryParams);
        } catch (Exception e) {
