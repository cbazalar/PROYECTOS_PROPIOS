...
/**
 * Implementacion del Service de ejecucin de los Graficos SSiCC (BAR3D Vertical)
 * 
 * @author <a href="mailto:cbazalar@belcorp.biz">Carlos Bazalar La Rosa</a>
 */
@Service("scsicc.graphExecutionBar3DVerticalService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class GraphExecutionBar3DVerticalServiceImpl implements GraphExecutionService {
	...
	public final GraphResult generarGrafico(GraphParams graphParam) throws Exception {
		...
		log.debug("Se genero el Grafico BAR 3D Vertical");
		return graphResult;
	}
