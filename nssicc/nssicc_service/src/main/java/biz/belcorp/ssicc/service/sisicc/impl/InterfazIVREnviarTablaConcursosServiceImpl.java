 ...
 * <p>
 * <a href="InterfazIVREnviarTablaConcursosServiceImpl.java.html"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:jcairampoma@belcorp.biz">Jos A. Cairampoma</a>
 */
@Service("sisicc.interfazIVREnviarTablaConcursosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIVREnviarTablaConcursosServiceImpl extends
	...
	public Map prepareQueryParams(InterfazParams interfazParams)
		...
		String infoAdic = (String) queryParams.get("indProceso");
		...
		paramsIVR.put("infoAdic", infoAdic);
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazIVREnviarTablaConcursos(params);
	}
