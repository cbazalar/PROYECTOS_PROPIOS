/*
 * Created on 15/04/2010 05:55:46 PM
 * biz.belcorp.ssicc.sisicc.service.impl.InterfazIMPEnviarFacturasPremioMatricialesServiceImpl
 */
 ...
 */
@Service("sisicc.interfazIMPEnviarFacturasPremioMatricialesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarFacturasPremioMatricialesServiceImpl extends
	...
	protected int writeData(InterfazParams interfazParams, File tempFile,
		...
		procesoIMPGeneracionDocumentosMatricialesDAO.executeProcesaFacturasPremioMatriciales(params);
		procesoIMPGeneracionDocumentosMatricialesDAO.executeGeneraFacturasPremioMatriciales(params);
