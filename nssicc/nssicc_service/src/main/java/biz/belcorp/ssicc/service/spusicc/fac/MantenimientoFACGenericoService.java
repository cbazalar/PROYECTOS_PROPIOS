package biz.belcorp.ssicc.service.spusicc.fac;
 ...
 *
 */
public interface MantenimientoFACGenericoService  extends Service{
	...
	/**
	 * Actualiza todo el consolidado
	 * @param map
	 */
	void updateConsolidadoCierreFacturacion(Map map);
