...
/**
 * Service InterfazVENEnviarMaestroRegionesServiceImpl.
 * 
 * @author <a href="mailto:">Sergio Buchelli</a>
 */
@Service("sisicc.interfazSABEnviarMaestroRegionesService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSABEnviarMaestroRegionesServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSABDAO
				.executeInterfazVENEnviarMaestroRegiones(params);
	}	
