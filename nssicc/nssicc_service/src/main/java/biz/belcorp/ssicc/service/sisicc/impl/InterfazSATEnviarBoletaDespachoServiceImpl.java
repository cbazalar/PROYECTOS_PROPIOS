 ...
 */
@Service("sisicc.interfazSATEnviarBoletaDespachoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSATEnviarBoletaDespachoServiceImpl extends
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		try {
			...
			list = this.interfazSiCCDAO.getInterfazSATEnviarBoletaDespachoA(queryParams);
