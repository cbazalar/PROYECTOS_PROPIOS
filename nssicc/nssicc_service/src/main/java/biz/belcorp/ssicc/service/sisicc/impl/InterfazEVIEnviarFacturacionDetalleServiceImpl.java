 ...
 * biz.belcorp.ssicc.sisicc.service.impl.InterfazEVIEnviarFacturacionDetalleServiceImpl
 */
 ...
 * <p>
 * <a href="InterfazEVIEnviarFacturacionDetalleServiceImpl.java.html">
 * <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cmarius@belcorp.biz">Carla Marius </a>
 */
@Service("sisicc.interfazEVIEnviarFacturacionDetalleService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazEVIEnviarFacturacionDetalleServiceImpl extends
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        List listFacturacionDetalle = null;
        try {
        	listFacturacionDetalle = this.interfazEVIDAO
            		.getInterfazEVIFacturacionDetalle(queryParams);
