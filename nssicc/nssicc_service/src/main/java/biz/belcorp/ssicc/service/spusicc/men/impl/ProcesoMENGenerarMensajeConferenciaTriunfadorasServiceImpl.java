 ...
 *
 */
@Service("spusicc.procesoMENGenerarMensajeConferenciaTriunfadorasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensajeConferenciaTriunfadorasServiceImpl extends BaseInterfazProcesoAbstractService{
	...
	protected void executeStoreProcedure(Map params) throws InterfazException {
		log.debug("inicio ProcesoMENGenerarMensajeConferenciaTriunfadorasServiceImpl " + params);
