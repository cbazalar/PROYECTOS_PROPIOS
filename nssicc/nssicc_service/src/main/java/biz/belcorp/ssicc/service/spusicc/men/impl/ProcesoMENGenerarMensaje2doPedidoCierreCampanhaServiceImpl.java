...
/**
 * Service para el proceso que Genera mensajes 2do pedido al cierre de campanha
 * 
 * @author <a href="mailto:sbuchelli@belcorp.biz">Sergio Buchelli</a>
 */
@Service("spusicc.procesoMENGenerarMensaje2doPedidoCierreCampanhaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarMensaje2doPedidoCierreCampanhaServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENGenerarMensaje2doPedidoCierreCampanhaServiceImpl " + params);
