 ...
 * <p>
 * <a href="InterfazPREEnviarMatrizFacturacionServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="}">Jos Luis Rodriguez</a>
 */
@Service("sisicc.interfazPREEnviarMatrizFacturacionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPREEnviarMatrizFacturacionServiceImpl extends
	...
	protected void executeStoreProcedure(Map map) {
		InterfazPREDAO.executeInterfazPREEnviarMatrizFacturacion(map);	
	}
