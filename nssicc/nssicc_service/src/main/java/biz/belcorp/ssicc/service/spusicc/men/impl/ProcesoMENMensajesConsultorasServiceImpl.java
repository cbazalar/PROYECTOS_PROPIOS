 ...
 */
@Service("spusicc.procesoMENMensajesConsultorasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENMensajesConsultorasServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
	 log.debug("inicio ProcesoMENMensajesConsultorasServiceImpl " + params);
