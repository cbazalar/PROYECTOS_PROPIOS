 ...
 * <p>
 * <a href="InterfazPRERecepcionarRangoPromocionServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="}">Jos Luis Rodriguez</a>
 */
@Service("sisicc.interfazPRERecepcionarRangoPromocionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRERecepcionarRangoPromocionServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try { 
			InterfazPREDAO.executeInterfazPRERecepcionarRangoPromocion(map);
		} catch (Exception e) {
