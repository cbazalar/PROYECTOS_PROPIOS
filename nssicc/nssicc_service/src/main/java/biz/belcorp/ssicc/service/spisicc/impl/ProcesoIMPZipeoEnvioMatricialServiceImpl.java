 ...
 */
@Service("spisicc.procesoIMPZipeoEnvioMatricialService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPZipeoEnvioMatricialServiceImpl extends
	...
	protected int writeData(InterfazParams interfazParams, File tempFile, List data) throws InterfazException {
		...
		params.put("codigoProcesoImpresion", Constants.PROCESO_IMPRESION_MATRICIAL);//MAT
