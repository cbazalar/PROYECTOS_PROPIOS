 ...
 * <p>
 * <a href="InterfazPREEnviarOfertaCabeceraServiceImpl.java.html"> <i>View Source
 * </i> </a>
 * </p>
 * 
 * @author <a href="}">Jos Luis Rodriguez</a>
 */
@Service("sisicc.interfazPREEnviarOfertaCabeceraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPREEnviarOfertaCabeceraServiceImpl extends
	...
	protected void executeStoreProcedure(Map map) {
		InterfazPREDAO.executeInterfazPREEnviarOfertaCabecera(map);
	}
