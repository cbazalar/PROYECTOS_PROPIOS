 ...
 */
@Service("sisicc.interfazAPEEnviarCabeceraBoletasRecojoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazAPEEnviarCabeceraBoletasRecojoServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazAPEDAO.executeInterfazAPEEnviarCabeceraBoletasRecojo(params);
	}
}