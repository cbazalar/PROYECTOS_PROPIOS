...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoAPEInicioArmadoPedidoWebService;
 ...
 * <p>
 * <a href="ACOProcesoAPEInicioArmadoPedidoWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto</a>
 */
public class ACOProcesoAPEInicioArmadoPedidoWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoAPEInicioArmadoPedidoWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoAPEInicioArmadoPedidoWebService#ejecutarProcesoAPEInicioArmadoPedido(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProcesoAPEInicioArmadoPedido(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		final String CODIGO_BATCH = Constants.APE_CODIGO_PROCESO_BATCH_INICIO_ARMADO_PEDIDOS;
		final String CODIGO_INTERFAZ = Constants.APE_CODIGO_INTERFAZ_INICIO_ARMADO_PEDIDOS;
