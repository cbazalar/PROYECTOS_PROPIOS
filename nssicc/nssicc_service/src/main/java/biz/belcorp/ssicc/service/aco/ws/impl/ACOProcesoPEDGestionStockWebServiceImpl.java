...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoPEDGestionStockWebService;
 ...
 * <p>
 * <a href="ACOProcesoPEDGestionStockWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:sapaza@belcorp.biz">Sergio Apaza</a>
 */
public class ACOProcesoPEDGestionStockWebServiceImpl extends BaseProcesoSICCAbstractWebService 
		implements ACOProcesoPEDGestionStockWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoPEDGestionStock(
		...
		if (log.isDebugEnabled()) {
			log.debug("ejecutarProcesoPEDGestionStock");
		}
		...
		try {
			...
			dtoEntrada.setProcesoNegocio(ConstantesIntegracion.PROCESO_MONITOR_GP4);
