...
public class ProcesoSTOApproveExecutorServiceImpl extends BaseProcesoSTOExecutorAbstractService {
	...
	protected void execute(DocumentoSTOParams documentoSTOParams) throws Exception {
		...
		stoImpl.approveValidacionDocumentoSTO(documentoSTOParams);
