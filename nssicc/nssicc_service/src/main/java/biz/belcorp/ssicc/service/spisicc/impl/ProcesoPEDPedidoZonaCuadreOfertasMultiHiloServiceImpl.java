...
/**
 * <p>
 * <a href="ProcesoIMPSpoolFacturaLaserMultihiloServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Gonzalo Javier Huertas Agurto</a>
 */
@Service("spisicc.procesoPEDPedidoZonaCuadreOfertasMultiHiloService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoPEDPedidoZonaCuadreOfertasMultiHiloServiceImpl extends BaseProcesoPEDPedidoZonaHiloAbstractService {
        ...
        try {
        	...
        	if(pedidos!=null && pedidos.size()>0){
        		...
        		for(int i=0;i<pedidos.size();i++){
        			...
        			procesoHiloPedidoZonaService.executeCuadrarOfertasPedidoZonaMultihilo(criteriaProceso);
        		}
        	}
		} catch (Exception e) {
