 ...
 * <p>
 * <a href="InterfazIMPEnviarNotasCreditoBoletasCabeceraPeruServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cbazalar@sigcomt.com">Carlos Bazalar</a>
 */
@Service("sisicc.interfazIMPEnviarNotasCreditoBoletasCabeceraPeruService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazIMPEnviarNotasCreditoBoletasCabeceraPeruServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		...
		if (StringUtils.isNotBlank(codigoPeriodo) && StringUtils.isNotBlank(fechaFacturacion))
			interfazIMPDAO.executeInterfazIMPEnviarNotasCreditoBoletasCabeceraPeru(params);
		else
