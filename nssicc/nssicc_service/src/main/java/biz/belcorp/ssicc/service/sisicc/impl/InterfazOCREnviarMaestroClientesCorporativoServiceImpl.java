 ...
 */
@Service("sisicc.interfazOCREnviarMaestroClientesCorporativoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCREnviarMaestroClientesCorporativoServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazOCREnviarMaestroClientesCorporativo(params);
	}
