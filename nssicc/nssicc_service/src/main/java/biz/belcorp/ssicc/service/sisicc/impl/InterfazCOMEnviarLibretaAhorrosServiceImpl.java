 ...
 */
@Service("sisicc.interfazCOMEnviarLibretaAhorrosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazCOMEnviarLibretaAhorrosServiceImpl extends
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        try {
            list = this.interfazSiCCDAO
                    .getInterfazCOMEnviarLibretaAhorros(queryParams);
        } catch (Exception e) {
