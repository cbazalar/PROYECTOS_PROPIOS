...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSGRRecepcionarPolizasCanceladasWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSGRRecepcionarPolizasCanceladasWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSGRRecepcionarPolizasCanceladasWebServiceImpl extends
		BaseInterfazHiloAbstractWebService implements
		ACOProcesoSGRRecepcionarPolizasCanceladasWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSGRRecepcionarPolizasCanceladasWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.SGR_CODIGO_PROCESO_BATCH_RECEPCIONAR_POLIZAS_CANCELADAS;
		String CODIGO_INTERFAZ = Constants.SGR_CODIGO_INTERFAZ_RECEPCIONAR_POLIZAS_CANCELADAS;
		String CODIGO_SISTEMA = Constants.SGR_CODIGO_SISTEMA;
