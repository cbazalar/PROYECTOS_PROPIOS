 ...
 * 
 */
@Service("sisicc.interfazPaqueteOCRRecepcionarOCSDemandaWebService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPaqueteOCRRecepcionarOCSDemandaWebServiceImpl extends SSiCC_Desfasado_BasePaqueteInterfazServiceImpl {
