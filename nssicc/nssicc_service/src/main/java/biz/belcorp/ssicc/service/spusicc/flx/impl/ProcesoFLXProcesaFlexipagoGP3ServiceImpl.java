...
@Service("sisicc.procesoFLXProcesaFlexipagoGP3Service")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoFLXProcesaFlexipagoGP3ServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	protected void executeStoreProcedure(Map params) throws InterfazException, Exception {
		interfazFLXDAO.executeProcesarFlexipagoGP3(params);
