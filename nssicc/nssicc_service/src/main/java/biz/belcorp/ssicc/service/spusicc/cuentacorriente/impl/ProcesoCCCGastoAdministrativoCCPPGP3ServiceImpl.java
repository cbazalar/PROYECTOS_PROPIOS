...
@Service("sisicc.procesoCCCGastoAdministrativoCCPPGP3Service")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoCCCGastoAdministrativoCCPPGP3ServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	protected void executeStoreProcedure(Map params) throws InterfazException, Exception {
		interfazCCCDAO.executeGenerarCargoGastoAdministrativoCCPPGP3(params);
