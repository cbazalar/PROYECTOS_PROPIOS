 ...
 *
 */
@Service("spusicc.procesoGENResultadoAcumuladoConcursoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoGENResultadoAcumuladoConcursoServiceImpl extends BaseInterfazProcesoAbstractService{
