...
@Service("sisicc.interfazPRERecepcionarCondicionesOfertaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRERecepcionarCondicionesOfertaServiceImpl extends BaseInterfazEntradaAbstractService 
{
	...
	{		
		...
		for(int i=0; i< data.size(); i++)
		{
			...
			interfazPREDAO.insertCondicionesOferta(criteria);	
			j++;
		}
	}
}
