...
/**
 * <p>
 * <a href="ProcesoIMPSpoolGeneraCtaCteServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio buchelli</a>
 */
@Service("spisicc.procesoIMPSpoolGeneraCtaCteService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolGeneraCtaCteServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolGeneraCtaCteService(proceso);
		} catch (Exception e) {
