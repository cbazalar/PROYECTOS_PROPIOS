 ...
 * <p>
 * <a href="InterfazPRIEnviarArchivosOCRDetalleServiceImpl"> <i>View
 * Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:cahurtado@belcorp.biz">Carlos Hurtado Ramrez </a>
 */
@Service("sisicc.interfazPRIEnviarArchivosOCRDetalleService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRIEnviarArchivosOCRDetalleServiceImpl extends
	...
	protected List readData(Map queryParams) throws InterfazException {
		...
		List list = null;
		try {
			String indicadorPremio = (String)queryParams.get("indicadorPremio");
			log.debug("indicadorPremio: "+indicadorPremio);
			list = this.premioDAO.getPremiosDetalle(queryParams);
		} catch (Exception e) {
