...
/**
 * <p>
 * <a href="ProcesoIMPCalculoFleteServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="">Sergio Buchelli</a>
 */
@Service("spisicc.procesoIMPCalculoFleteService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPCalculoFleteServiceImpl extends BaseInterfazProcesoAbstractService {
	...
	protected void executeStoreProcedure(Map params) throws InterfazException,
			Exception {
		procesoImpresionDAO.executeCalculoFlete(params);
