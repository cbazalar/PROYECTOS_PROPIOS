 ...
 */
@Service("sisicc.interfazMYERecepcionarActivacionFlexipagoWebService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazMYERecepcionarActivacionFlexipagoWebServiceImpl extends	BaseInterfazEntradaAbstractService {
	...
	protected void beforeReadData(InterfazParams interfazParams) throws InterfazException {
		...
		try {
			interfazMYEDAO.executeInterfazMYERecepcionarActivacionFlexipagoWeb(map);
		} catch (Exception e) {
	...
	protected void afterProcessInterfaz(InterfazParams interfazParams)	throws InterfazException {
		...
		try{
			interfazMYEDAO.executeInterfazMYERecepcionarActivacionFlexipagoWebFLX(map);
		}catch (Exception e) {
