 ...
 */
@Service("sisicc.interfazDATEnviarFechaProcesoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazDATEnviarFechaProcesoServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazDATDAO.executeInterfazDATEnviarFechaProceso(params);
	}
