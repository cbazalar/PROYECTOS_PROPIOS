...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoLLIEnviarVentaPeriodoWebService;
 ...
 */
public class ACOProcesoLLIEnviarVentaPeriodoWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoLLIEnviarVentaPeriodoWebService {

	
	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoLLIEnviarVentaPeriodoWebService#ejecutarProcesoLLIEnviarVentaPeriodo(java.lang.String, java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProcesoLLIEnviarVentaPeriodo(
		...
		String mensajeError = "";		
		final String CODIGO_INTERFAZ = Constants.LLI_CODIGO_INTERFAZ_ENVIAR_VENTA_PERIODO;
		final String CODIGO_SISTEMA = Constants.LLI_CODIGO_SISTEMA;
		final String CODIGO_BATCH = Constants.LLI_CODIGO_PROCESO_BATCH_ENVIAR_VENTA_PERIODO;
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso ejecutarProcesoLLIEnviarVentaPeriodo");
		}
		try{
