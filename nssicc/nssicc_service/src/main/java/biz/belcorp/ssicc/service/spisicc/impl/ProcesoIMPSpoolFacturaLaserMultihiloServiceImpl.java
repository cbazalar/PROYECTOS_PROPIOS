 ...
 */
@Service("spisicc.procesoIMPSpoolFacturaLaserMultihiloService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoIMPSpoolFacturaLaserMultihiloServiceImpl extends BaseProcesoIMPSpoolHiloAbstractService {
    ...
    public void executeHilo(ProcesoSpool proceso){
        try {
        	procesoHiloImpresionService.executeSpoolFacturaLaserMultihilo(proceso);
		} catch (Exception e) {
