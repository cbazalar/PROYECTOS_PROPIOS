 ...
 */
@Service("sisicc.interfazLETEnviarTarjetasAsociadasDetaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazLETEnviarTarjetasAsociadasDetaServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
	...
	protected void executeStoreProcedure(Map params) {
		this.interfazLETDAO.executeInterfazLETEnviarTarjetasAsociadasDeta(params);
