 ...
 */
@Service("sisicc.interfazOCREnviarRangoPeriodosVigenteCorporativoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCREnviarRangoPeriodosVigenteCorporativoServiceImpl extends	BaseInterfazSalidaStoredProcedureAbstractService {
...
public Map prepareQueryParams(InterfazParams interfazParams) throws InterfazException {
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazOCREnviarRangoPeriodosVigenteCorporativo(params);
	}
