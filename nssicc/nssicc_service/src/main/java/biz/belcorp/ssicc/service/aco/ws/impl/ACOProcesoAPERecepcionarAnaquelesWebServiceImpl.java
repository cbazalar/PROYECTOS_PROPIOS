...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoAPERecepcionarAnaquelesWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoAPERecepcionarAnaquelesWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoAPERecepcionarAnaquelesWebServiceImpl extends
		BaseInterfazAbstractWebService implements
		ACOProcesoAPERecepcionarAnaquelesWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoAPERecepcionarAnaquelesWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";		
		String CODIGO_INTERFAZ = Constants.APE_CODIGO_INTERFAZ_RECEPCIONAR_ANAQUELES;
