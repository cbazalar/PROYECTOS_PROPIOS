...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCRRecepBolEntWebService;
 ...
 * 
 */
public class ACOProcesoOCRRecepBolEntWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoOCRRecepBolEntWebService {
	...
	public ACOWebServiceResponse ejecutarProcesoOCRRecepBolEnt(
		...
		String mensajeError = "";
		String CODIGO_BATCH = "23";
		String CODIGO_INTERFAZ = "OCR-84";
		String CODIGO_SISTEMA = "OCR";
	...
	protected Map prepareParamsBeforeExecute(Map params, Pais pais) throws Exception {		
		params.put("codigoDocumento", Constants.STO_TIPO_DOCUMENTO_OT);
