...
@Service("sisicc.paqueteProcesoGENProcesarCierreZonaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class PaqueteProcesoGENProcesarCierreZonaServiceImpl extends BaseInterfazPaqueteAbstractServiceImpl
{
