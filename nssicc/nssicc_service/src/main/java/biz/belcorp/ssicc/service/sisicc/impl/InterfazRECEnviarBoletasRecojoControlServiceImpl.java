 ...
 */
@Service("sisicc.interfazRECEnviarBoletasRecojoControlService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazRECEnviarBoletasRecojoControlServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazSiCCDAO.executeInterfazRECEnviarBoletasRecojoControl(params);
