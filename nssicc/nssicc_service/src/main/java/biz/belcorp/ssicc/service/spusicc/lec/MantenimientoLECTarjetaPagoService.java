...
/**
 * <p>
 * <a href="MantenimientoLECTarjetaPagoService.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="dtorres@sigcomt.com">Diego Torres</a>
 *         
 */
public interface MantenimientoLECTarjetaPagoService extends Service {
	...
	/**
	 * Obtiene la lista de tarjetas pago en base a los criterios de b�squeda
	 * @param params
	 * @return
	 */
