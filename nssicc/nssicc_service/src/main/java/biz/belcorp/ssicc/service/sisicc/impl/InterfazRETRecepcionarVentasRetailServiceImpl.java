...
@Service("sisicc.interfazRETRecepcionarVentasRetailService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazRETRecepcionarVentasRetailServiceImpl extends
	...
	throws InterfazException {
    	if (log.isDebugEnabled())
	    	...
	    	if(Constants.NUMERO_UNO.equals(indicadorReproceso))//elimina cabecera detalle segun fechas de incio y fin
	    	    interfazRETDAO.deleteInterfazRETRecepcionarVentasRetail(interfazParams.getQueryParams());
	}
	/* (non-Javadoc)
		...
		try {
			...
			while(it.hasNext()) {
				...
				/* Insertando en la cabecera */ 
					try {					
						interfazRETDAO.insertInterfazRETRecepcionarVentasRetail(row);//inserta cada registro
