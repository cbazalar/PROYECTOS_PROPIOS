...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoOCRRecepcionarFamiliaSeguraWebWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoOCRRecepcionarFamiliaSeguraWebWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoOCRRecepcionarFamiliaSeguraWebWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoOCRRecepcionarFamiliaSeguraWebWebService {
	...
	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoOCRRecepcionarFamiliaSeguraWeb#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.OCR_CODIGO_PROCESO_BATCH_RECEPCIONAR_FAMILIA_SEGURA_WEB;
		String CODIGO_INTERFAZ = Constants.OCR_CODIGO_INTERFAZ_RECEPCIONAR_ARCHIVO_FAMILIA_SEGURA_WEB;
		String CODIGO_SISTEMA = Constants.SISTEMA_OCR;

		if (log.isDebugEnabled()) {
			log.debug("ejecutar Proceso ACOProcesoOCRRecepcionarFamiliaSeguraWeb");
		}
		...
		try {
			...
			criteria.put("codigoDocumento", Constants.STO_TIPO_DOCUMENTO_FAS);
