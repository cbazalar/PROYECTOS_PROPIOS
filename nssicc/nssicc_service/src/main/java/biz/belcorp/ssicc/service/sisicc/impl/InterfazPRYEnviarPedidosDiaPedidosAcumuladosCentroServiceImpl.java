 ...
 */
@Service("sisicc.interfazPRYEnviarPedidosDiaPedidosAcumuladosCentroService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazPRYEnviarPedidosDiaPedidosAcumuladosCentroServiceImpl extends BaseInterfazSalidaStoredProcedureAbstractService {
    ...
    protected void executeStoreProcedure(Map params) {
    	interfazPRYDAO.executeEnvioPedidosDiaPedidosAcumuladosCentro(params);
	}
