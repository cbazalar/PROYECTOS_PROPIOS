 ...
 * 
 */
@Service("sisicc.interfazOCREnviarLimiteDeVentaProlService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazOCREnviarLimiteDeVentaProlServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazOCRDAO
				.executeInterfazOCREnviarLimiteDeVentaProl(params);
	}
}