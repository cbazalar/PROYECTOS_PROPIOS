 ...
 *
 */
@Service("spusicc.procesoMENGenerarFaltantesAnunciadosService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ProcesoMENGenerarFaltantesAnunciadosServiceImpl extends BaseInterfazProcesoAbstractService{
	...
	protected void executeStoreProcedure(Map params) throws InterfazException {
		log.debug("inicio ProcesoMENGenerarFaltantesAnunciadosServiceImpl " + params);
