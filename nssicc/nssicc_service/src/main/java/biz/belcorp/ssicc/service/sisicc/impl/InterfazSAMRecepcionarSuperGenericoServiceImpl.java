 ...
 *
 */
@Service("sisicc.interfazSAMRecepcionarSuperGenericoService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazSAMRecepcionarSuperGenericoServiceImpl extends BaseInterfazEntradaAbstractService {
	...
	protected void processLine(InterfazParams interfazParams, int lineCount,
		...
		try {
			...
			interfazSAMDAO.executeRecepcionSuperGenerico(row);
