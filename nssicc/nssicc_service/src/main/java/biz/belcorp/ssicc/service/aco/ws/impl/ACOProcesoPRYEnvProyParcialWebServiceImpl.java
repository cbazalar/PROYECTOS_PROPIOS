...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoPRYEnvProyParcialWebService;
 ...
 */
public class ACOProcesoPRYEnvProyParcialWebServiceImpl extends BaseInterfazHiloAbstractWebService implements ACOProcesoPRYEnvProyParcialWebService{
	...
	public ACOWebServiceResponse ejecutarProcesoPRYEnvProyParcial(
		...
		final String CODIGO_INTERFAZ = "PRY-P1";
		final String CODIGO_SISTEMA = "PRY";
		
		if(log.isDebugEnabled()){
			log.debug("ejecutar Proceso Interfaz ejecutarProcesoPRYEnvProyParcial");
		}
		try{
