 ...
 * 
 */
@Service("sisicc.interfazFLXEnviarConsultorasObjetadasService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazFLXEnviarConsultorasObjetadasServiceImpl extends
	...
	protected void executeStoreProcedure(Map params) {
		interfazFLXDAO.executeEnviarConsultorasObjetadas(params);
	}
