...
import biz.belcorp.ssicc.service.aco.ws.ACOProcesoSATRecepcionarParametrizacionCalculoFechaEntregaExactaWebService;
 ...
 * 
 * <p>
 * <a href="ACOProcesoSATRecepcionarParametrizacionCalculoFechaEntregaExactaWebServiceImpl.java.html"> <i>View Source </i> </a>
 * </p>
 * 
 * @author <a href="mailto:itocto@sigcomt.com">Ivan Tocto Jaimes</a>
 */

public class ACOProcesoSATRecepcionarParametrizacionCalculoFechaEntregaExactaWebServiceImpl
		extends BaseInterfazHiloAbstractWebService implements
		ACOProcesoSATRecepcionarParametrizacionCalculoFechaEntregaExactaWebService {

	/* (non-Javadoc)
	 * @see biz.belcorp.ssicc.aco.ws.ACOProcesoSATRecepcionarParametrizacionCalculoFechaEntregaExactaWebService#ejecutarProceso(java.lang.String, java.lang.String)
	 */
	public ACOWebServiceResponse ejecutarProceso(String codigoPais, String codigoUsuario) throws RemoteException {
		...
		String mensajeError = "";
		String CODIGO_BATCH = Constants.SAT_CODIGO_PROCESO_BATCH_RECEPCIONAR_PARAMETRIZACION_CALCULO_FECHA_ENTREGA_EXACTA;
		String CODIGO_INTERFAZ = Constants.SAT_CODIGO_INTERFAZ_RECEPCIONAR_PARAMETRIZACION_CALCULO_FECHA_ENTREGA_EXACTA;
