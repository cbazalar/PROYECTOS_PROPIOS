...
/**
 * Service para el envio de PreFacturacion Cabecera de la Interfaz AVI.
 *   
 * @author <a href="mailto:sapaza@belcorp.biz">Sergio Apaza </a>
 */
@Service("sisicc.interfazAVIEnviarPrefacturacionCabeceraService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class InterfazAVIEnviarPrefacturacionCabeceraServiceImpl extends
	...
	interfazAVIDAO.executeInterfazAVIPrefacturacionCabecera(params);
    }
    ...
    protected List readData(Map queryParams) throws InterfazException {
        ...
        try {
        	listPrefacturacionCabecera = this.interfazAVIDAO
            		.getInterfazAVIPrefacturacionCabecera(queryParams);
