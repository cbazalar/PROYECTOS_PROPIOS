 ...
 * 29/05/2014
 */
@Service("reportes.reporteSACFechaRealEntrega2Service")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ReporteSACFechaRealEntregaServiceImpl2 extends BaseReporteInterfaceImpl{
	
		
	@Resource(name="scsicc.reporteService")
	private ReporteService reporteService;
	
	@Resource(name="sac.reporteSACFechaRealEntregaService")
	private ReporteSACFechaRealEntregaService service;
	...
	public ReporteParams beforeExecuteReporte(ReporteParams reporteParams, BaseReporteForm formReporte) throws Exception {
		...
		service.executeGenerarReporteLideres((Map)reporteParams.getQueryParams().get("parameterMap"));
