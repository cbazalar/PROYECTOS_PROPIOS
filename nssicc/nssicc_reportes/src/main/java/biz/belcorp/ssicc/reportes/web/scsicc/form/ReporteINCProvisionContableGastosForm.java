...
public class ReporteINCProvisionContableGastosForm extends BaseReporteForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3143568164569838744L;
