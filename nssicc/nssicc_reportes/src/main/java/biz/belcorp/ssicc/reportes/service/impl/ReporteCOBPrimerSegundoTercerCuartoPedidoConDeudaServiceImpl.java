...
@Service("reportes.reporteCOBPrimerSegundoTercerCuartoPedidoConDeudaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ReporteCOBPrimerSegundoTercerCuartoPedidoConDeudaServiceImpl extends BaseReporteInterfaceImpl {
	...
	public ReporteParams beforeExecuteReporte(ReporteParams reporteParams, BaseReporteForm formReporte) throws Exception {
		if (log.isDebugEnabled()) {
			log.debug("Entering 'ReporteCOBPrimerSegundoTercerCuartoPedidoConDeudaServiceImpl.beforeExecuteReporte' method");
		}
		
		Map params = (Map) reporteParams.getQueryParams().get("parameterMap");

		reporteService.executeReporteCOBPrimerSegundoTercerCuartoPedidoConDeuda(params);
