...
public class ReporteRECReclamosMotDevolucionForm extends BaseReporteForm
		implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5601231223088007046L;
	...
	private String[] motivoDevolucionList;
	...
	public ReporteRECReclamosMotDevolucionForm() {
	...
	/**
	 * @return the motivoDevolucionList
	 */
	public String[] getMotivoDevolucionList() {
		return motivoDevolucionList;
	}

	/**
	 * @param motivoDevolucionList the motivoDevolucionList to set
	 */
	public void setMotivoDevolucionList(String[] motivoDevolucionList) {
