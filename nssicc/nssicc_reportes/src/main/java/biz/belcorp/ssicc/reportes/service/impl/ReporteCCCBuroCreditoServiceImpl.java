...
@Service("reportes.reporteCCCBuroCreditoService")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class ReporteCCCBuroCreditoServiceImpl extends BaseReporteInterfaceImpl {
	...
	public ReporteParams beforeExecuteReporte(ReporteParams reporteParams,
		...
		if (log.isDebugEnabled()) {
			log.debug("Entering 'ReporteCCCBuroCreditoServiceImpl.beforeExecuteReporte' method");
		}
		...
		reporteService.executeReporteSQL("executeGenerarReporteCCCBuroCredito",params);
	...
	public String generarNombreArchivoReporteOracle(Map parameterMap) {
		String nombreArchivo = Constants.PREFIJO_REPORTE_CCC_BURO_CREDITO;
	...
	public String obtieneKeyTituloReporteOracle(Map parameterMap) {
		...
		String formatoExportacion = (String) parameterMap.get("formatoExportacion");
			...
			if (formatoExportacion.equals("OCSV"))
				return "reporteBuroCreditoForm.tituloReporteCSV";
	...
	public Map generarReporteOracle(Map parameterMap) {
		...
		if (formatoExportacion.equals("OCSV")){
			parameterMap = reporteService.executeReporteCCCBuroCreditoCSV(parameterMap);
		}
