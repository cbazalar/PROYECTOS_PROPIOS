...
/**
 * The Class ReporteSACTIMImpositivoAduanaServiceImpl.
 *
 * @autor: cbazalar
 * @version: 1.0
 * 18/03/2014
 */
@Service("reportes.reporteSACTIMImpositivoAduanaService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ReporteSACTIMImpositivoAduanaServiceImpl extends BaseReporteInterfaceImpl {
	...
	public ReporteParams beforeExecuteReporte(ReporteParams reporteParams, BaseReporteForm formReporte) throws Exception {
		...
		reporteService.executeReporteSACTIMImpositivoAduana(params);
