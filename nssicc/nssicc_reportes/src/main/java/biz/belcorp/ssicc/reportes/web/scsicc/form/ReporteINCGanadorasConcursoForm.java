 ...
 * 
 * @struts.form name="reporteINCGanadorasConcursoForm" extends="baseReporteForm"
 */
public class ReporteINCGanadorasConcursoForm extends BaseReporteForm {
	/**
	 * 
	 */
	...
	public ReporteINCGanadorasConcursoForm() {
	...
	/**
	 * @param indicadorRegion the indicadorRegion to set
	 */
	...
	/**
	 * @param indicadorTerritorio the indicadorTerritorio to set
	 */
