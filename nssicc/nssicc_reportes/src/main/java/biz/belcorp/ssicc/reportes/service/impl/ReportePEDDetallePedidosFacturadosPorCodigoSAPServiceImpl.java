...
/**
 * The Class ReportePEDDetallePedidosFacturadosPorCodigoSAPServiceImpl.
 *
 * @autor: Belcorp
 * @version: 1.0
 * 18/03/2014
 */
@Service("reportes.reportePEDDetallePedidosFacturadosPorCodigoSAPService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ReportePEDDetallePedidosFacturadosPorCodigoSAPServiceImpl extends BaseReporteInterfaceImpl {
	...
	public ReporteParams beforeExecuteReporte(ReporteParams reporteParams, BaseReporteForm formReporte) throws Exception {
		...
		this.reporteService.insertReportePEDDetallePedidosFacturadosPorCodigoSAP(params);
