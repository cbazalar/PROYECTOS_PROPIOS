 ...
 *
 */
@Service("reportes.reportePERFacturasPendientesSeccionService")
@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
public class ReportePERFacturasPendientesSeccionServiceImpl extends BaseReporteInterfaceImpl {
	...
	public ReporteParams beforeExecuteReporte(ReporteParams reporteParams, BaseReporteForm formReporte) throws Exception {
		...
		log.debug("Los parametros del Reporte en el before son: "
				+ params.toString());
		reporteService.executeFacturaPendienteSeccion(params);
